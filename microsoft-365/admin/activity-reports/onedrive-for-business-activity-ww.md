...
OneDrive レポートでアクティビティを表示するには、[アクティビティ] タブを **選択** します。<br/>![Microsoft 365 レポート - Microsoft OneDrive アクティビティ レポート。](../../media/c89df0b0-2611-4acf-9ef7-17cedf7977be.png)

[列 **の選択]** を選択して、レポートの列を追加または削除します。  <br/> ![OneDrive アクティビティ レポート - 列の選択](../../media/252f311f-ffde-4e5a-9158-2b822bf86964.png)
...
|最終アクティビティ日 (UTC)  <br/> |選択した日付範囲の OneDrive アカウントでファイル アクティビティが実行された最新の日付。 . 特定の日付に発生したアクティビティを表示するには、直接グラフ内の日付を選択します。  <br/> |
