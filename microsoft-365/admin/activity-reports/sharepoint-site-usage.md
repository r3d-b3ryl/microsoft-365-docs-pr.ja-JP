...
|3.  <br/> |[ **サイト** ] グラフには、ユーザーがファイルを表示、変更、アップロード、ダウンロード、共有、同期したサイト、またはレポート期間内にページを表示したサイトを含む、合計およびアクティブなサイトの数が表示されます。  <br/> |
