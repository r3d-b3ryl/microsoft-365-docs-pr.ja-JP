...
|Power プラットフォーム管理者 |   Power プラットフォーム管理者ロールは、以下の操作を行う必要があるユーザーに割り当てます。 <br> - Power Apps、Power Automate、および Microsoft Purview データ損失防止のすべての管理者機能を管理する <br> - サービス リクエストを作成および管理する <br> - サービス正常性を監視する  |
