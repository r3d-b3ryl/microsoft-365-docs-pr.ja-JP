...
|メッセージ センター閲覧者 |   レポート閲覧者のロールは、以下の操作を行う必要があるユーザーに割り当てます。 <br> - メッセージ センターの通知の監視 <br> - メッセージ センターの投稿と更新情報の週単位のメール ダイジェストの取得 <br> - メッセージ センターの投稿の共有 <br> - ユーザーやグループなど、Azure AD サービスへの読み取り専用アクセス権の所持|
|Power プラットフォーム管理者 |   レポート閲覧者のロールは、以下の操作を行う必要があるユーザーに割り当てます。 <br> - Power Apps、Power Automate、およびデータ損失防止のすべての管理者機能を管理する <br> - サービス リクエストを作成および管理する <br> - サービス正常性を監視する  |
