...
Microsoft 365 管理者は、ユーザーがセルフサービスのパスワード[](https://go.microsoft.com/fwlink/p/?LinkId=522677)リセット ツールを使用して、ユーザーのパスワードをリセットする必要がなにかからなにかできます。 より少ない作業です。
  
## <a name="before-you-begin"></a>はじめに
  
- Microsoft 365 のビジネス、教育、または非営利団体の有料プランでは、クラウド ユーザーのセルフサービスによるパスワードのリセットを無料で受け取る。 Microsoft 365 試用版では動作しません。
...
- **オンプレミスの Active Directory を使用している場合**、上記の 2 つのポイントは適用されません。 この設定は可能ですが、Azure AD Premium の有料 **サブスクリプションが必要です**。
...
これらの手順を実行 [するには、グローバル管理者またはパスワード](about-admin-roles.md) 管理者である必要があります。
...
1. 管理センター <a href="https://go.microsoft.com/fwlink/p/?linkid=850627" target="_blank">で、[</a>設定のセキュリティプライバシー  \> **]** \> **ページ &amp; に移動** します。

::: moniker-end

2. [組織の設定] ページ **の上部で** 、[セキュリティとプライバシー] **&選択** します。
  
3. [ **セルフサービスによるパスワードのリセット] を選択します**。

4. [ **セルフサービスによるパスワードのリセット] で**、[Azure portal に移動] を選択してセルフサービスによるパスワードのリセット **を有効にします**。

5. 左側のナビゲーション ウィンドウで [ユーザー] **を選択し**、[ユーザー] ウィンドウで| **[すべてのユーザー]** ページで、[パスワードのリセット **] を選択します**。
