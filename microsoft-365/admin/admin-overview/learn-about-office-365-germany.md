...
Office 365ドイツのプラン製品は、この分離された環境で可能な限りグローバルなオファーと一致しています。 除外項目には、Yammer 関連のプラン、廃止目前のプラン、非営利のプログラムを通じて利用可能なプランが含まれます。 Office 365E5、SPE、その他のサービスは、ドイツでの一般提供後Office 365されます。 
