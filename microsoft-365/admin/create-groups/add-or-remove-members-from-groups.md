...
3. 詳細ウィンドウで、[ **メンバー**] の横にある [ **編集**] を選択し、[ **メンバーの追加**] を選択します。
...
3. 詳細ウィンドウで、[ **グループメンバーシップ**] の横にある [ **編集**] を選択し、[ **メンバーシップの追加**] を選択します。
...
3. 詳細ウィンドウで、[ **メンバー**] の横にある [ **編集**] を選択します。
...
3. 詳細ウィンドウで、[ **所有者**] の横にある [ **編集**] を選択します。
