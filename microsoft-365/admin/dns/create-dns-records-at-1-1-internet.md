---
title: IONOS で DNS レコードを 1&1 ずつ Microsoft 365 に接続する
f1.keywords:
- CSH
ms.author: efrene
author: efrene
...
ms.locfileid: "66563431"
---
# <a name="connect-your-dns-records-at-ionos-by-11-to-microsoft-365"></a>IONOS で DNS レコードを 1&1 ずつ Microsoft 365 に接続する
...
Microsoft 365 を使用して、1&1 つのドメインで IONOS を自動的に確認して設定するには、次の手順に従います。

1. Microsoft 365 管理センターで **[設定**<a href="https://go.microsoft.com/fwlink/p/?linkid=834818" target="_blank">**ドメイン**</a>]  >  を選択し、設定するドメインを選択します。

    :::image type="content" source="../../media/dns-IONOS/IONOS-DomainConnects-1.png" alt-text="Microsoft 365 でドメインを選択します。":::
...
1. IONOS by 1&1 ログイン ページで、アカウントにサインインし、[ **接続**]、[ **許可**] の順に選択します。

    :::image type="content" source="../../media/dns-IONOS/IONOS-DomainConnects-3.png" alt-text="[接続]、[許可] の順に選択します。":::

    これで、Microsoft 365 のドメインセットアップが完了します。

## <a name="create-dns-records-with-manual-setup"></a>手動セットアップを使用して DNS レコードを作成する

IONOS でこれらのレコードを 1&1 ずつ追加すると、ドメインは Microsoft サービスで動作するように設定されます。
