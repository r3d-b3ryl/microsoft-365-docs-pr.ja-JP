...
5. 新しい **レコードの [種類** ] ボックスで、ドロップダウン リストから **[TXT/SPF** ] を選択し、次の表の他の値を入力またはコピーして貼り付けます。
    ...
    |---|---|---|
    |@|TXT/SPF|MS=*msXXXXXXXX* <br/> **注:** これは例です。 この表から **[宛先またはポイント先のアドレス]** の値を指定してください。 [確認する方法](../get-help-with-domains/information-for-dns-records.md)|
...
### <a name="add-the-two-required-cname-records-for-skype-for-business"></a>必要な 2 つの CNAME レコードを追加Skype for Business
