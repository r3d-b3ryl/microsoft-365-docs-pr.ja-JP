...
---
# <a name="create-dns-records-at-crazy-domains-for-office-365"></a>Crazy Domains で Office 365 用の DNS レコードを作成する
...
これらのレコードを Crazy Domains で追加すると、使用しているドメインが、Office 365 のサービスで機能するように設定されます。
...
8. 新規レコードのボックスに、次の表の値を入力するか、コピーして貼り付けます。
    ...
    |**サブドメイン**|**テキスト レコード**|
    |:-----|:-----|
    |(Leave this field empty.)  <br/> |MS=ms *XXXXXXXX*  <br/> **注:** これは例です。Office 365 の表から [ **宛先またはポイント先のアドレス** ] の値を指定してください。           [情報の取得方法](../get-help-with-domains/information-for-dns-records.md)          |
...
8. 2 つの SRV レコードの最初のレコードを追加します。
    ...
    |**レコードの種類**|**サブドメイン**|**優先度**|**Weight**|**Port**|**対象**|
    |:-----|:-----|:-----|:-----|:-----|:-----|
