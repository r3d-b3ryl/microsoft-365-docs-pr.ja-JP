---
title: OVH で DNS レコードをMicrosoft 365にConnectする
f1.keywords:
- CSH
ms.author: efrene
author: efrene
...
ms.locfileid: "64780415"
---
# <a name="connect-your-dns-records-at-ovh-to-microsoft-365"></a>OVH で DNS レコードをMicrosoft 365にConnectする
...
OVH でこれらのレコードを追加すると、ドメインはMicrosoft サービスで動作するように設定されます。
