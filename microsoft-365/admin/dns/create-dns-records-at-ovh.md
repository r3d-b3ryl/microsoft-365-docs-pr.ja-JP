...
6. In the boxes for the new record, type or copy and paste the values from the following table. TTL 値を割り当てるには、ドロップダウンリストから [**個人用**] を選択し、テキストボックスに値を入力します。 
...
6. 1 番目の SRV レコードを作成します。
    ...
    |**Record type**|**サブドメイン**|**優先度**|**Weight**|**Port**|**TTL**|**ターゲット**|
    |:-----|:-----|:-----|:-----|:-----|:-----|:-----|
