...
Wix でこれらのレコードを追加した後、ドメインはユーザーと一緒に動作Microsoft サービス。
...
2. [**ドメイン**  >  **...] を選択** し、ドロップダウン リストから **[DNS レコード** の管理] を選択します。 
...
1. [**ドメイン**  >  **...] を選択** し、ドロップダウン リストから **[DNS レコード** の管理] を選択します。 
...
3. DNS **エディターの** **CNAME (Aliases)** 行で [+ 追加] を選択し、次の表の最初の行の値を入力します。 
