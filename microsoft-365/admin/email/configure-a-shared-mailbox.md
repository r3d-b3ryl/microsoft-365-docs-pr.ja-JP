...
2. 編集する共有メールボックスを選択し、[**電子メール転送**編集] を選択し \> **Edit**ます。
    
3. **[オン**] に切り替え、メッセージを転送するメールアドレスを1つ入力します。 任意の有効な電子メールアドレスを指定できます。 複数のアドレスに転送するには、アドレスの [配布グループを作成](https://docs.microsoft.com/office365/admin/setup/create-distribution-lists) し、このボックスにグループの名前を入力する必要があります。
...
2. 編集する共有メールボックスを選択し、[**自動応答**の編集] を選択し \> **Edit**ます。
...
2. 編集する共有メールボックスを選択し、[**電子メールアプリ**の編集] を選択し \> **Edit**ます。
...
2. 編集する共有メールボックスを選択して、[**訴訟ホールド**編集] を選択し \> **Edit**ます。
...
2. 編集する共有メールボックスを選択し、[**メンバー**の編集] を選択し \> **Edit**ます。
...
2. 編集する共有メールボックスを選択し、[**グローバルアドレス一覧の**編集] で [表示] を選択し \> **Edit**ます。
