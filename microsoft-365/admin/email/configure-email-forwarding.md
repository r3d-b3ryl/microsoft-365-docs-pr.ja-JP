...
---
# <a name="configure-email-forwarding-in-microsoft-365"></a>Microsoft 365 で電子メール転送を構成する
...
1. 管理センターで、[ **ユーザー** の \> **[アクティブなユーザー](https://go.microsoft.com/fwlink/p/?linkid=847686)** ] ページに移動します。
...
1. 管理センターで、[ **ユーザー** の \> **[アクティブなユーザー](https://go.microsoft.com/fwlink/p/?linkid=850628)** ] ページに移動します。
