...
- Web サイトのアドレスと一緒に現在使用されているドメインを追加しますか `https://www.fourthcoffee.com` 。 ドメインの NS レコードを Microsoft 365 に変更した後も、ユーザーが Web サイトにアクセスできるよう、サイトがホストされている場所にドメインを追加する場合は、以下の手順を実行します。
