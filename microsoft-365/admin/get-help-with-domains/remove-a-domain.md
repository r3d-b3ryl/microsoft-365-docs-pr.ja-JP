...
別のサブスクリプション プランに追加する場合、ドメインを削除Microsoft 365ですか? それとも、サブスクリプションをキャンセルするためですか? [プランやサブスクリプションを変更する](../../commerce/subscriptions/switch-to-a-different-plan.md)ことも、[サブスクリプションをキャンセル](../../commerce/subscriptions/cancel-your-subscription.md)することもできます。
  
### <a name="step-1-move-users-to-another-domain"></a>手順 1: 別のドメインにユーザーを移動する
...
2. **[ユーザー** > **アクティブ ユーザー**] を選択します。

3. 移動するすべてのユーザーの名前の横にあるボックスを選択します。

4. ページの上部で 、[ **ドメインの変更**] をクリックします。
...
4. ページの上部にある [ **その他** の > **ドメインの編集]** を選択します。
...
#### <a name="move-yourself"></a>自分で移動する

::: moniker range="o365-worldwide"

1. <a href="https://go.microsoft.com/fwlink/p/?linkid=850627" target="_blank">管理センター</a>にアクセスします。

2. **[** \> **アクティブユーザー**] に移動し、一覧からアカウントを選択します。
...
1. **[** \> **アクティブ ユーザー**] に移動し、一覧から自分の名前を選択します。

2. [ **ユーザー名/電子メール** ] セクションで [ **編集**] を選択し、別のドメインを選択します。

3. [ **プライマリ** > **保存** > **を閉じる**] に設定する] を選択します。
...
2. グループ名を選択し、[ **全般** ] タブの [ **電子メール アドレス]、[ プライマリ**] の下の [ **編集**] を選択します。

3. ドロップダウン リストを使用して、別のドメインを選択します。
...
1. <a href="https://go.microsoft.com/fwlink/p/?linkid=848041" target="_blank">管理センター</a>の [**グループ** > **グループ**] ページに移動します。

2. グループ名を選択し、[**名前**] の横の **[編集]** を選択します。
...
1. <a href="https://go.microsoft.com/fwlink/p/?linkid=850627" target="_blank">管理センター</a>の [**グループ** > **グループ**] ページに移動します。
...
1. 管理センターで、[ **ドメインのセットアップ**] \> ページ <a href="https://go.microsoft.com/fwlink/p/?linkid=854615" target="_blank">に</a> 移動します。

::: moniker-end

::: moniker range="o365-21vianet"

1. 管理センターで、[ **ドメインのセットアップ**] \> ページ <a href="https://go.microsoft.com/fwlink/p/?linkid=2007048" target="_blank">に</a> 移動します。
...
4. 追加のプロンプトに従い、[ **閉じる**] を選択します。

## <a name="how-long-does-it-take-for-a-domain-to-be-removed"></a>ドメインが削除されるまで、どれくらいかかりますか?

セキュリティ グループ、配布リスト、ユーザー、Microsoft 365 グループなど、多くの場所でドメインが参照されていない場合、Microsoft 365がドメインを削除するまでにわずか 5 分程度かかることがあります。 ドメインを使用する参照が多い場合、ドメインが削除されるまでに数時間 (1 日) 程度かかることもあります。
...
> [!NOTE]
> アカウントから [".onmicrosoft.com"](../setup/domains-faq.yml) ドメインを削除することはできません。 ドメインを削除すると、ユーザー アカウントはプライマリ SMTP/ユーザー プリンシパル名として ".onmicrosoft.com" アドレスに戻ります。
