...
Microsoft 365 でカスタムドメイン (contoso.com) の使用を開始するには、ドメインを確認して、ドメインの DNS レコードを構成する必要があります。 
...
## <a name="let-microsoft-365-manage-your-dns-records"></a>Microsoft 365 が DNS レコードを管理できるようにする

||
|---|---|
|[1&IONOS](../dns/change-nameservers-at-1-1-internet.md) |
|[Amazon Web Services (AWS)](../dns/change-nameservers-at-aws.md) |
 [Bluehost](../dns/change-nameservers-at-bluehost.md)|
|[Google ドメイン](../dns/change-nameservers-at-google-domains.md) |
|[Hostgator](../dns/change-nameservers-at-hostgator.md)  |  
|[,](../dns/change-nameservers-at-mydomain.md) | 
|[Namecheap](../dns/change-nameservers-at-namecheap.md)|
|[Network Solutions](../dns/change-nameservers-at-network-solutions.md) |  

または、すべての[ドメインレジストラーを使用して Microsoft 365 をセットアップするためにネームサーバーを変更](change-nameservers-at-any-domain-registrar.md)する方法について説明します。

## <a name="manage-your-own-dns-records"></a>自分の DNS レコードを管理する

|                           |                          |
|---------------------------|--------------------------|
| [1&IONOS](../dns/create-dns-records-at-1-1-internet.md) | [Hover](../dns/create-dns-records-at-hover.md) |
| [123-reg.co.uk](../dns/create-dns-records-at-123-reg-co-uk.md) | [Google による管理 (eNom)](../dns/create-dns-records-for-domain-managed-by-google-enom.md)|
| [Amazon Web Services (AWS)](../dns/create-dns-records-at-aws.md) | [,](../dns/create-dns-records-at-mydomain.md) |
| [Azure DNS ゾーン](../dns/create-dns-records-for-azure-dns-zones.md) | [name.com](../dns/create-dns-records-at-name-com.md) |
...
|[DNSMadeEasy](../dns/create-dns-records-at-dnsmadeeasy.md) | [ネットワークソリューション](../dns/create-dns-records-at-network-solutions.md) |
...
|[GoDaddy](../dns/create-dns-records-at-godaddy.md)|[Windows ベースの DNS](../dns/create-dns-records-using-windows-based-dns.md)   |
| [Google Domains](../dns/create-dns-records-at-google-domains.md) |[Wix](../dns/create-dns-records-at-wix.md) |
|[Hostgator](../dns/create-dns-records-at-hostgator.md)  | [Yahoo!  小規模企業](../dns/create-dns-records-at-yahoo-small-business.md)  |

[ドメインホストがこの一覧にはないため、一般的な手順が必要です。](create-dns-records-at-any-dns-hosting-provider.md)
