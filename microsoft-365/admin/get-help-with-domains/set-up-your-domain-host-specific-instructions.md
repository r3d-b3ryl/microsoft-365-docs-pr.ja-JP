...
ドメイン ホストの管理ツールを使用して DNS レコードを追加および管理したり、ドメイン レコードを Microsoft が制御し、セットアップします。
  
正確な手順については、以下のドメイン ホストを選択してください。 ホストが不明な場合は、「ドメイン レジストラーを検索する [」を参照してください](find-your-domain-registrar.md)。
...
||
|---|---|
|[1&1 つ](../dns/change-nameservers-at-1-1-internet.md) |
...
または、任意のドメイン レジスト [ラーで Microsoft 365](change-nameservers-at-any-domain-registrar.md)をセットアップするためにネームサーバーを変更する方法について説明します。

## <a name="manage-your-own-dns-records"></a>独自の DNS レコードを管理する

|                           |                          |
|---------------------------|--------------------------|
| [1&1 つ](../dns/create-dns-records-at-1-1-internet.md) | [Hover](../dns/create-dns-records-at-hover.md) |
...
|[DNSMadeEasy](../dns/create-dns-records-at-dnsmadeeasy.md) | [ネットワーク ソリューション](../dns/create-dns-records-at-network-solutions.md) |
...
|[Hostgator](../dns/create-dns-records-at-hostgator.md)  | [Yahoo!  小規模ビジネス](../dns/create-dns-records-at-yahoo-small-business.md)  |

[ドメイン ホストはこの一覧に表示されていないので、一般的な手順が必要です。 ](create-dns-records-at-any-dns-hosting-provider.md)
