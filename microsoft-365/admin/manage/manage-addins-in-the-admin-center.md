...
グローバル管理者または Exchange 管理者が組織内のユーザーのアドインを展開した後、アドインのオン/オフ、編集、削除、アドインへのアクセスの管理を行うことができます。
...
3. 前にデプロイしたアドイン (この例では **引用文献**) をダブルクリックします。
    ...
    ![Office アドイン ページの [管理] タブを管理します。](../../media/fd36ba81-9882-40f0-9fce-74f991aa97d5.png)
