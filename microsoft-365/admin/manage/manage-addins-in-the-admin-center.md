...
> [!NOTE]
> ユーザーが office ストアにアクセスできないようにすると、 [Office アドインのサイドローディングからテストを行う](https://docs.microsoft.com/office/dev/add-ins/testing/create-a-network-shared-folder-catalog-for-task-pane-and-content-add-ins)こともできなくなります。
