...
3. [宛先] フィールドに、招待する出席者に加えて、予約する会議室または備品の名前も入力します。
   ...
   または、[ **宛先** ] を選択し、一覧から会議室または備品をダブルクリックします。次に [**OK**]を選択します。
...
8. 他のユーザーがオンラインで参加したり、会議に参加したりできるようにするには、[**Teams 会議**]を選択します。
...
3. 会議室または備品のフィールドに入力します。
   ...
   - [**電話番号**]: 会議室の電話番号。 これは、Microsoft Teams の使用時に生成される会議の電話番号とは異なります。
