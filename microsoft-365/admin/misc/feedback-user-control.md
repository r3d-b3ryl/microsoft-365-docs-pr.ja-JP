...
近日、Microsoft 製品用に収集したフィードバック データをお客様に共有します。 組織のフィードバック データを表示、削除、およびエクスポートする Microsoft 365 管理センターで新しいエクスペリエンスに取り組む。 これにより、ユーザーの製品に関するエクスペリエンスに関する透明性と有用なMicrosoft 365できます。
