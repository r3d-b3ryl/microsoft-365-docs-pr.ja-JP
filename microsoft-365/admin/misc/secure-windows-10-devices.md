...
ms.locfileid: "63327491"
---
# <a name="secure-windows-10-devices"></a>Windows 10 デバイスをセキュリティで保護する

この記事は、ユーザーにMicrosoft 365 Business Premium。

ここで構成する設定は、Windows 10 の既定のデバイス ポリシーの一部です。 モバイル デバイスや PC を含むWindows 10、自分の仕事用アカウントでサインインすると、これらの設定が自動的に受信されます。 セットアップ時は既定のポリシーを受け入れて、ユーザーの特定のグループを対象にするポリシーは後で追加することをお勧めします。
