...
MFA を設定する方法と、ユーザーがセットアップを完了する方法のトレーニング ビデオについては、「 [セットアップ MFA](../../business-video/turn-on-mfa.md) とユーザー セットアップ」 [を参照してください](../../business-video/set-up-mfa.md)。
