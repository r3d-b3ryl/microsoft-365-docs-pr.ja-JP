...
以下のセクションでは、各サービスの相違点に焦点を当てます。 最終的には、グローバル サービスとパリティを実現します。 ただし、中国内のデータセンターのパートナーが運営する中国サービスの固有の性質により、まだ有効になっていない機能がいくつか存在します。 お客様は、段階的にサービスの完全な機能をご利用いただけるようになります。 21Vianet が運用する各サービス プランOffice 365詳細については、「サービスの説明」をOffice 365[してください](/office365/servicedescriptions/office-365-platform-service-description/office-365-operated-by-21vianet)。
...
|セルフサービスによるパスワードのリセット  <br/> |管理者のみ利用可能です。 詳細については[、「21Vianet](https://support.microsoft.com/office/d8eb5b62-9d0e-4267-a9bf-2aa491ee6d0b)が運用しているパスワードを変更またはリセットOffice 365を参照してください。  <br/> |
|セキュリティ、プライバシー、コンプライアンス、サポートレベルの詳細  <br/> |21Vianet によって提供されます。  <br/> |
|Officeデスクトップのセットアップ  <br/> |Office 2010 および 2007 年OfficeデスクトップのセットアップOfficeできません。 ただし、管理者は、現在のデスクトップ[アプリケーションOfficeを](https://support.microsoft.com/office/85646aba-7e6c-4e24-a047-8fd9ce4f9d2e)構成して、現在のデスクトップ アプリケーションをOffice 365。  <br/> |
...
|自動的にホストされるアプリ  <br/> |プロバイダーホスト型アプリを展開して、プロバイダーとSharePointをSQL Azure。 詳細については、「基本プロバイダーホスト型アプリを作成する」[を参照SharePoint。](/sharepoint/dev/sp-add-ins/get-started-creating-provider-hosted-sharepoint-add-ins) 近日、開発者は自動ホストされた Web サイトを使用するアプリを展開できます。  <br/> |
...
|Office 365開発者向けサイト: 販売者ダッシュボードをSharePointストアに発行する\*  <br/> |21Vianet が運営するユーザーに配布SharePointアプリを提出するOffice 365について説明します。 [](/office/dev/store/submit-sharepoint-add-ins-for-office-365-operated-by-21vianet-in-china)  <br/> |
...
| 2010 SP3  <br/> | 2010 SP3  <br/> | いいえ  <br/> | None  <br/> |
...
| 2003  <br/> | 2010 SP3  <br/> | いいえ  <br/> | None  <br/> |
