...
個別の受信者名を入力せずに、ユーザーのグループに電子メールを送信する場合に使用されます。配布グループは、特定のディスカッションの件名 ("Marketing" など) によって、または、それらが頻繁に通信することを必要とする共通の作業を共有するユーザーによって編成されます。 また、電子メールを複数の電子メールアドレスに自動的に転送する方法も提供します。
