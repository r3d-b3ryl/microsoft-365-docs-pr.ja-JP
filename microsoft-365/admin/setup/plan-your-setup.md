...
Microsoft 365 は、個人、小規模組織、および企業向けクラウド ストレージを提供します。 保存場所のガイダンスについては [、「Microsoft 365](../../business-video/store-files.md)でドキュメントを保存できる場所」を参照してください。
...
- **従業員が 50 名未満の場合:**
  ...
  - **ご質問 [がある場合は、Microsoft 365 for Business サポート](../../business-video/get-help-support.md) にお問い合わせください**。 We're here to help! 
