...
## <a name="start-using-onedrive-and-your-team-site"></a>チーム サイトOneDriveの使用を開始する

### <a name="team-members-can-store-their-own-files-in-onedrive"></a>チーム メンバーは、自分のファイルを自分のファイルにOneDrive
...
1. [ポータル] <a href="https://portal.office.com/ " target="_blank">Microsoft 365に</a>移動し、ユーザー名とパスワードでサインインします。
...
### <a name="what-files-can-be-stored-in-onedrive-and-a-team-site"></a>ユーザーとチーム サイトにOneDriveファイルは何ですか?
