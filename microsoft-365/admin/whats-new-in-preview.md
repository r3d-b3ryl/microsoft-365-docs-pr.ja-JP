...
- デバイスベースのサブスクリプション: microsoft 365 管理センターのデバイスに**対して、microsoft 365 アプリの教育 (デバイス)** ライセンスを割り当てるか、または割り当てを解除することができます。 **Microsoft 365 の教育機関向けアプリ (デバイス)** は、ライセンスをデバイスに割り当てることができるアドオンライセンスです。 [ **Billing** > **Products & services** ] に移動して、ライセンスを検索して購入します。
