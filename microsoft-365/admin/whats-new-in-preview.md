...
サブスクリプション管理には多くの作業が行われており、ページの読み込みが速くなり、探しているものが見つけやすくなり、web acessibility の標準を満たすことができます ([WCAG 2.1 のガイドライン](http://www.w3.org/TR/WCAG21/))。
...
[Microsoft 365](https://youtu.be/m1Nu8WJgCDY) ビデオシリーズの新機能: 今月は、web およびモバイルでの新しい yammer の使用方法、Microsoft Teams 用の yammer コミュニティアプリの統合方法、第一線ワーカーとマネージャーをサポートするための新しいポリシーパッケージなどについて説明します。
...
- ユーザーベースのライセンス管理:**ユーザー**の  >  **アクティブユーザー**のライセンスを新しいスタイルに割り当てる方法を更新しました。 詳しくは、以下を参照してください。
