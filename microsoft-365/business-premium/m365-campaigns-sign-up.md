...
1. [キャンペーンの登録] メールへのMicrosoft 365で、[組織の登録] を選択 **>。** これにより、サインアップMicrosoft 365にアクセスできます。
    > [!NOTE]
...
2. **[ビジネスMicrosoft 365] ページで**、ビジネスの詳細を入力します。 [ **ビジネス用メール アドレス] では**、現在のメール アドレスを使用します。 このアドレスは、セットアップ プロセス中に連絡を取り合う場合にのみ必要です。 **[次へ]** を選択します。

3. **[ユーザー ID の作成] ページで、次の設定を行います**。
    ...
    3. [ **ドメインの選択] で**、[ **.onmicrosoft.com** ] を選択します。 後でドメインを設定したり、既に所有しているMicrosoft 365に接続したりするのに役立ちます。
...
> [!IMPORTANT]
> 既存のユーザー アカウントMicrosoft 365キャンペーン のキャンペーン オファーをMicrosoft 365できません。
