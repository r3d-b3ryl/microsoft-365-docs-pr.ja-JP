...
次の手順は、Microsoft 365 Business Premiumをお持ちのお客様に適用されます。 [Windows 10デバイスをセキュリティで保護](../business-premium/m365bp-secure-windows-devices.md)し、[Intuneに登録](/mem/intune/enrollment/windows-enrollment-methods)する必要があります。
