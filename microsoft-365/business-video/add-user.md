...
1. 管理センターでMicrosoft 365[**ユーザー管理]** に移動し、[ユーザーの追加] を選択します。
...
1. ユーザーが正常に作成されたことを確認します。Microsoft 365管理センターの左側のナビゲーション ウィンドウで、[ユーザー] 、[アクティブユーザー]**の順に選択します**。 割り当てられたライセンスと共に、新しいユーザーを一覧表示する必要があります。