...
1. Web サイトを Microsoft 365 と統合するには、ビジネスメールを Web サイトに追加し、Microsoft Teams、SharePoint、または他のコラボレーション ツールへのリンクを追加できます。
1. Web サイトをドメイン名に接続し、Microsoft 365&#39;に使用する必要があります。