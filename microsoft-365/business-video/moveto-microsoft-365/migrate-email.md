...
1. 管理センター **Microsoft 365左側** のナビゲーションで、[すべて表示] 、[ドメイン] 、および **[ドメインの設定] の順** に **選択します**。  
...
1. 管理センターでオフにした場所Microsoft 365 **に戻り**、[続行] を **選択します**。 
...
1. 次の手順を開始するには、管理センターの [ドメインの追加] ウィザードMicrosoft 365[アクティブ ユーザーに移動]**を選択します**。 
...
1. 管理センターの左側のナビゲーション **で** Microsoft 365管理センターまで下にスクロールし、[管理センター] を選択 **Exchange。** 
