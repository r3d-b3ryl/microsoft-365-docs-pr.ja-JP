...
description: 組織内のすべてのユーザーに適用Windows 10デバイス ポリシーを構成し、セキュリティで保護された方法で接続する方法について説明します。
...
セットアップ中に、組織内のすべてのユーザーに適用Windows 10デバイス ポリシーを作成します。 ユーザーが自分の Windows 10 デバイスの Office アプリ に自分の仕事または学校のアカウントでサインインすると、構成した設定が自動的に適用され、ユーザーが安全な方法で接続している必要があります。
