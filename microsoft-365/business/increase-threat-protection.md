...
1. [管理センター Microsoft 365で、[管理センター]**を選択Exchange。** \> 
...
安全な添付ファイル ポリシーを作成するには、この短 [いビデオを見](../business-video/safe-attachments.md)るか、次の手順を実行します。
...
セーフ リンクを設定するには、この [短いトレーニング ビデオを見る](../business-video/safe-links.md)、または次の手順を実行します。
