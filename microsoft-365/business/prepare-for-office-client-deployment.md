...
次の表に、エンド ユーザー/管理者が、ビジネス管理コンソール用の Microsoft 365 から 32 ビット クイック実行 バージョンの Office 展開を成功するために必要なアクションを示します。
  
|**Office インストールの開始状態**|**ビジネス アプリケーションのインストールMicrosoft 365前に実行Officeアクション**|**終了状態**|
|:-----|:-----|:-----|
