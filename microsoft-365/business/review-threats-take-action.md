...
以下の手順は、お客様がご利用のお客様Microsoft 365 Business Premium。 [Windows 10デバイスをセキュリティで保護し、Intune](./secure-win-10-pcs.md) [に登録する必要があります](/mem/intune/enrollment/windows-enrollment-methods)。
