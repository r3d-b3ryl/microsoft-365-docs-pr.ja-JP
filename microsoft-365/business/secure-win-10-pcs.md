...
この設定[が](set-up.md)Microsoft 365 Business Premium、組織の Windows 10 コンピューターと、ウイルスやマルウェアなどの悪意のある脅威から保護する必要があります。
...
4. [コンピューター **のセキュリティWindows 10] ウィンドウ** で、有効にするオプションを選択します。 設定の詳細については、「Secure [Windows 10 デバイス」を参照してください](secure-windows-10-devices.md)。 
...
1. [設定 **の適用] を選択します**。
    ...
    これらの設定は、組織内のすべてのユーザーに適用されます。 異なるセキュリティ グループに対して異なるポリシーを設定するには、「デバイス保護設定を設定する」を参照Windows 10[してください](protection-settings-for-windows-10-pcs.md)。