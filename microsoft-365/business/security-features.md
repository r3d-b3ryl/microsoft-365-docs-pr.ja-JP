...
## <a name="microsoft-365-admin-center-security-features"></a>Microsoft 365管理センターのセキュリティ機能
...
- [デバイスのデバイス保護設定をWindows 10します](protection-settings-for-windows-10-pcs.md)。 
    ...
    デバイスが紛失[BitLocker](/windows/security/information-protection/bitlocker/bitlocker-frequently-asked-questions)場合のデータ保護に役立つ暗号化を有効にし、Windows [Exploit Guard](/windows/security/threat-protection/microsoft-defender-atp/enable-exploit-protection)でランサムウェアに対する高度な保護を提供できます。 
...
- **[Azure portal での Intune の完全な機能](/mem/intune/fundamentals/what-is-intune)**
    ...
    Azure portal の Intune 管理センターにアクセスすると、macOS デバイス、iPhone、Android デバイスの管理などの追加のセキュリティ機能と、Microsoft 365 管理センターでは利用できない Windows の高度なデバイス管理をセットアップできます。
- **Azure [と同じ](/azure/active-directory/conditional-access/overview)条件付きアクセスAD プレミアム P1 プラン**
...
これらの機能は、セキュリティ コンプライアンス センター &amp; と Intune 管理センターで管理できます。 時間がたつ間に、簡略化されたコントロールが管理センター Microsoft 365されます。
