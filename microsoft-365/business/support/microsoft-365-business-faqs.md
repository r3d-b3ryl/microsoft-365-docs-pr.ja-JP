...
- Office 365 Advanced Threat Protection プラン1および Windows Defender Exploit Guard を使用して、フィッシングや高度なマルウェアなどの外部の脅威からの保護を提供します。 
-  Office 365 のデータ損失防止ポリシーと Azure Information Protection プラン1を使用して、機密情報へのアクセスと転送を制御し、管理するのに役立てることができます。 
...
* ユーザーとデバイスをセットアップおよび管理するための単一の管理コンソール 
...
- ビジネスに接続するデバイスをセキュリティで保護し、iOS、Android、Windows、および Mac デバイス上のデータをセキュリティで保護して、Windows デバイスを最新の状態に保つことができます。

Microsoft 365 Business は Office 365 と完全に統合されており、管理、課金、24時間365日のサポートのためのおなじみの場所を提供します。 これは、従業員数が300未満の企業向けに構築されたエンタープライズレベルのテクノロジで構成されています。 

### <a name="how-can-i-get-microsoft-365-business-for-my-business"></a>ビジネス向けの Microsoft 365 Business を入手するにはどうすればよいですか。 

Microsoft 365 Business は、microsoft の<a href="https://www.microsoft.com/solution-providers/search" target="_blank">パートナー</a>を通じて、または直接<a href="https://www.microsoft.com//microsoft-365/business" target="_blank">microsoft</a>から購入できます。 Microsoft から直接購入するか、Microsoft パートナー経由で購入するかを選択する際に、担当スタッフの技量と、IT インフラストラクチャを維持する必要があるかどうかを検討してください。 Microsoft パートナーは、Microsoft のソリューションを含む IT インフラストラクチャの展開と管理に役立ちます。

### <a name="how-much-does-microsoft-365-business-cost"></a>Microsoft 365 Business のコストはどの程度ですか。 

Microsoft 365 Business は、Microsoft から直接購入した場合、_年間契約_に基づいて USD$20.00/月/ユーザーで提供されます。 Microsoft パートナー経由で購入した場合、価格はパートナーが提供するサービスや、Microsoft 365 Business の価格モデルによって異なる可能性があります。 
...
IT 環境を標準化することによって、メンテナンスとセキュリティのコストを徐々に削減でき、企業が達成すべき状態になります。 ただし、一部の中小規模のお客様は、ハードウェアを長期間にわたってアップグレードする際に、ソフトウェアを主に更新することを認識しています。 企業は組織の一部に Microsoft 365 Business を展開することもできますが、重要なビジネス データを保護し、一貫した共同作業のエクスペリエンスを提供するために、すべてのユーザーに展開することをお勧めします。
...
現在利用しているハードウェアで Windows 7 Pro 以降を実行している場合、Microsoft 365 Business の最小要件を満たしていると考えられます。 Cortana、Windows Hello、マルチタッチなどの Windows 10 の一部の機能には、新しい Pc でのみ利用できる特定のハードウェアが必要です。 詳細については、「 <a href="https://www.microsoft.com/windows/windows-10-specifications" target="_blank">Windows 10 Pro システムの要件</a>」を参照してください。 
...
Windows 10 Business は、Windows 10 Pro を補完し、Microsoft 365 Business の集中管理およびセキュリティ制御を可能にする、一連のクラウドサービスおよびデバイス管理機能です。
...
Windows 7、8、および 8.1 Professional のライセンスを持つデバイスがある場合、Microsoft 365 Business は windows 10 Pro へのアップグレードを提供します。これは、Windows 10 Business を展開するための前提条件です。
> [!IMPORTANT]
...
Microsoft 365 Business は、お客様がビジネス情報にアクセスしたり、保持したり、共有したりすることを防ぐことができるようにする一方で、従業員が自分の個人用デバイスを使用できるようにすることができます。 具体的な機能は次のとおりです。 
* **Office モバイルアプリのアプリ保護**は office データを保護するのに役に立ちます。 IOS および Android モバイルデバイス上の電子メール、予定表、連絡先、ドキュメントなどのポリシーを適用することにより、サービスに接続せずに、指定された期間後に自動的にビジネスデータを削除するなどのポリシーを適用することにより、office アプリにアクセスするために PIN/指紋検証を要求し、office アプリから個人用アプリにデータを Intune を介した他のモバイルアプリのモバイルアプリケーション管理も、Microsoft 365 Business サブスクライバーで利用できます。 
  
* **Windows 10 PC 向けのデバイス管理**により、企業は、Windows Defender によるマルウェア対策、自動更新、一定時間後の画面のオフなどの機能を設定して適用できます。 また、Windows 10 デバイスの紛失または盗難は、管理センターを介してビジネスアプリケーションやデータを完全にワイプすることができます。 
...
Microsoft 365 Business で管理されている PC は Windows Defender で保護されています。 これは、Windows 10 で最も使用されているウイルス対策機能であり、他のソリューションよりも多くのコンピューターを、ウイルス、マルウェア、スパイウェア、その他の脅威から保護しています。  Microsoft 365 Business を使用すると、組織は Windows Defender の保護が実行されており、Windows 10 デバイスすべてを常に最新の状態に保つことができます。  
 
Windows 10 Business には、Windows Defender Exploit Guard が搭載されています。これには、新しいアタック防止機能のセットが含まれています。 その機能の1つである [制御されたフォルダーアクセス] は、フォルダーをロックダウンし、承認されていないアプリがユーザーの重要なファイルにアクセスするのを防ぐことで、ランサムウェアを停止 

### <a name="whats-the-difference-between-office-365-business-premium-microsoft-365-business-and-microsoft-365-enterprise"></a>Office 365 Business Premium、Microsoft 365 Business、および Microsoft 365 Enterprise の違いは何ですか。 

Microsoft は、デスクトップとデバイスのインフラストラクチャをアップグレードするときに、より強力な機能を提供するように、中小規模のお客様を対象とした、さまざまな生産性とセキュリティ管理のソリューションを提供しています。 

**Office 365 Business Premium**は、office 365 のアプリとサービスに対してクラス最高の生産性を提供します。ただし、Microsoft 365 Business のアプリケーション保護とデバイスの管理機能は含まれていません。
...
**Microsoft 365 Enterprise**は、Microsoft 365 Business のコンプライアンスおよびセキュリティ管理のレベルが向上しており、企業のお客様や、300ユーザーを超える顧客向けに設計されているライセンスプランのセットです。 さらに、Microsoft 365 Enterprise プランでは、ビジネスインテリジェンスおよび分析ツールを含む追加機能が提供されます。

### <a name="can-i-switch-my-office-365-plan-to-microsoft-365-business"></a>Office 365 プランを Microsoft 365 Business に切り替えることはできますか。 

はい。お客様は、正規の Office 365 プランから Microsoft 365 Business へのプランを切り替えることができます。 お客様の現在のプランによっては、月々の料金が減少または増加することがあります。

### <a name="in-what-regions-is-microsoft-365-business-available"></a>Microsoft 365 Business はどのような地域で利用できますか。 

Microsoft 365 Business は、Office 365 が使用可能なすべてのパートナーおよびお客様が利用できます。 <a href="https://products.office.com/business/international-availability" target="_blank">言語、国、地域の Office 365 の国際的な可用性</a>のリストを参照してください。 
...
Microsoft 365 のビジネス評価版は、Csp で利用できます。 ダイレクトお客様の試用版は後で利用可能になります。 
...
Microsoft 365 Business のすべての機能を使用することを望むお客様は、既存のデスクトップで Windows 7、8.1、または 10 Pro<sup>[2](#footnote2)</sup>を実行している必要があります。 既存の Windows 10 Pro PC で、Creators Update をまだ実行していない場合は、Creators Update を実行している必要があります。 
...
Microsoft では、CSP パートナーが Microsoft 365 Business をマーケティング、販売、サポートするためのさまざまなリソースを提供しています。 これらのリソースについては、[https://partners.office.com/microsoft365business](https://partners.office.com/microsoft365business) を参照してください。
...
Microsoft 365 Business を使用すると、パートナーは、追加のサービスを販売したり既存の製品やサービスをアップグレードしたりするための堅固で安全なプラットフォームを作成することで、お客様との信頼できるアドバイザーの位置づけを維持できます。 Microsoft 365 Business では、現在、Exchange Server、Exchange Online、または Office 365 Business Essentials を使用して、お客様とのアップグレードに関するディスカッションを行うことができます。 パートナーは、増加した管理サービスや peruser サポート料金の収益を得ることもできます。 
