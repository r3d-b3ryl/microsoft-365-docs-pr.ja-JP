...
1. [管理センター Microsoft 365で、[管理センター]**をクリックExchange。** \> 
...
ユーザーが予定表の共有を許可されている場合は、Web[](https://support.office.com/article/7ecef8ae-139c-40d9-bae2-a23977ee58d5)上のユーザーから共有する方法Outlook参照してください。
