...
2. 変更するサブスクリプションを選択し、[**支払いの詳細の変更**] を選択します。
    ...
    ![クレジット カードを使用して支払われているサブスクリプションのサブスクリプション カードの [支払い方法] セクション。](../../admin/media/6c9d9cae-6086-4687-a979-bb971f35f1b4.png)
...
2. 変更するサブスクリプションを選択し、[**支払いの詳細の変更**] を選択します。
    ...
    ![請求書を使用して支払われているサブスクリプションのサブスクリプション カードの [支払い方法] セクション。](../../admin/media/51ab38aa-6e15-4e51-9f27-261c38c98fed.png)
