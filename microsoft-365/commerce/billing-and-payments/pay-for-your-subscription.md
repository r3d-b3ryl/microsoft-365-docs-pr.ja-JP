...
サブスクリプションを設定するときは、クレジットカードの支払いを使用して支払いを行うか、小切手または電子ファンド振替 (EFT) を使用して請求書で支払いするかを選択できます。 ここで選択した支払い方法は、[支払い方法を変更](change-payment-method.md)しない限り、以降の請求期間に対して支払い方法として使用されます。

> [!NOTE]
> 銀行口座による支払いは、一部の国や地域では使用できません。

## <a name="pay-by-credit-card-or-bank-account"></a>クレジット カードで支払う
...
クレジット カードでの支払いを選んだときに、クレジット カードが拒否された場合、支払いプロセスが完了できなかったことを通知するメールが送信されます。 これは、クレジット カードの有効期限が切れている場合など、いくつかの理由で発生します。 トランザクションは、数日ごとに再試行されます。 再試行に失敗すると、引き続きそれらの失敗について警告のメールが送信されます。 いつでも**決済残高**機能を使用して、クレジットカード情報を変更し、すぐに支払いを再送信することができます。
...
2. 未払い残高があるサブスクリプションを検索します。 [**請求**] セクションで、[**サブスクリプションの支払期日**] の横にある [未払い**残高**] を選択します。

3. クレジットカードの所有者である場合は、カードの有効期限を変更するか、別のカードを選ぶか、または[新しいカードを追加](add-update-or-remove-credit-card-or-bank-account.md)することができます。

    > [!NOTE]
    > **決済バランス**機能を使用すると、アカウントの未払い残高全体が請求されます。これは、他の場所に表示されている金額を超える可能性があります。

4. クレジットカードの所有者でない場合は、別のクレジットカードを選択するか、[新しいカードを追加](add-update-or-remove-credit-card-or-bank-account.md)することができます。

5. クレジットカード情報を更新した後、またはサブスクリプションの支払いに使用されたクレジットカードを変更した後、[**保存**] を選択します。
...
2. 変更するサブスクリプションを選択します。 **[自分の請求書**] セクションで、[**今すぐ支払う**] を選択します。
...
5. クレジットカード情報を更新した後、またはサブスクリプションの支払いに使用されたクレジットカードを変更した後、[**送信**] を選択します。 「お支払い方法が更新され、すべての未払い料金が決済されました」という確認メッセージが表示されます。 よろしくお願いいたします。
...
> [!NOTE]
> ブラジルに居住しているお客様は、Bancario を使用したサブスクリプションに対して料金を支払うことができます。 このオプションを選択した場合、支払いの直方体は、注文日から10営業日以内にサブスクリプションを購入したときに提供される電子メールに送信されます。 期日は、注文日から30日後になります。 電子メールでの表示を受信しない場合は、[スパム] フォルダーをチェックするか、サポートにお問い合わせください。 <br><br>必要に応じて、アカウント間で電子メールで支払うことができます。 エージェンシーとアカウント番号は、請求書の末尾にあります。 [転送 id] フィールドに請求書番号を入力する必要があります。
...
> [!NOTE]
> 既定により、組織の請求書は、組織のすべての全体管理者および課金管理者の Office 365 メール アドレスおよび連絡用電子メール アドレスに送信されます。 別の電子メールアドレスを変更するには、「[請求先住所を変更](change-your-billing-addresses.md)する」を参照してください。
...
> [!NOTE]
> クレジット カードでの自動支払いに切り替える場合、最初に必ずすべての未払い残高をお支払いください。 請求明細書の支払いオプションと手順を確認してください。 詳細については、「[請求書につい](understand-your-invoice2.md)て」を参照してください。
 ...
 **下にあるドロップダウンメニューから、[請求先] の国または地域を選択します。**
...
- 2つの個別のメールが表示されます。これにより、請求書の準備ができていることを確認できます。また、管理センターにログオンして表示するための指示と、請求明細書が添付ファイルとして含まれる2番目の電子メールを知ることができます。

### <a name="to-receive-your-billing-statement-in-email"></a>請求明細書を電子メールで受信するには
...
サブスクリプションを調整して支払い金額が少なくなったために、請求書での支払いが不適切になった場合など、請求書またはクレジット カードを選んだ本来の理由が変わってきた場合は、支払い方法を変更できます。 詳細については、「[支払い方法を変更する](change-payment-method.md)」を参照してください。
