...
古いサブスクリプションに複数のサービスが含まれていて、ユーザーが割り当てられているサービスのいずれかを変更した場合は、後でこれらの変更を再作成できるように計画をアップグレードする前に、この点をメモしてください。 すべてのユーザーには、新しいサブスクリプションのすべてのサービスへのアクセス権が与えられます。 たとえば、Microsoft 365 Business Premium をユーザーの100すべてに対して以前に購入していて、そのうちの50から SharePoint Online サービスを割り当てていない場合、この変更はプランのアップグレード後に保持されません。
