...
3. 定義したテンプレートのカスタマイズを定義するには、「 [omeconfiguration](https://docs.microsoft.com/powershell/module/exchange/encryption-and-certificates/Set-OMEConfiguration)設定」で説明されているように、このコマンドレットを使用するか、または次の表を参考にしてください。
