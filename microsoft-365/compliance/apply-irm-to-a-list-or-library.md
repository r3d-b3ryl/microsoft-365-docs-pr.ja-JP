...
|ドキュメントを開くライセンスが付与されているプログラムに対して Azure RMS 資格情報がキャッシュされる間隔を制御します。|[ **ユーザーはこの間隔 (日) を使用して資格情報を確認する必要があります** ] チェック ボックスをオンにし、資格情報をキャッシュする間隔を日数で入力します。|
...
|Other|IRM アクセス許可に直接対応する他のアクセス許可はありません。|
