...
3. Microsoft 365 コンプライアンス センターで作成する Oracle コネクタ上の Cisco Jabber は、毎日 Veritas Merge1 サイトに接続し、Jabber コンテンツを Microsoft クラウド内の安全なAzure Storageの場所に転送します。
...
最初の手順では、Microsoft 365 コンプライアンス センターの **[データ コネクタ**] ページにアクセスし、Jabber データ用のコネクタを作成します。
