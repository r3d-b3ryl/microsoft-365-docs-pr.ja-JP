...
---
# <a name="set-up-a-connector-to-archive-jive-data-preview"></a>Jive データをアーカイブするためのコネクタを設定する (プレビュー)
...
2. [ **コネクタ** ] タブをクリックし、[ **Jive** コネクタ] を選択して、コネクタに関するプロパティと情報を含むフライアウトページを表示します。
