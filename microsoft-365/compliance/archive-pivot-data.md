...
---
# <a name="set-up-a-connector-to-archive-pivot-data-preview"></a>ピボットデータをアーカイブするコネクタを設定する (プレビュー)
...
2. [ **コネクタ** ] タブをクリックし、[ **ピボット** コネクタ] を選択して、コネクタに関するプロパティと情報を含む、フライアウトページを表示します。
