...
---
# <a name="set-up-a-connector-to-archive-redtail-speak-data-preview"></a>Redtail Speak データをアーカイブするコネクタをセットアップする (プレビュー)
...
1. 組織は Redtail Speak と連携して、毎日のメッセージが Redtail Speak から組織の SFTP サーバーに転送される SMTP ゲートウェイを設定および構成します。
...
- 手順で、組織の SFTP サーバーを指定する必要があります。 これは、Globanet Merge1 が SFTP を介して Redtail Speak データを収集するために通信するために必要です。
