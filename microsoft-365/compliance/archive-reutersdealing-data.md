...
3. Microsoft 365 コンプライアンス センターで作成したロイターの対応コネクタは、毎日 Veritas Merge1 サイトに接続し、Microsoft クラウド内のセキュリティで保護された Azure Storage 場所にコンテンツを転送します。
...
ロイター取引コネクタを作成した後、コンプライアンス センターでコネクタのMicrosoft 365できます。
