...
3. Microsoft 365 コンプライアンス センターで作成したロイター FX コネクタは、毎日 Veritas Merge1 サイトに接続し、Microsoft クラウド内の安全な Azure Storage の場所にコンテンツを転送します。
