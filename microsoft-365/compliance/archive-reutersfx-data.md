...
3. Microsoft 365 コンプライアンス センターで作成したロイター FX コネクタは、毎日 Veritas Merge1 サイトに接続し、Microsoft クラウド内の安全な Azure Storage 場所にコンテンツを転送します。
...
ロイター FX コネクタを作成した後、コンプライアンス センターでコネクタのMicrosoft 365できます。
