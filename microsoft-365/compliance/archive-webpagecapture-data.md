...
ms.locfileid: "48409145"
---
# <a name="set-up-a-connector-to-archive-webpage-data-preview"></a>Web ページデータをアーカイブするためのコネクタを設定する (プレビュー)
...
2. [ **コネクタ** ] タブをクリックし、[ **Web ページ] キャプチャ** コネクタを選択して、コネクタに関するプロパティと情報を含むフライアウトページを表示します。
