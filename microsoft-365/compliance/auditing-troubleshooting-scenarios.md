...
削除済みアイテムの保持期間が経過していない場合、ユーザーは削除済みアイテムを回復できます。 このExchange Online、削除済みアイテムの既定の保持期間は 14 日ですが、管理者は、この設定を最大 30 日間に増やします。 削除済みアイテムの[回復](https://support.office.com/article/Recover-deleted-items-or-email-in-Outlook-Web-App-C3D8FC15-EEEF-4F1C-81DF-E27964B7EDD4)方法については、web Outlookの [削除済みアイテムまたはメールの復元] をポイントします。
