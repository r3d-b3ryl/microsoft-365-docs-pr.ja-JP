...
---
# <a name="build-search-queries-in-data-investigations-preview"></a>データ調査で検索クエリを作成する (プレビュー)

検索クエリの作成時に、キーワードを使用して特定のコンテンツと条件を見つけ、検索範囲を絞り込んで、調査に最も関連性の高いアイテムを返すことができます。
