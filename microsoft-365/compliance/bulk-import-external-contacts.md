...
5. 必要に応じて **、[最新** ![の情報に更新] アイコン](media/O365-MDM-Policy-RefreshIcon.gif)をクリックしてリストを更新し、インポートされた外部連絡先を表示します。 
...
## <a name="hide-external-contacts-from-the-shared-address-book"></a>共有アドレス帳から外部連絡先を非表示にする>
