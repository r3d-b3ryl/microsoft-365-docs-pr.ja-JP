...
> [!IMPORTANT]
> コンテンツ エクスプローラーで、アイテム保持ラベル ポリシーを Exchange アイテムに自動適用するフィードバックを提供し、分類子を条件として使用します。 **アイテム保持ラベルを Exchange アイテムに自動適用し、条件として分類子を使用するアイテム保持ポリシーを持ってない場合は、ここで停止します。**
...
1. コンプライアンス管理者またはセキュリティ管理者の役割アクセスを使用して Microsoft 365 コンプライアンス センターにサインインし **、Microsoft 365 コンプライアンス** センターデータ分類コンテンツ エクスプローラー  >  **を**  >  **開きます**。 
