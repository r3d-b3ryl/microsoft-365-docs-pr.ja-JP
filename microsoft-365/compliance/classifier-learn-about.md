...
> [!IMPORTANT]
> 判別トレーニング可能な分類子は、北米のデータ センターにMicrosoft 365テナントを持つ顧客にのみパブリック プレビューとして利用できます。 テナントがホームMicrosoft 365を確認するには、Microsoft 365 管理 センターを開き、[組織の設定] 設定[組織プロファイル データの場所]  >    >    >  **に移動します**。 
