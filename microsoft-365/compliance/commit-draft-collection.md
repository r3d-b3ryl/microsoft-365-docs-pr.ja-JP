...
1. コンプライアンス センター Microsoft 365、Advanced eDiscovery ケースを開き、[コレクション] タブを選択して、ケース内のコレクションの一覧を表示します。
...
5. 以下の設定を構成します。
   ...
   2. 新しいレビュー セット (コレクションを送信した後に作成される) にコレクションを追加するか、既存のレビュー セットに追加するかどうかを決定します。 決定に基づいてこのセクションを完了します。
