...
通信コンプライアンス ポリシーの一致は、各ポリシーの監督メールボックスに格納されます。 場合によっては、監視メールボックスのサイズを確認して、現在の 50 GB の制限に近づいていか確認する必要がある場合があります。 メールボックスの制限に達した場合、ポリシーの一致はキャプチャされません。同じアクティビティの一致を引き続きキャプチャするには、新しいポリシー (同じ設定) を作成する必要があります。
