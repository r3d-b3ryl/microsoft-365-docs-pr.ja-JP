...
- **通信コンプライアンスのホームページ**: [https://compliance.microsoft.com](https://compliance.microsoft.com) Microsoft 365 組織の管理者アカウントの資格情報を使用してサインインするときに、[**通信コンプライアンスの**概要] を選択して [  >  **Overview**通信コンプライアンスのホーム] ページを表示します。 次のように表示します。
...
- **[通知] タブ: [****通信コンプライアンス**アラート] に移動し  >  **Alerts**て、ポリシーの一致によってグループ化されたアラートの過去30日間を表示します。 このビューでは、重要度別に並べ替えられた最も多くのアラートを生成している通信コンプライアンスポリシーをすばやく確認できます。  修復操作を開始するには、ポリシーを展開して特定の通知を選択し、[通知の詳細] ページを起動します。
- **[ポリシー] タブ: [****通信コンプライアンス**ポリシー] に移動して  >  **Policies** 、Microsoft 365 組織用に構成された通信コンプライアンスポリシーを表示します。 一覧に表示される各ポリシーには、確認が必要な通知の数が含まれています。 ポリシーを選択すると、ポリシーに一致するすべての保留中のアラートが表示され、[ポリシーの詳細] ページを起動して修復アクションを開始するための特定のアラートを選択します。
...
3. **修復アクションを決定**する: 通知のメッセージの詳細を確認したので、いくつかの修復アクションを選択できます。
    ...
    - **エスカレート**:**エスカレート**コントロールを使用して、組織内の他の誰がメッセージを確認する必要があるかを選択できます。 コミュニケーションコンプライアンスポリシーに構成されたレビュー担当者の一覧から、メッセージ通知の追加のレビューを求める電子メール通知を送信することを選択します。 選択したレビュー担当者は、電子メール通知のリンクを使用して、レビューのためにエスカレートされたアイテムに直接移動することができます。
    - **ケースの作成**: case コントロールの**作成**を使用して、単一または複数のメッセージに対して新しい[電子情報開示ケース](overview-ediscovery-20.md)を作成できます。 新しいケースには名前とメモを指定し、ポリシーに一致するメッセージを送信したユーザーは、保管担当者ケースとして自動的に割り当てられます。 ケースを管理するために追加のアクセス許可は必要ありません。 ケースを作成しても、メッセージの新しいタグは解決または作成されません。
