...
- **不快な言葉と嫌がらせ対策**: このテンプレートを使用すると、組み込みの脅威、不快感、嫌がらせになる分類子を使用して、不適切または不快なコンテンツを自動的に検出するポリシーをすばやく作成できます。
...
- **カスタムポリシー**: このテンプレートを使用して、組織内の特定の通信チャネル、分類子、個々の検出条件、および監視対象のコンテンツの量を構成します。
