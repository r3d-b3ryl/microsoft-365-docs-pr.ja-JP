...
- **警告**: メッセージがポリシーの条件に一致すると、アラートが自動的に生成されます。 各警告について、状態、重大度、検出された時刻、およびケースが割り当てられているかどうか、およびその状態が表示されます。 新しい通知が [通信コンプライアンスのホーム] ページと [**通知**] ページに表示され、重要度の順に一覧表示されます。
