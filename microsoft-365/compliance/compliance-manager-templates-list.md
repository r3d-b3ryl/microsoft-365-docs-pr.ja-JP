...
- **含まれるテンプレートは** 、組織のライセンス契約の一部として含まれるテンプレートです。
 - **プレミアムテンプレートには**、組織が取得する可能性がある追加のテンプレートが表示されます (サービス用語を [参照](/office365/servicedescriptions/microsoft-365-service-descriptions/microsoft-365-tenantlevel-services-licensing-guidance/microsoft-365-security-compliance-licensing-guidance))。
...
- [EU GDPR](/compliance/regulatory/gdpr) (Microsoft 365、Office 365 Intune)
...
- [CFR - 連邦規制のコード タイトル 21、パート 11、](/compliance/regulatory/offering-fda-cfr-title-21-part-11)電子記録、電子署名 (Microsoft 365)
...
- コロラド州改訂規則、セクション 6-1-716、セキュリティ侵害の通知 (Microsoft 365)
...
- [刑事司法情報サービス (CJIS) セキュリティ ポリシー](/compliance/regulatory/offering-cjis) (Microsoft 365)
...
- [連邦金融機関審査評議会 (FFIEC) Information Security Booklet](/compliance/regulatory/offering-ffiec-us) (Microsoft 365, Intune)
...
- ジョージアの個人データ保護に関する法律 (Microsoft 365)
...
- ISO 19791 - 情報テクノロジ - セキュリティ技術 - 運用システムのセキュリティ評価 (Microsoft 365)
...
- ISO 55001 – アセット管理 -- 管理システム--Requirements (Microsoft 365)
...
- 日本 - 政府機関および関連機関の情報セキュリティ対策に関する一般的な基準 (Microsoft 365)
...
- 個人データに関するウズベキスタン共和国の法律 (Microsoft 365)
...
- Mississippi セキュリティ侵害通知 (Microsoft 365)
- Montana - Identity Theft の障害 (Microsoft 365)
- モンテネグロ - 個人データ保護に関する法律 (Microsoft 365)
- [映画関連付け (MPA) コンテンツ セキュリティの](/compliance/regulatory/offering-mpaa)ベスト プラクティス (Microsoft 365)
...
- [個人データに関する](/compliance/regulatory/offering-russia-data-localization)ロシア連邦法 (Microsoft 365)
...
- サウス ダコタ州 - 違反に関する通知 (Microsoft 365)
...
- [システムおよび組織の制御 (SOC) 2](/compliance/regulatory/offering-soc)
...
- [信頼できる情報セキュリティ評価 Exchange](/compliance/regulatory/offering-tisax-germany)
- トルコ - KVKK 個人データ保護 6698 (Microsoft 365)
- UAE - サイバー犯罪対策に関する連邦法令 (Microsoft 365)
- UAE - 電子取引と商取引に関する連邦法
- UAE - 2019 年の連邦法 No 2 健康分野における情報通信技術 (ICT) の使用に関する法律 (Microsoft 365)
...
- ウガンダ - データ保護およびプライバシー法 (Microsoft 365)
- 英国 - 防御サプライヤー向けサイバーセキュリティ標準 05-138 (Microsoft 365)
...
- 英国のデータ保護法 (Microsoft 365)
- 英国のデータ保持法 (Microsoft 365)
- 英国のプライバシーと電子通信 (Microsoft 365)
- ウクライナ - 個人データ保護法 (Microsoft 365)
- 米国プライバシー法 (Microsoft 365)
- 米国 - データの合法な海外使用 (CLOUD) 法の明確化 (Microsoft 365)
- 米国 - パブリック企業のサイバーセキュリティ開示に関する委員会声明とガイダンス (Microsoft 365)
...
- 米国 - テロ攻撃法からの化学施設の保護と確保 (Microsoft 365)
