...
1. **改善アクション**: 各アクションは、関連する潜在的なリスクに応じてスコアに異なる影響を与えます。 詳細については、 [以下のアクションの種類とポイント](#action-types-and-points) を参照してください。

2. **評価**: このスコアは、改善アクション スコアを使用して計算されます。 コントロールで参照される頻度に関係なく、組織によって管理される各 Microsoft アクションと各改善アクションは 1 回カウントされます。
...
1. **改善アクション**: 組織によって管理される
2. **Microsoft アクション**: Microsoft によって管理される
