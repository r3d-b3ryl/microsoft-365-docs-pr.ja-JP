...
3. [アクティビティ通知 **] ページで** 、[追加] アイコン ![ をクリックします。](../media/8ee52980-254b-440b-99a2-18d068de62d3.gif) **New**.

   アクティビティアラートを作成するフライアウト ページが表示されます。


    ![アクティビティアラートを作成します。](../media/53888bd5-9fa2-4398-8ccc-1a9dc72517ac.png)
...
5. [保存 **] をクリック** してアラートを作成します。
    ...
    ![[アクティビティ通知] ページにアラートの一覧が表示されます。](../media/02b774f2-1719-41de-bbc9-5e5b7576f335.png)
