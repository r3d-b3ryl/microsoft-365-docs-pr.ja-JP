...
- 削除された Exchange Online メールボックスに関連付けられたライセンスは、対応するユーザーアカウントを削除した後に使用できるようになります。 その後、[これらのライセンスを別のユーザーに割り当てる](../admin/manage/assign-licenses-to-users.md)ことができます。
