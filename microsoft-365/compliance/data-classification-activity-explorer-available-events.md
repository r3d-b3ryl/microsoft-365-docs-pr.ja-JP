...
|Rights Management サービス (RMS)         |該当しない         | |
|Power BI デスクトップと Web        | 不要| 監査ログMicrosoft 365アクセス可能         |
|Microsoft Cloud App Security (MCAS)         |不要|         |
...
|Outlook         |該当しない         |
|SharePoint Online、OneDrive         |該当しない         |
|Exchange         |該当しない         |
|AIP 統合クライアント         |該当しない       |
