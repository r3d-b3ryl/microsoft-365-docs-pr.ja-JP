---
title: Configuration Manager をWindows 10使用Windows 11 台のデバイスをオンボードおよびインストールする
f1.keywords: NOCSH
ms.author: chrfox
author: chrfox
manager: laurawi
...
ms.locfileid: "60950894"
---
# <a name="onboard-windows-10-and-windows-11-devices-using-configuration-manager"></a>Configuration Manager をWindows 10使用Windows 11 台のデバイスをオンボードおよびインストールする
...
1. Microsoft コンプライアンス センターから.zip *(DeviceComplianceOnboardingPackage.zip)*[を取得します](https://compliance.microsoft.com/)。
...
> [!NOTE]
> Microsoft 365情報保護は、アウトオブボックス エクスペリエンス[(OOBE)](https://answers.microsoft.com/en-us/windows/wiki/windows_10/how-to-complete-the-windows-10-out-of-box/47e3f943-f000-45e3-8c5c-9d85a1a0cf87)フェーズ中のオンボーディングをサポートしない。 インストールまたはアップグレードの実行後にユーザーが OOBE をWindows確認します。
...
2. デバイスが Microsoft 365 デバイス オンボーディング サービスに準拠している (これにより、デバイスがオンボーディング プロセスを完了し、サービスにデータを報告し続け可能になります)。
