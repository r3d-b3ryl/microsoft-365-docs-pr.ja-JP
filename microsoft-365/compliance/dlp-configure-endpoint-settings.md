...
**制限付きアプリ グループ (プレビュー) 内のアプリのアクティビティをファイルする**、**すべてのアプリのファイル アクティビティ**、および **制限付きアプリ アクティビティ** のリスト間の相互作用は、同じルールにスコープされます。

##### <a name="restricted-app-groups-overrides"></a>制限付きアプリ グループのオーバーライド

**制限付きアプリ グループ内のアプリのファイル アクティビティ (プレビュー)** で定義されている構成は、同じルール内の **制限付きアプリアクティビティ** のリストと **すべてのアプリのファイル アクティビティ** をオーバーライドします。
