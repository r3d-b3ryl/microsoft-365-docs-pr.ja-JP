...
5. [場所の **選択**] タブで、すべてのアカウントの既定の設定を維持するか、[特定の場所を選択して、含めるおよび除外するアカウント、配布リスト、またはセキュリティ グループを指定する] を選択します。 **[次へ]** を選択します。
...
5. [場所の **選択**] タブで、すべてのアカウントの既定の設定を維持するか、[特定の場所を選択して、含める/除外するアカウント、配布リスト、またはセキュリティ グループを指定する] を選択します。 **[次へ]** を選択します。
