...
|**SharePoint Win32/ OneDrive for Business Win32 クライアント**|:::image type="icon" source="../media/crsmrk.png" border="false":::|none|none|DLP ポリシー ヒントは、デスクトップ クライアント アプリSharePoint OneDriveサポートされていません|
