...
データ調査の証拠からドキュメントをエクスポートすると、ドキュメントが Microsoft 提供の Azure ストレージの場所または組織によって管理される Azure ストレージの場所にアップロードされます。 使用される Azure ストレージの場所の種類は、ドキュメントのエクスポート時に選択されたオプションによって異なります。 
...
1. [**データ調査**] ページで、調査に移動し、[**エクスポート**] タブをクリックします。
