...
Microsoft Purview には、コンテンツ検索、電子情報開示 (Standard)、電子情報開示 (プレミアム) の 3 つの電子情報開示ソリューションが用意されています。

![Microsoft Purview 電子情報開示ツールの主な機能。](..\media\m365-ediscovery-solution-graphic.png)
...
- **コンテンツを検索します**。 Exchange メールボックス、OneDrive for Business アカウント、SharePoint サイト、Microsoft Teams、Microsoft 365 グループ、Yammer Teamsに格納されているコンテンツを検索します。 これには、メールボックスやサイトにデータを格納する他のMicrosoft 365 アプリによって生成されたコンテンツが含まれます。

- **キーワード クエリと検索条件**。 KQLキーワード検索クエリを作成して、クエリ条件に一致するコンテンツを検索します。 検索条件を含めて、検索範囲を絞り込むこともできます。
...
- **検索結果をエクスポートします**。 2 段階のプロセスで、組織内のローカル コンピューターに検索結果をエクスポートします。 検索結果をエクスポートすると、アイテムはMicrosoft 365の元のコンテンツの場所から Microsoft 提供のAzure Storageの場所にコピーされます。 その後、これらの項目をローカル コンピューターにダウンロードできます。
...
- **ケース管理**。 電子情報開示 (Standard) と電子情報開示 (プレミアム) の電子情報開示ケースを使用すると、特定の検索とエクスポートを特定の調査に関連付けることができます。 ケースにメンバーを割り当てて、ケースにアクセスできるユーザーを制御し、ケースの内容を表示することもできます。
...
- **訴訟ホールド通知**。 ケース カストディアンと通信するプロセスを管理します。 訴訟ホールド通知は、ケースに関連するコンテンツを保持するようにカストディアンに指示します。 カストディアンによって受信、読み取り、および確認された通知を追跡できます。 電子情報開示 (プレミアム) の通信ワークフローを使用すると、保管担当者が保留通知を確認できなかった場合に、初期通知、リマインダー、エスカレーションを作成して送信できます。
...
- **エラー修復**。 エラー修復と呼ばれるプロセスを使用して処理 *エラーを修正します*。 エラー修復を使用すると、高度なインデックス作成中に電子情報開示 (プレミアム) がコンテンツを適切に処理できないようにするデータの問題を修正できます。 たとえば、パスワードで保護されたファイルは、ファイルがロックまたは暗号化されているため、処理できません。 エラー修復を使用すると、エラーのあるファイルをダウンロードし、パスワード保護を削除してから、修復されたファイルをアップロードできます。

- **セットを確認します**。 関連するデータをレビュー セットに追加します。 レビュー セットは、Microsoft クラウド内のセキュリティで保護された Microsoft 提供のAzure Storage場所です。 レビュー セットにデータを追加すると、収集されたアイテムは元のコンテンツの場所からレビュー セットにコピーされます。 レビュー セットは、予測コーディング モデルを使用して関連性を検索、フィルター処理、タグ付け、分析、予測できる静的な既知のコンテンツ セットを提供します。 また、レビュー セットに追加されるコンテンツを追跡およびレポートすることもできます。

- **クラウドの添付ファイルとSharePointバージョンのサポート**。 レビュー セットにコンテンツを追加する場合は、クラウドの添付ファイルまたはリンクされたファイルを含めるオプションがあります。 つまり、クラウド添付ファイルまたはリンク ファイルのターゲット ファイルがレビュー セットに追加されます。 また、SharePoint ドキュメントのすべてのバージョンをレビュー セットに追加することもできます。
...
- **会話のスレッド処理**。 TeamsおよびYammer会話からのチャット メッセージがレビュー セットに追加されると、会話スレッド全体を収集できます。 つまり、コレクションの条件に一致するアイテムを含むチャット会話全体がレビュー セットに追加されます。 これにより、前後の会話のコンテキストでチャット アイテムを確認できます。
...
## <a name="get-started-with-ediscovery"></a>電子情報開示を使用した概要
