...
ユーザーメールボックスと共有メールボックスについて監査されるメールボックスの操作を変更するに**は、AuditOwner コマンドレット**で*auditadmin*、 *Auditadmin*、または** パラメーターを使用できます (Office 365 グループの監査対象アクション)メールボックスをカスタマイズすることはできません)。
