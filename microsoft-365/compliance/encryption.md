...
## <a name="encryption-for-data-at-rest-and-data-in-transit"></a>保存中のデータと転送中のデータの暗号化
 ...
 保存された**データの例**としては、SharePoint ライブラリにアップロードしたファイル、プロジェクトオンラインデータ、Skype for business 会議にアップロードしたドキュメント、Office 365 メールボックス内のフォルダーに格納した電子メールメッセージと添付ファイル、OneDrive for business にアップロードしたファイルなどがあります。
