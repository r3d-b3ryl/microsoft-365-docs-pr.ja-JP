...
ポリシーの **[許可されていないアプリによるアクセス]** 設定が有効になっていて、許可されていないリストにあるアプリが保護されたファイルにアクセスしようとすると、アクティビティは許可、禁止、または禁止されますが、ユーザーは制限をオーバーライドできます。すべてのアクティビティが監査され、アクティビティ エクスプローラーでレビューできます。
