...
<span data-ttu-id="5a5c3-111">24文字:</span><span class="sxs-lookup"><span data-stu-id="5a5c3-111">24 characters:</span></span>
...
<span data-ttu-id="5a5c3-122">オーストリアの id 番号</span><span class="sxs-lookup"><span data-stu-id="5a5c3-122">austrian identity number</span></span>
...
### <a name="checksum"></a><span data-ttu-id="5a5c3-138">Checksum</span><span class="sxs-lookup"><span data-stu-id="5a5c3-138">Checksum</span></span>
...
<span data-ttu-id="5a5c3-148">「//入力 n」</span><span class="sxs-lookup"><span data-stu-id="5a5c3-148">egn</span></span>
...
## <a name="cyprus"></a><span data-ttu-id="5a5c3-167">キプロス</span><span class="sxs-lookup"><span data-stu-id="5a5c3-167">Cyprus</span></span>
...
### <a name="keywords"></a><span data-ttu-id="5a5c3-178">キーワード</span><span class="sxs-lookup"><span data-stu-id="5a5c3-178">Keywords</span></span>
...
### <a name="pattern"></a><span data-ttu-id="5a5c3-192">パターン</span><span class="sxs-lookup"><span data-stu-id="5a5c3-192">Pattern</span></span>
...
## <a name="france"></a><span data-ttu-id="5a5c3-219">フランス</span><span class="sxs-lookup"><span data-stu-id="5a5c3-219">France</span></span>
...
- <span data-ttu-id="5a5c3-232">シリアル番号に対応する3桁の数字</span><span class="sxs-lookup"><span data-stu-id="5a5c3-232">Three digits that correspond to a serial number</span></span>
...
#### <a name="keywords_hungary_eu_national_id_card"></a><span data-ttu-id="5a5c3-243">Keywords_hungary_eu_national_id_card</span><span class="sxs-lookup"><span data-stu-id="5a5c3-243">Keywords_hungary_eu_national_id_card</span></span>
...
- <span data-ttu-id="5a5c3-259">1つのチェックディジット</span><span class="sxs-lookup"><span data-stu-id="5a5c3-259">One check digit</span></span>
...
<span data-ttu-id="5a5c3-271">個人用パブリックサービス番号</span><span class="sxs-lookup"><span data-stu-id="5a5c3-271">personal public service number</span></span>
...
### <a name="keywords"></a><span data-ttu-id="5a5c3-301">キーワード</span><span class="sxs-lookup"><span data-stu-id="5a5c3-301">Keywords</span></span>
...
<span data-ttu-id="5a5c3-318">11桁の数字と、指定された形式のハイフン</span><span class="sxs-lookup"><span data-stu-id="5a5c3-318">11 digits and a hyphen in the specified format</span></span>
...
### <a name="pattern"></a><span data-ttu-id="5a5c3-345">パターン</span><span class="sxs-lookup"><span data-stu-id="5a5c3-345">Pattern</span></span>
...
### <a name="keywords"></a><span data-ttu-id="5a5c3-359">キーワード</span><span class="sxs-lookup"><span data-stu-id="5a5c3-359">Keywords</span></span>
...
<span data-ttu-id="5a5c3-376">11 桁の数字</span><span class="sxs-lookup"><span data-stu-id="5a5c3-376">11 digits</span></span>
...
<span data-ttu-id="5a5c3-389">個人 id</span><span class="sxs-lookup"><span data-stu-id="5a5c3-389">personal id</span></span>
...
<span data-ttu-id="5a5c3-408">7桁の数字の後に1文字</span><span class="sxs-lookup"><span data-stu-id="5a5c3-408">Seven digits followed by one letter</span></span>
...
### <a name="keywords"></a><span data-ttu-id="5a5c3-421">キーワード</span><span class="sxs-lookup"><span data-stu-id="5a5c3-421">Keywords</span></span>
...
<span data-ttu-id="5a5c3-438">はい</span><span class="sxs-lookup"><span data-stu-id="5a5c3-438">Yes</span></span>
...
<span data-ttu-id="5a5c3-448">一意の識別番号</span><span class="sxs-lookup"><span data-stu-id="5a5c3-448">unique identification number</span></span>
...
<span data-ttu-id="5a5c3-464">13桁の数字 (スペースと区切り文字なし)</span><span class="sxs-lookup"><span data-stu-id="5a5c3-464">13 digits without spaces and delimiters</span></span>
...
### <a name="keywords"></a><span data-ttu-id="5a5c3-475">キーワード</span><span class="sxs-lookup"><span data-stu-id="5a5c3-475">Keywords</span></span>
...
<span data-ttu-id="5a5c3-486">uniqueidentityno#</span><span class="sxs-lookup"><span data-stu-id="5a5c3-486">uniqueidentityno#</span></span>
  
<span data-ttu-id="5a5c3-487">cod 数値個人</span><span class="sxs-lookup"><span data-stu-id="5a5c3-487">cod numeric personal</span></span>
  
<span data-ttu-id="5a5c3-488">cod 識別子 (個人)</span><span class="sxs-lookup"><span data-stu-id="5a5c3-488">cod identificare personal</span></span>
  
<span data-ttu-id="5a5c3-489">cod の識別子は</span><span class="sxs-lookup"><span data-stu-id="5a5c3-489">cod unic identificare</span></span>
  
<span data-ttu-id="5a5c3-490">număr 個人用非 ic</span><span class="sxs-lookup"><span data-stu-id="5a5c3-490">număr personal unic</span></span>
  
<span data-ttu-id="5a5c3-491">număr 識別子縦</span><span class="sxs-lookup"><span data-stu-id="5a5c3-491">număr identitate</span></span>
  
<span data-ttu-id="5a5c3-492">număr 識別子の個人情報</span><span class="sxs-lookup"><span data-stu-id="5a5c3-492">număr identificare personal</span></span>
  
<span data-ttu-id="5a5c3-493">număridentitate#</span><span class="sxs-lookup"><span data-stu-id="5a5c3-493">număridentitate#</span></span>
  
<span data-ttu-id="5a5c3-494">codnumericpersonal#</span><span class="sxs-lookup"><span data-stu-id="5a5c3-494">codnumericpersonal#</span></span>
  
<span data-ttu-id="5a5c3-495">numărpersonalunic#</span><span class="sxs-lookup"><span data-stu-id="5a5c3-495">numărpersonalunic#</span></span>
  
## <a name="slovakia"></a><span data-ttu-id="5a5c3-496">スロバキア</span><span class="sxs-lookup"><span data-stu-id="5a5c3-496">Slovakia</span></span>

### <a name="format"></a><span data-ttu-id="5a5c3-497">Format</span><span class="sxs-lookup"><span data-stu-id="5a5c3-497">Format</span></span>

<span data-ttu-id="5a5c3-498">1つの円記号を含む10桁の数字</span><span class="sxs-lookup"><span data-stu-id="5a5c3-498">Ten digits containing one backslash</span></span>
  
### <a name="pattern"></a><span data-ttu-id="5a5c3-499">パターン</span><span class="sxs-lookup"><span data-stu-id="5a5c3-499">Pattern</span></span>

<span data-ttu-id="5a5c3-500">1つの円記号を含む10桁の数字:</span><span class="sxs-lookup"><span data-stu-id="5a5c3-500">Ten digits containing one backslash:</span></span>
  
### <a name="checksum"></a><span data-ttu-id="5a5c3-501">Checksum</span><span class="sxs-lookup"><span data-stu-id="5a5c3-501">Checksum</span></span>

<span data-ttu-id="5a5c3-502">はい</span><span class="sxs-lookup"><span data-stu-id="5a5c3-502">Yes</span></span>
  
### <a name="definition"></a><span data-ttu-id="5a5c3-503">定義</span><span class="sxs-lookup"><span data-stu-id="5a5c3-503">Definition</span></span>

<span data-ttu-id="5a5c3-504">DLP ポリシーは、抽出した約 300 文字が次の条件に該当することを検出した場合に、85% の確証を持ってそれがこの種類の機密情報であると特定します。</span><span class="sxs-lookup"><span data-stu-id="5a5c3-504">A DLP policy is 85% confident that it's detected this type of sensitive information if, within a proximity of 300 characters:</span></span>
  
- <span data-ttu-id="5a5c3-505">関数`Func_slovakia_eu_national_id_card`は、パターンに一致するコンテンツを検索します。</span><span class="sxs-lookup"><span data-stu-id="5a5c3-505">The function  `Func_slovakia_eu_national_id_card` finds content that matches the pattern.</span></span> 
    
- <span data-ttu-id="5a5c3-506">From `Keywords_slovakia_eu_national_id_card`キーワードが見つかりました。</span><span class="sxs-lookup"><span data-stu-id="5a5c3-506">A keyword from  `Keywords_slovakia_eu_national_id_card` is found.</span></span> 
    
<span data-ttu-id="5a5c3-507">DLP ポリシーは、抽出した約 300 文字が次の条件に該当することを検出した場合に、75% の確証を持ってそれがこの種類の機密情報であると特定します。</span><span class="sxs-lookup"><span data-stu-id="5a5c3-507">A DLP policy is 75% confident that it's detected this type of sensitive information if, within a proximity of 300 characters:</span></span>
  
- <span data-ttu-id="5a5c3-508">関数`Func_slovakia_eu_national_id_card`は、パターンに一致するコンテンツを検索します。</span><span class="sxs-lookup"><span data-stu-id="5a5c3-508">The function  `Func_slovakia_eu_national_id_card` finds content that matches the pattern.</span></span> 
...
### <a name="keywords"></a><span data-ttu-id="5a5c3-509">キーワード</span><span class="sxs-lookup"><span data-stu-id="5a5c3-509">Keywords</span></span>

#### <a name="keywords_slovakia_eu_national_id_card"></a><span data-ttu-id="5a5c3-510">Keywords_slovakia_eu_national_id_card</span><span class="sxs-lookup"><span data-stu-id="5a5c3-510">Keywords_slovakia_eu_national_id_card</span></span>

<span data-ttu-id="5a5c3-511">出生地番号</span><span class="sxs-lookup"><span data-stu-id="5a5c3-511">birth number</span></span>
  
<span data-ttu-id="5a5c3-512">national identification number</span><span class="sxs-lookup"><span data-stu-id="5a5c3-512">national identification number</span></span>
  
<span data-ttu-id="5a5c3-513">個人識別番号</span><span class="sxs-lookup"><span data-stu-id="5a5c3-513">personal identification number</span></span>
  
<span data-ttu-id="5a5c3-514">social security number</span><span class="sxs-lookup"><span data-stu-id="5a5c3-514">social security number</span></span>
  
<span data-ttu-id="5a5c3-515">nationalnumber#</span><span class="sxs-lookup"><span data-stu-id="5a5c3-515">nationalnumber#</span></span>
  
<span data-ttu-id="5a5c3-516">ssn#</span><span class="sxs-lookup"><span data-stu-id="5a5c3-516">ssn#</span></span>
  
<span data-ttu-id="5a5c3-517">ssn</span><span class="sxs-lookup"><span data-stu-id="5a5c3-517">ssn</span></span>
  
<span data-ttu-id="5a5c3-518">国番号</span><span class="sxs-lookup"><span data-stu-id="5a5c3-518">national number</span></span>
  
<span data-ttu-id="5a5c3-519">個人 id 番号</span><span class="sxs-lookup"><span data-stu-id="5a5c3-519">personal id number</span></span>
  
<span data-ttu-id="5a5c3-520">personalidnumber#</span><span class="sxs-lookup"><span data-stu-id="5a5c3-520">personalidnumber#</span></span>
  
<span data-ttu-id="5a5c3-521">rč</span><span class="sxs-lookup"><span data-stu-id="5a5c3-521">rč</span></span>
  
<span data-ttu-id="5a5c3-522">rodnéčíslo</span><span class="sxs-lookup"><span data-stu-id="5a5c3-522">rodné číslo</span></span>
  
<span data-ttu-id="5a5c3-523">rodne cislo</span><span class="sxs-lookup"><span data-stu-id="5a5c3-523">rodne cislo</span></span>
  
## <a name="slovenia"></a><span data-ttu-id="5a5c3-524">スロベニア</span><span class="sxs-lookup"><span data-stu-id="5a5c3-524">Slovenia</span></span>

### <a name="format"></a><span data-ttu-id="5a5c3-525">Format</span><span class="sxs-lookup"><span data-stu-id="5a5c3-525">Format</span></span>

<span data-ttu-id="5a5c3-526">13桁の数字、スペースまたは区切り記号なし</span><span class="sxs-lookup"><span data-stu-id="5a5c3-526">13 digits without spaces or delimiters</span></span>
  
### <a name="pattern"></a><span data-ttu-id="5a5c3-527">パターン</span><span class="sxs-lookup"><span data-stu-id="5a5c3-527">Pattern</span></span>

<span data-ttu-id="5a5c3-528">指定したパターンの13桁の数字:</span><span class="sxs-lookup"><span data-stu-id="5a5c3-528">13 digits in the specified pattern:</span></span>
  
-  <span data-ttu-id="5a5c3-529">誕生日 (DDMMLLL) に対応する7桁の数字で、"LLL" は誕生年の最後の3桁に対応します。</span><span class="sxs-lookup"><span data-stu-id="5a5c3-529">Seven digits that correspond to the birth date (DDMMLLL) where "LLL" corresponds to the last three digits of the birth year</span></span> 
    
- <span data-ttu-id="5a5c3-530">誕生日の範囲に対応する2桁の数字</span><span class="sxs-lookup"><span data-stu-id="5a5c3-530">Two digits that correspond to the area of birth</span></span>
    
- <span data-ttu-id="5a5c3-531">同じ日に生まれた人物の性別とシリアル番号の組み合わせに対応する3つの数字 (女性の場合は男性と500-999 は 000-499)</span><span class="sxs-lookup"><span data-stu-id="5a5c3-531">Three digits that correspond to a combination of gender and serial number for persons born on the same day (000-499 for male and 500-999 for female)</span></span>
    
- <span data-ttu-id="5a5c3-532">1つのチェックディジット</span><span class="sxs-lookup"><span data-stu-id="5a5c3-532">One check digit</span></span>
    
### <a name="checksum"></a><span data-ttu-id="5a5c3-533">Checksum</span><span class="sxs-lookup"><span data-stu-id="5a5c3-533">Checksum</span></span>

<span data-ttu-id="5a5c3-534">はい</span><span class="sxs-lookup"><span data-stu-id="5a5c3-534">Yes</span></span>
  
### <a name="definition"></a><span data-ttu-id="5a5c3-535">定義</span><span class="sxs-lookup"><span data-stu-id="5a5c3-535">Definition</span></span>

<span data-ttu-id="5a5c3-536">DLP ポリシーは、抽出した約 300 文字が次の条件に該当することを検出した場合に、85% の確証を持ってそれがこの種類の機密情報であると特定します。</span><span class="sxs-lookup"><span data-stu-id="5a5c3-536">A DLP policy is 85% confident that it's detected this type of sensitive information if, within a proximity of 300 characters:</span></span>
  
- <span data-ttu-id="5a5c3-537">関数`Func_slovenia_eu_national_id_card`は、パターンに一致するコンテンツを検索します。</span><span class="sxs-lookup"><span data-stu-id="5a5c3-537">The function  `Func_slovenia_eu_national_id_card` finds content that matches the pattern.</span></span> 
    
- <span data-ttu-id="5a5c3-538">From `Keywords_slovenia_eu_national_id_card`キーワードが見つかりました。</span><span class="sxs-lookup"><span data-stu-id="5a5c3-538">A keyword from  `Keywords_slovenia_eu_national_id_card` is found.</span></span> 
    
<span data-ttu-id="5a5c3-539">DLP ポリシーは、抽出した約 300 文字が次の条件に該当することを検出した場合に、75% の確証を持ってそれがこの種類の機密情報であると特定します。</span><span class="sxs-lookup"><span data-stu-id="5a5c3-539">A DLP policy is 75% confident that it's detected this type of sensitive information if, within a proximity of 300 characters:</span></span>
  
- <span data-ttu-id="5a5c3-540">関数`Func_slovenia_eu_national_id_card`は、パターンに一致するコンテンツを検索します。</span><span class="sxs-lookup"><span data-stu-id="5a5c3-540">The function  `Func_slovenia_eu_national_id_card` finds content that matches the pattern.</span></span> 
...
### <a name="keywords"></a><span data-ttu-id="5a5c3-541">キーワード</span><span class="sxs-lookup"><span data-stu-id="5a5c3-541">Keywords</span></span>

#### <a name="keywords_slovenia_eu_national_id_card"></a><span data-ttu-id="5a5c3-542">Keywords_slovenia_eu_national_id_card</span><span class="sxs-lookup"><span data-stu-id="5a5c3-542">Keywords_slovenia_eu_national_id_card</span></span>

<span data-ttu-id="5a5c3-543">個人の数値コード</span><span class="sxs-lookup"><span data-stu-id="5a5c3-543">personal numeric code</span></span>
  
<span data-ttu-id="5a5c3-544">一意の識別番号</span><span class="sxs-lookup"><span data-stu-id="5a5c3-544">unique identification number</span></span>
  
<span data-ttu-id="5a5c3-545">一意の登録番号</span><span class="sxs-lookup"><span data-stu-id="5a5c3-545">unique registration number</span></span>
  
<span data-ttu-id="5a5c3-546">一意の id 番号</span><span class="sxs-lookup"><span data-stu-id="5a5c3-546">unique identity number</span></span>
  
<span data-ttu-id="5a5c3-547">uniqueidentityno#</span><span class="sxs-lookup"><span data-stu-id="5a5c3-547">uniqueidentityno#</span></span>
  
<span data-ttu-id="5a5c3-548">一意のマスター市民番号</span><span class="sxs-lookup"><span data-stu-id="5a5c3-548">unique master citizen number</span></span>
  
<span data-ttu-id="5a5c3-549">edinstベンダー a identifikacijska številka</span><span class="sxs-lookup"><span data-stu-id="5a5c3-549">edinstvena identifikacijska številka</span></span>
  
<span data-ttu-id="5a5c3-550">uniqueidentityno#</span><span class="sxs-lookup"><span data-stu-id="5a5c3-550">uniqueidentityno #</span></span>
  
<span data-ttu-id="5a5c3-551">edinstベンダー a številka glavnega državljana</span><span class="sxs-lookup"><span data-stu-id="5a5c3-551">edinstvena številka glavnega državljana</span></span>
  
<span data-ttu-id="5a5c3-552">emšo</span><span class="sxs-lookup"><span data-stu-id="5a5c3-552">emšo</span></span>
  
## <a name="spain"></a><span data-ttu-id="5a5c3-553">スペイン</span><span class="sxs-lookup"><span data-stu-id="5a5c3-553">Spain</span></span>

### <a name="format"></a><span data-ttu-id="5a5c3-554">Format</span><span class="sxs-lookup"><span data-stu-id="5a5c3-554">Format</span></span>

<span data-ttu-id="5a5c3-555">7桁の数字の後に1文字</span><span class="sxs-lookup"><span data-stu-id="5a5c3-555">Seven digits followed by one character</span></span>
  
### <a name="pattern"></a><span data-ttu-id="5a5c3-556">パターン</span><span class="sxs-lookup"><span data-stu-id="5a5c3-556">Pattern</span></span>

<span data-ttu-id="5a5c3-557">7桁の数字の後に1文字</span><span class="sxs-lookup"><span data-stu-id="5a5c3-557">Seven digits followed by one character</span></span>
  
- <span data-ttu-id="5a5c3-558">7 桁の数字 </span><span class="sxs-lookup"><span data-stu-id="5a5c3-558">Seven digits</span></span>
    
- <span data-ttu-id="5a5c3-559">1桁の数字または文字 (大文字小文字を区別しない)</span><span class="sxs-lookup"><span data-stu-id="5a5c3-559">One digit or letter (not case-sensitive)</span></span>
    
### <a name="checksum"></a><span data-ttu-id="5a5c3-560">Checksum</span><span class="sxs-lookup"><span data-stu-id="5a5c3-560">Checksum</span></span>

<span data-ttu-id="5a5c3-561">該当なし</span><span class="sxs-lookup"><span data-stu-id="5a5c3-561">Not applicable</span></span>
  
### <a name="definition"></a><span data-ttu-id="5a5c3-562">定義</span><span class="sxs-lookup"><span data-stu-id="5a5c3-562">Definition</span></span>

<span data-ttu-id="5a5c3-563">DLP ポリシーは、抽出した約 300 文字が次の条件に該当することを検出した場合に、75% の確証を持ってそれがこの種類の機密情報であると特定します。</span><span class="sxs-lookup"><span data-stu-id="5a5c3-563">A DLP policy is 75% confident that it's detected this type of sensitive information if, within a proximity of 300 characters:</span></span>
  
- <span data-ttu-id="5a5c3-564">正規表現`Regex_spain_eu_national_id_card`は、パターンに一致するコンテンツを検出します。</span><span class="sxs-lookup"><span data-stu-id="5a5c3-564">The regular expression  `Regex_spain_eu_national_id_card` finds content that matches the pattern.</span></span> 
    
- <span data-ttu-id="5a5c3-565">From `Keywords_spain_eu_national_id_card"`キーワードが見つかりました。</span><span class="sxs-lookup"><span data-stu-id="5a5c3-565">A keyword from  `Keywords_spain_eu_national_id_card"` is found.</span></span> 
...
### <a name="keywords"></a><span data-ttu-id="5a5c3-566">キーワード</span><span class="sxs-lookup"><span data-stu-id="5a5c3-566">Keywords</span></span>

#### <a name="keywords_spain_eu_national_id_card"></a><span data-ttu-id="5a5c3-567">Keywords_spain_eu_national_id_card</span><span class="sxs-lookup"><span data-stu-id="5a5c3-567">Keywords_spain_eu_national_id_card</span></span>

<span data-ttu-id="5a5c3-568">dni</span><span class="sxs-lookup"><span data-stu-id="5a5c3-568">dni</span></span>
  
<span data-ttu-id="5a5c3-569">national identification number</span><span class="sxs-lookup"><span data-stu-id="5a5c3-569">national identification number</span></span>
  
<span data-ttu-id="5a5c3-570">国内の id 番号</span><span class="sxs-lookup"><span data-stu-id="5a5c3-570">national identity number</span></span>
  
<span data-ttu-id="5a5c3-571">保険番号</span><span class="sxs-lookup"><span data-stu-id="5a5c3-571">insurance number</span></span>
  
<span data-ttu-id="5a5c3-572">個人識別番号</span><span class="sxs-lookup"><span data-stu-id="5a5c3-572">personal identification number</span></span>
  
<span data-ttu-id="5a5c3-573">国民 id</span><span class="sxs-lookup"><span data-stu-id="5a5c3-573">national identity</span></span>
  
<span data-ttu-id="5a5c3-574">個人 id いいえ</span><span class="sxs-lookup"><span data-stu-id="5a5c3-574">personal identity no</span></span>
  
<span data-ttu-id="5a5c3-575">一意の id 番号</span><span class="sxs-lookup"><span data-stu-id="5a5c3-575">unique identity number</span></span>
  
<span data-ttu-id="5a5c3-576">nationalidno#</span><span class="sxs-lookup"><span data-stu-id="5a5c3-576">nationalidno#</span></span>
  
<span data-ttu-id="5a5c3-577">見つから#</span><span class="sxs-lookup"><span data-stu-id="5a5c3-577">uniqueid#</span></span>
  
<span data-ttu-id="5a5c3-578">dni#</span><span class="sxs-lookup"><span data-stu-id="5a5c3-578">dni#</span></span>
  
<span data-ttu-id="5a5c3-579">nationalid#</span><span class="sxs-lookup"><span data-stu-id="5a5c3-579">nationalid#</span></span>
  
<span data-ttu-id="5a5c3-580">nie#</span><span class="sxs-lookup"><span data-stu-id="5a5c3-580">nie#</span></span>
  
<span data-ttu-id="5a5c3-581">nie</span><span class="sxs-lookup"><span data-stu-id="5a5c3-581">nie</span></span>
  
<span data-ttu-id="5a5c3-582">nienúmero#</span><span class="sxs-lookup"><span data-stu-id="5a5c3-582">nienúmero#</span></span>
  
<span data-ttu-id="5a5c3-583">nie número</span><span class="sxs-lookup"><span data-stu-id="5a5c3-583">nie número</span></span>
  
<span data-ttu-id="5a5c3-584">documento nacional de 識別子 dad</span><span class="sxs-lookup"><span data-stu-id="5a5c3-584">documento nacional de identidad</span></span>
  
<span data-ttu-id="5a5c3-585">dad único の識別子</span><span class="sxs-lookup"><span data-stu-id="5a5c3-585">identidad único</span></span>
  
<span data-ttu-id="5a5c3-586">número nacional 識別子 dad</span><span class="sxs-lookup"><span data-stu-id="5a5c3-586">número nacional identidad</span></span>
  
<span data-ttu-id="5a5c3-587">dni número</span><span class="sxs-lookup"><span data-stu-id="5a5c3-587">dni número</span></span>
  
<span data-ttu-id="5a5c3-588">dninúmero#</span><span class="sxs-lookup"><span data-stu-id="5a5c3-588">dninúmero#</span></span>
  
<span data-ttu-id="5a5c3-589">identidadúnico#</span><span class="sxs-lookup"><span data-stu-id="5a5c3-589">identidadúnico#</span></span>
  
## <a name="sweden"></a><span data-ttu-id="5a5c3-590">スウェーデン</span><span class="sxs-lookup"><span data-stu-id="5a5c3-590">Sweden</span></span>

<span data-ttu-id="5a5c3-591">詳細については、「スウェーデン国立 ID」の「[機密情報の種類の検索方法](what-the-sensitive-information-types-look-for.md)」を参照してください。</span><span class="sxs-lookup"><span data-stu-id="5a5c3-591">For details, see the section "Sweden National ID" in [What the sensitive information types look for](what-the-sensitive-information-types-look-for.md).</span></span>
  
## <a name="see-also"></a><span data-ttu-id="5a5c3-592">関連項目</span><span class="sxs-lookup"><span data-stu-id="5a5c3-592">See also</span></span>

[<span data-ttu-id="5a5c3-593">機密情報の種類の検索基準</span><span class="sxs-lookup"><span data-stu-id="5a5c3-593">What the sensitive information types look for</span></span>](what-the-sensitive-information-types-look-for.md)
