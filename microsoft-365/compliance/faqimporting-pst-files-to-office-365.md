...
> [!NOTE]
> 現時点では、PST ファイルのネットワークアップロードはドイツおよびスイスでは利用できません。 この FAQ は、ネットワークアップロードがこれらの国で利用可能になったときに更新されます。
...
> [!NOTE]
> 現時点では、PST ファイルをインポートするためのドライブ配布は、ドイツおよびスイスでは利用できません。 この FAQ は、ドライブの配送がこれらの国で利用可能になったときに更新されます。
