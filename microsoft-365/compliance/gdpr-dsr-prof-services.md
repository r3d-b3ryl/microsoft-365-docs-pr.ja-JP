...
Microsoft プロフェッショナル サービスの詳細を確認するには、[Microsoft プロフェッショナル サービスのセキュリティ ドキュメントの Web ページ](https://www.microsoft.com/ja-JP/professionalservices/overview)に移動してください。 Microsoft プロフェッショナル サービスでは、一般データ保護規則 (GDPR) の下での義務を重く受け止めています。 このドキュメント内の情報は、Microsoft のサポートおよびコンサルティング サービスが GDPR の下でのデータ主体の要求 (DSR) の義務にどのように対応し、お客様を支援するかに関するお客様の質問に回答するために用意されました。
