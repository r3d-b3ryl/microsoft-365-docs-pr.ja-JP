...
ms.locfileid: "34431708"
---
# <a name="gdpr"></a>GDPR

このライブラリには、一般データ保護規則 (GDPR) のための技術ガイダンスを記載します。

- [情報保護](gdpr-information-protection.md)
- [データ サブジェクト要求](gdpr-data-subject-requests.md)
- [違反の通知](gdpr-breach-notification.md)

GDPR に関する Microsoft の支援の詳細については、セキュリティ センターの「[GDPR の概要](https://www.microsoft.com/en-us/trustcenter/privacy/gdpr/gdpr-overview)」を参照してください。
