...
> [!IMPORTANT]
> コンプライアンスマネージャーは、サービス信頼ポータルから、 [Microsoft 365 コンプライアンスセンター](https://compliance.microsoft.com/)の新しい場所に移動しました。 お客様のデータはすべて新しい場所に移動されているため、引き続きコンプライアンスマネージャーを中断せずに使用することができます。 セットアップ情報および新機能の詳細については、 [コンプライアンスマネージャーのドキュメント](compliance-manager.md) を参照してください。 コンプライアンスマネージャーのクラシックバージョンはサービス信頼ポータルに残っていますが、すべてのユーザーは、Microsoft 365 コンプライアンスセンターでコンプライアンスマネージャーを使用することをお勧めします。
...
- **設定:** このページでは、コンプライアンスマネージャー (クラシック) のユーザーロールを割り当てることができます。

- **ユーザーのプライバシー設定:** このページでは、特定のユーザーのコンプライアンスマネージャー (クラシック) でのアクションアイテムの割り当てを含むレポートをエクスポートできます。 また、すべてのアクションアイテムを別のユーザーに再割り当てし、指定されたユーザーから割り当てられたアクションアイテムを削除することもできます。
...
既定では、検索によってドキュメントの結果が返されます。 ドロップダウンリストを使用して、表示されているドキュメントの一覧を絞り込むことにより、結果をフィルター処理することができます。 複数のフィルターを使用して、ドキュメントの一覧を絞り込むことができます。 フィルターには、特定のクラウドサービス、コンプライアンスのカテゴリ、セキュリティプラクティス、地域、業界などが含まれます。 ドキュメント名のリンクをクリックして、ドキュメントをダウンロードします。

コンプライアンスマネージャー (クラシック) の評価からコントロールをリストするには、検索用語に関連する [ **コンプライアンスマネージャー**] をクリックします。 検索結果には、評価が作成された日付、評価グループの名前、適用可能な Microsoft クラウドサービス、およびそのコントロールが Microsoft であるか顧客が管理されているかが表示されます。 コントロールの名前をクリックして、コンプライアンスマネージャー (クラシック) の評価でコントロールを表示します。
