...
セキュリティ & コンプライアンスセンター PowerShell に接続するには、「  [connect To security & powershell](https://docs.microsoft.com/powershell/exchange/connect-to-scc-powershell)」を参照してください。
