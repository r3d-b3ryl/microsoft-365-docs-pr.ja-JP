...
既存の Microsoft 365 Enterprise E5 プランをお持ちで、インサイダー リスク管理を試す場合は、Microsoft 365 を既存のサブスクリプションに追加するか、[Microsoft 365 Enterprise](/office365/admin/try-or-buy-microsoft-365) E5 の試用版に[](https://www.microsoft.com/microsoft-365/enterprise)サインアップできます。
...
- **監査を有効にする**: オンにすると、組織のユーザーと管理者のアクティビティが監査ログに記録Microsoft 365されます。 Insider リスク ポリシーと分析スキャンでは、このログを使用してリスク アクティビティを検出します。
...
- **ポリシー インジケーターの選択**: インジケーターは、基本的に検出して調査するユーザー アクティビティです。 インジケーターを選択すると、複数の場所やサービスMicrosoft 365アクティビティを追跡できます。
...
組織の[人事コネクタ](import-hr-data.md)を構成する手順については、「人事データをインポートするコネクタをセットアップする」の記事Microsoft 365参照してください。 HR コネクタを構成した後、次の構成手順に戻ってください。
...
1. このページ [Microsoft 365 コンプライアンス センター](https://compliance.microsoft.com) Insider リスク管理に **移動** し、任意のページの右上隅から [**Insider** リスク設定] を選択します。
...
6. [アラートの **エクスポート] ページ** で、必要に応じて、セキュリティ管理 API を使用Office 365インサイダー リスクアラート情報のエクスポートを有効にします。
