...
|1 人のユーザーが同時に開始できる検索の最大数。 この制限は、ユーザーがセキュリティ & Compliance PowerShell **の Get-ComplianceSearch \|Start-ComplianceSearch** コマンドを使用して複数の検索を開始しようとしたときに発生する可能性があります。|10|
