...
---
# <a name="compliance-offering-defense-federal-acquisition-regulation-supplement-dfars"></a>コンプライアンスオファリング: 防衛機関買収規制補足 (DFARS dfars)
...
- [その他の監査レポートを参照してください。](https://aka.ms/auditreports)
