...
---
# <a name="compliance-offering-financial-supervision-authority-knf-poland"></a>コンプライアンス認証：金融監督局（KNF）ポーランド
...
このサービスに関する背景資料が必要ですか? [PDF](https://download.microsoft.com/download/B/3/9/B392C073-FDF7-4F0C-8765-03ACEE5E0289/KNF-Compliance.pdf) をダウンロードします。
