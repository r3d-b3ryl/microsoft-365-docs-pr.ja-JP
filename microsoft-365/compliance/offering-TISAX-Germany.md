...
---
# <a name="compliance-offering-trusted-information-security-assessment-exchange-tisax-germany"></a>コンプライアンス サービス: 信頼された情報セキュリティ アセスメント交換 (TISAX) ドイツ
...
このサービスに関する背景資料が必要ですか? [PDF](https://download.microsoft.com/download/5/C/3/5C32AD74-703F-4B61-A290-B00B96E8DD8D/TISAX-Compliance.pdf) をダウンロードします。
