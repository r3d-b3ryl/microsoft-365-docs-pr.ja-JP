...
ms.locfileid: "48906932"
---
# <a name="overview-of-data-investigations-preview-in-microsoft-365"></a>Microsoft 365 のデータ調査 (プレビュー) の概要

> [!IMPORTANT]
> お客様との deliberation と議論の後、microsoft はデータ調査ツールをリリースして一般提供しないことを決定しました。 そのため、2020年12月31日に、このツールと既存のデータ調査ケースに関連付けられているデータを削除します。  組織内のデータ調査を管理するには、コア電子情報開示ケースを使用することをお勧めします。 Microsoft 365 からコンテンツを検索して削除する必要がある場合は、次の記事を参照してください。 
> - [電子情報開示ソリューションシリーズ: Data 流出 scenario-検索と削除](data-spillage-scenariosearch-and-purge.md)
