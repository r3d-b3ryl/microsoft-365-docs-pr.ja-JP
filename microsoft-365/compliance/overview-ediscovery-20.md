...
[設定] **タブを** 使用して、ケース全体の設定を構成します。 これには、ケースへのメンバーの追加、ケースの閉じるまたは削除、検索と分析の設定の構成が含まれます。 詳しくは、以下を参照してください。
