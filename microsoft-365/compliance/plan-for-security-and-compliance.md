...
セキュリティとコンプライアンスの管理はパートナーシップです。 Microsoft は Microsoft 365 サービスを積極的に保護しながら、データ、ID、およびデバイスを保護する責任があります。 Microsoft 365 と Enterprise Mobility + Security (EMS) を組み合わせて使用して、組織の適切なレベルの保護を実現できます。
  
## <a name="step-1-review-capabilities"></a>手順 1: 機能の確認

「365 ポスターの情報保護」の情報保護機能Officeしてください。 
  
[Microsoft 365 でデータプライバシー規制に関する情報保護を展開する](../solutions/information-protection-deploy.md?view=o365-worldwide)
...
Microsoft 365 のデータとサービスへのアクセスを保護することは、サイバー攻撃から防御し、データ損失から保護するために重要です。
...
セキュリティ コンプライアンス センターでは、脅威管理、データ ガバナンス、検索と調査など、Microsoft 365 セキュリティの範囲を管理するために使用するコントロールを 1 つのビュー &amp; で確認できます。 
