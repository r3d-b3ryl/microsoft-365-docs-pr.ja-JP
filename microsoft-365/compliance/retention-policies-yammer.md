...
現在、Yammer のアイテム保持ポリシーはプレビュー中であり、継続的に保持機能の最適化に努めています。 当面は、Yammer のコミュニティ メッセージとプライベート メッセージで保持を使用する場合は、次の制限事項に注意する必要があります。

- **Yammer のメッセージでの "いいね" やその他の反応は保持されません**。 他のユーザーからの絵文字形式の反応は、アイテム保持ポリシーではサポートされていません。
