...
4. [アクティビティ **] ドロップダウン** リストの [**電子** 情報開示アクティビティ] または [Advanced eDiscovery] で、検索する 1 つ以上のアクティビティをクリックします。
...
10. 必要に応じて、監査ログの検索結果を CSV ファイルにエクスポートし、Excel Power Query 機能を使用して、これらのレコードの書式設定とフィルター処理を行います。 詳細については、「[監査ログ レコードをエクスポート、構成、表示する](export-view-audit-log-records.md)」を参照してください。
...
次の表に、監査Advanced eDiscovery記録されるアクティビティの一覧を示します。 これらのアクティビティ (関連する電子情報開示アクティビティに加えて、 を使用して、ケース内のアクティビティの進行状況を追跡Advanced eDiscoveryできます。
