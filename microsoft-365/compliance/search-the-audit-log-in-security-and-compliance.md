...
4. [**検索**] をクリックして、設定した検索条件で検索を実行します。
   ...
   検索結果が読み込まれ、しばらくすると、新しいページに表示されます。 検索が完了すると、検索結果の件数が表示されます。 イベント 150 件の増分で最大 5,000 件のイベントが表示されます。 検索条件を満たすイベントが 5,000 件を超える場合、最新の5,000 件のイベントが表示されます。
