...
> 
> 中国語/日本語/2 バイト文字と共に、キーワード/語句のリストにも中国語/日本語以外の単語 (英語のみなど) が含まれている場合は、2 つの辞書/キーワード リストを作成してください。 1 つは中国語/日本語/2 バイト文字を含むキーワード用で、もう 1 つは英語のみです。 
> - たとえば、「機密性の高い」、"機密性の高い"、"机密" の 3 つの語句を含むキーワード辞書/リストを作成する場合は、2 つのキーワード リストを作成する必要があります。 
>     1. 極秘
>     2. 2016 年 11 月 1 日
> 
