...
2. 次に、**[グループとサイトの保護設定の定義]** ページで、使用可能なオプションの 1 つまたは両方を選択します。
    ...
    - **[デバイス アクセスと外部共有設定]** を使用して、**[非管理対象デバイスからのアクセス]** 設定を構成します。
