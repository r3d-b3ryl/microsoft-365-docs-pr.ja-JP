...
いいえ。 データは常に、BitLocker および DKM を使用して Office 365 サービスで保存されます。 詳細については、「365 Office のセキュリティ、プライバシー、コンプライアンスに関する情報」、および「 [Exchange Online が電子メールの機密情報を保護する方法](https://support.office.com/article/989BA10C-F73F-4EFB-AD1B-AF3322E5F376)」を参照してください。
