...
たとえば、テキストコンテンツが "DAVE BOB ALICE CAROL イブ" の場合、次に示すのは、無視するテキストエントリの例と、それらのエントリが生成する結果です。

|**テキストの入力を無視する** <br/> |**結果** <br/> |
|:-----|:-----|
|"ALICE"、"BOB CAROL"  <br/> |"DAVE イブ"  <br/> |
|"ALICE"、"BOB ALICE CAROL"  <br/> |"DAVE BOB CAROL イブ"  <br/> |
