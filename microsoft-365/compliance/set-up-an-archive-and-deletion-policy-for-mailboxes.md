...
Microsoft Purview管理者は、アイテムをユーザーのアーカイブ メールボックスに自動的に移動し、メールボックスからアイテムを自動的に削除する[アーカイブ](archive-mailboxes.md)および削除ポリシーを作成できます。
...
2. EAC で、**コンプライアンス管理** > **Retention タグ** に移動します
...
1. **[アイテム保持タグ**] ページで、[**新しい tagNew**![] アイコン](../media/457cd93f-22c2-4571-9f83-1b129bcfb58e.gif)を選択し、**メールボックス全体に自動的に適用 (既定値)** を選択します。
...
1. EAC で、 **コンプライアンス管理** > **Retention ポリシー** に移動します。
...
1. EAC で **RecipientsMailboxes** >  に移動します。
...
- 次の表に、この記事のカスタム MRM アイテム保持ポリシーの各リテンション タグの詳細を示します。
    ...
    | 保持タグ | このタグの機能 | 組み込みですか、カスタムですか? | 種類 |
    |:-----|:-----|:-----|:-----|
