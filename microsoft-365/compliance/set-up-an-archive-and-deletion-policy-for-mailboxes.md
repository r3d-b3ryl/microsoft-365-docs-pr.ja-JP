...
メールボックスに割り当てることができる MRM アイテム保持ポリシーは一度に 1 つだけであるため、置換が必要です。 この手順では、組織内のすべてのメールボックスに新しいポリシーを割り当てることを前提としています。
...
- 次の表に、この記事のカスタム MRM アイテム保持ポリシーの各リテンション タグの詳細を示します。
    ...
    |迷惑メール  <br/> |迷惑メール Email フォルダーに 30 日間保存されているアイテムを完全に削除します。 ユーザーは、これらのアイテムを削除した後、最大 14 日間回復できます。<sup>\*</sup> <br/> |組み込み  <br/> |アイテム保持ポリシー タグ (迷惑メール Email);このタグは、迷惑メール Email フォルダー内のアイテムに自動的に適用されます。  <br/> |
