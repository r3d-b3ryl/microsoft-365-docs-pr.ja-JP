---
title: Azure App Service デプロイ パスワード エンティティ定義 (プレビュー)
f1.keywords:
- CSH
ms.author: chrfox
author: chrfox
...
description: Azure App Service 展開パスワードの機密情報の種類エンティティ定義。
ms.openlocfilehash: 6b8915b64e9b647523838284a996f1fca8721eef
ms.sourcegitcommit: 5aed330d8af523f0dffe5e392f1c79f047e38172
ms.translationtype: MT
ms.contentlocale: ja-JP
ms.lasthandoff: 07/21/2022
ms.locfileid: "66996087"
---
# <a name="azure-app-service-deployment-password-preview"></a>Azure App Serviceデプロイ パスワード (プレビュー)

## <a name="format"></a>フォーマット

文字、数字、特殊文字で構成される 60 文字の組み合わせ。

## <a name="pattern"></a>パターン

以下で構成される 60 文字の任意の組み合わせ。
...
この SIT は、ローカル コンピューターから[Azure App Service展開](/azure/app-service/deploy-configure-credentials)をセキュリティで保護するために使用されるセキュリティ情報と一致するように設計されています。

いくつかの主なリソースが使用されます。

- Base64 でエンコードされた 360 ビットの対称キーのパターン。
