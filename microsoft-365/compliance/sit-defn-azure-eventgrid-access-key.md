---
title: Azure EventGrid アクセス キー エンティティ定義 (プレビュー)
f1.keywords:
- CSH
ms.author: chrfox
author: chrfox
...
description: Azure EventGrid アクセス キーの機密情報の種類エンティティ定義。
ms.openlocfilehash: 623d1cbe6ecad053981e09f7c71e9ae99d855530
ms.sourcegitcommit: 5aed330d8af523f0dffe5e392f1c79f047e38172
ms.translationtype: MT
ms.contentlocale: ja-JP
ms.lasthandoff: 07/21/2022
ms.locfileid: "66996482"
---
# <a name="azure-eventgrid-access-key-preview"></a>Azure EventGrid アクセス キー (プレビュー)
...
この SIT は、アプリケーション発行イベントをAzure Event Grid[リソース (トピックとドメイン) の](/azure/event-grid/get-access-keys)認証に使用されるセキュリティ情報と一致するように設計されています。
