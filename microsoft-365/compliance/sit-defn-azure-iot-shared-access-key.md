---
title: Azure IoT 共有アクセス キー エンティティ定義
f1.keywords:
- CSH
ms.author: chrfox
author: chrfox
...
description: Azure IoT 共有アクセス キーの機密情報の種類エンティティ定義。
ms.openlocfilehash: b619fd6b488727ea9d0c615e354ab19d7eaad34b
ms.sourcegitcommit: 5aed330d8af523f0dffe5e392f1c79f047e38172
ms.translationtype: MT
ms.contentlocale: ja-JP
ms.lasthandoff: 07/21/2022
ms.locfileid: "66996847"
---
# <a name="azure-iot-shared-access-key"></a>Azure IoT の共有アクセス キー  

## <a name="format"></a>フォーマット

文字、数字、およびパターンの一部ではない符号で終わる特殊文字で構成される 44 文字の組み合わせ。
...
この SIT は、 [Azure IoT デバイスとサービス](/azure/iot-fundamentals/iot-security-deployment)の認証に使用されるセキュリティ情報と一致するように設計されています。
