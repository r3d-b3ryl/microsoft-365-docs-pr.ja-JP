---
title: Azure Storage アカウントの共有アクセス署名エンティティ定義 (プレビュー)
f1.keywords:
- CSH
ms.author: chrfox
author: chrfox
...
description: Azure Storage アカウントの共有アクセス署名の機密情報の種類エンティティ定義。
ms.openlocfilehash: 5affa9a8b31afa006f38949834df9d852d57394b
ms.sourcegitcommit: 5aed330d8af523f0dffe5e392f1c79f047e38172
ms.translationtype: MT
ms.contentlocale: ja-JP
ms.lasthandoff: 07/21/2022
ms.locfileid: "66950691"
---
# <a name="azure-storage-account-shared-access-signature-preview"></a>Azure Storage アカウントの共有アクセス署名 (プレビュー)
...
この SIT は、 [Azure Storage リソース](/rest/api/storageservices/delegate-access-with-shared-access-signature)への制限付きアクセス権を付与するために使用されるセキュリティ情報と一致するように設計されています。 
