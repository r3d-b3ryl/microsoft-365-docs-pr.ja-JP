...
1. テナントのMicrosoft Purview コンプライアンス ポータルで、**Data classificationExact** >  **データと一致する** > **EDM スキーマに移動します**。
...
2. [セキュリティ/コンプライアンス センター PowerShell に接続します](/powershell/exchange/connect-to-scc-powershell)。
