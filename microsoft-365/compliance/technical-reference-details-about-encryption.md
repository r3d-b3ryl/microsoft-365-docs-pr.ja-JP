...
クラス最高の暗号化を提供するために、365 はOffice暗号化の標準を定期的に確認します。 古い標準は、古く、安全性が低くなると廃止される場合があります。 この記事では、現在サポートされている暗号スイート、その他の標準、および計画されている廃止に関する詳細について説明します。
...
Office 365 は、2018 年 10 月 31 日に TLS 1.0 および 1.1 のサポートを停止しました。 TLS 1.0 および 1.1 を使用して Office 365 に接続するクライアント、デバイス、またはサービスで見つかった新しい問題は修正されません。 GCC High および DoD 環境の正式な廃止は、2020 年 1 月 15 日に開始されました。 世界規模および GCC 環境向け TLS 1.0 および 1.1 の廃止は、2020 年 10 月 15 日に開始されました。
...
2016 年 6 月以降、Office 365 は送信接続または受信接続用の SHA-1 証明書を受け付けなくなりました。 証明書チェーンで SHA-2 (セキュア ハッシュ アルゴリズム 2) またはより強力なハッシュ アルゴリズムを使用します。
...
> [!IMPORTANT]
> TLS バージョンは非推奨であり、新しいバージョンが利用可能な場合は非推奨のバージョンを使用しない必要があります。 TLS 1.3 は現在サポートされていません。 従来のサービスで TLS 1.0 または 1.1 が必要ない場合は、無効にする必要があります。

| 暗号スイート | キー交換アルゴリズム/強度 | 完全な転送の秘密 | 暗号/強度 | 認証アルゴリズム |
|:-----|:-----|:-----|:-----|:-----|
...
これらの暗号スイートは、廃止日まで TLS 1.0 および 1.1 プロトコルをサポートしました。 廃止日が 2020 年 1 月 15 日の GCC High および DoD 環境、および 2020 年 10 月 15 日のワールドワイド環境と GCC 環境の場合。

| プロトコル | 暗号スイート名 | キー交換アルゴリズム/強度 | 完全な転送セックのサポート | 認証アルゴリズム/強度 | 暗号/強度 |
|:-----|:-----|:-----|:-----|:-----|:-----|
