...
1. 以下の問題名ダイアログの次の例に示すように、ケースの問題に関する関連性トラックで次の **詳細を** 表示します。
   ...
   - **次の手順**: 実行する次の手順の推奨事項を表示します。 
    ...
    ![関連性追跡のトレーニング手順 1.](../media/a00fe607-680a-48eb-9d61-4565319f7ab6.png)
    ...
    ![関連性追跡のトレーニング。](../media/98dbc3f5-5238-4d73-9f88-1aa4d77ea729.png)
...
![関連性 トラックのタグ付けの概要。](../media/0ec906fc-bc84-4245-a964-fb3ca37891db.png)
...
![関連性 トレーニングの進捗状況を追跡します。](../media/8a5089f5-a162-4246-ae09-bc1921859860.png)
...
![関連性 トレーニングの統計情報を追跡します。](../media/9a07740e-20d3-49fb-b9b9-84265e0a1836.png)
