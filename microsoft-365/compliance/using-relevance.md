...
- 関連性に追加: 関連性負荷の下で、関連性があるとし \> て処理されたドキュメントを追加して、トレーニングで利用できるようにすることができます。
...
[ **関連性の \> 追跡** ] タブで、Advanced eDiscovery は処理を進める方法に関する推奨事項を提供し、次の手順を実行します。 関連トレーニングプロセスで以下の各手順を実行する場合は、次に示す影響について説明します。 
