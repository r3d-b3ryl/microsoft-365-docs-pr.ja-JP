...
1. SharePointドキュメント ライブラリから、[**モダン テンプレート****の新規作成** > ] を選択します。
...
1. SharePointドキュメント ライブラリから、[**新しい** > **編集] メニューを選択します**。
...
1. SharePointドキュメント ライブラリから [**新規**] を選択し、使用するモダン テンプレートを選択します。
