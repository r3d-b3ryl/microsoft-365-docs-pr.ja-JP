...
> [!NOTE]
> これらの手順では、Syntex Samples リポジトリの[Microsoft SharePointファイルを使用できます](https://github.com/pnp/syntex-samples)。 このリポジトリのサンプルには、ドキュメント理解モデル ファイルと、モデルのトレーニングに使用されるファイルの両方が含まれています。
