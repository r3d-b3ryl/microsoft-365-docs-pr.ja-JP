...
以前のサイトの既定のホームページと、新しいサイトの既定のホームページとの間のリダイレクトのみがサポートされています。 以前のサイトと新しいサイトにリダイレクトされずにアクセスする必要がある管理者または所有者が、パラメーターを使用してリストされていることを確認する必要があり `WaveOverrideUsers` ます。 以前のサイトと新しいサイトにリダイレクトされずにアクセスする必要がある管理者または所有者が、パラメーターを使用してリストされていることを確認する必要があり `WaveOverrideUsers` ます。 以前のサイトの既定のホームページと、新しいサイトの既定のホームページとの間のリダイレクトのみがサポートされています。
