...
#### [手順 2: 全体管理者アカウントを保護する](identity-designate-protect-admin-accounts.md)
#### [手順 3: オンデマンドで全体管理者をセットアップする](identity-privileged-identity-management.md)
#### [手順 4: パスワードのリセットを簡素化する](identity-password-reset.md)
#### [手順 5: 多要素認証をセットアップする](identity-multi-factor-authentication.md)
#### [手順 6 資格情報が侵害されないように保護する](identity-azure-ad-identity-protection.md)
#### [手順 7: ディレクトリを同期する](identity-azure-ad-connect.md)
#### [手順 8: 同期の状態の監視する](identity-azure-ad-connect-health.md)
#### [手順 9: パスワードの更新を簡素化する](identity-password-writeback.md)
#### [手順 10: ユーザー サインインを簡素化する](identity-single-sign-on.md)
#### [手順 11: Office 365 サインイン ページをカスタマイズする](identity-customize-office-365-sign-in.md)
#### [手順 12: 自動ライセンスをセットアップする](identity-group-based-licensing.md)
#### [手順 13: テナントとサインイン アクティビティを監視する](identity-azure-ad-access-usage-reporting.md)
#### [手順 14: ユーザーが各自のグループを作成および管理できるようにする](identity-self-service-group-management.md)
#### [手順 15: 動的グループ メンバーシップを設定する](identity-automatic-group-membership.md)
...
#### [手順 3: Office 365 のセキュリティ強化を構成する](infoprotect-configure-increased-security-office-365.md)
#### [手順 4: Office 365 の特権アクセスの管理を構成する](infoprotect-configure-privileged-access-management.md)
#### [情報保護の終了条件](infoprotect-exit-criteria.md)
### [既存のインフラストラクチャで展開する](deploy-with-existing-infrastructure.md)
...
### [高度な規制データを扱うチームおよびサイト](teams-sharepoint-online-sites-highly-regulated-data.md)
...
#### [パスワードの書き戻し](password-writeback-m365-ent-test-environment.md)
...
### [情報保護]()
#### [Office 365 セキュリティの強化](increased-o365-security-microsoft-365-enterprise-dev-test-environment.md)
...
# [モダン デスクトップ展開センター](desktop-deployment-center-home.md)
...
## [手順 6: OS の展開と機能の更新](step-6-os-deployment-and-feature-updates.md)
## [手順 7: サービスとしての Windows および Office](step-7-windows-and-office-as-a-service.md)
## [手順 8: ユーザーのコミュニケーションとトレーニング](step-8-user-communications-and-training.md)
## [モダン デスクトップの展開と管理 Lab Kit](modern-desktop-deployment-and-management-lab.md)
...
## [ISO — 推奨アクション プラン](../compliance/iso-action-plan.md)
## [NIST — 推奨アクション プラン](../compliance/nist-action-plan.md) 
## [GDPR](../compliance/gdpr.md?toc=/microsoft-365/enterprise/toc.json)

### [GDPR の推奨アクション プラン](../compliance/gdpr-action-plan.md)

### [アカウンタビリティ対応準備チェックリスト](../compliance/gdpr-arc.md)
...
### [データ主体要求](../compliance/gdpr-data-subject-requests.md?toc=/microsoft-365/enterprise/toc.json)
