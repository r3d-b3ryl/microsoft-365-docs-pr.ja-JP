...
>[!Note]
>[ユーザー アカウントにライセンスを割り当てる方法については](../admin/manage/assign-licenses-to-users.md)、Microsoft 365 管理センター。 その他のリソースの一覧については、「ユーザーと [グループの管理」を参照してください](/admin)。
>
