...
詳細については、「パフォーマンスとメンテナンス[Windows」](https://windows.microsoft.com/windows/performance-maintenance-help#performance-maintenance-help)を参照ヒント[PC](https://support.microsoft.com/en-za/help/4002019/windows-10-improve-pc-performance)のパフォーマンスを向上Windows 10。
