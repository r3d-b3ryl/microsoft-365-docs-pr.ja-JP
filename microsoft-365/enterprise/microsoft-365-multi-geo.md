...
Microsoft 365 Multi-Geo は、テナント内に 250 以上の Microsoft 365 シートがあり、そのうち 5% 以上が複数地域を使用している Enterprise Agreement 顧客向けに、次の Microsoft 365 サブスクリプション プランのアドオンとして利用可能できます。 ユーザー サブスクリプション ライセンスは、複数地域サービス ライセンスと同じ Enterprise Agreement 上に存在する必要があります。 詳細については、Microsoft アカウント チームにお問い合わせください。
