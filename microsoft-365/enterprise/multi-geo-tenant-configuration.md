...
1. SharePoint 管理センターを開きます。 <a href="https://go.microsoft.com/fwlink/?linkid=2185076" target="_blank">**[Geo の場所]**</a> に移動します。

1. [ **場所の追加]** を選択します。

1. 追加する場所を選択し、[ **次へ**] を選択します。

1. 地理的な場所で使用するドメインを入力し、[ **追加**] を選択します。
