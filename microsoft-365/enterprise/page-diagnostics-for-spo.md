...
> ![このページで実行するSharePoint必要があります。](../media/page-diagnostics-for-spo/pagediag-Error-StartPage.png)
...
> [!div class="mx-imgBorder"]
> ![フィードバックを送信します。](../media/page-diagnostics-for-spo/pagediag-feedback.png)
...
1. 拡張機能のツール バー ボタンをクリックする ![ロゴのページSharePointします。](../media/page-diagnostics-for-spo/pagediag-icon32.png) ツールを読み込むには、次の拡張機能ポップアップ ウィンドウが表示されます。
