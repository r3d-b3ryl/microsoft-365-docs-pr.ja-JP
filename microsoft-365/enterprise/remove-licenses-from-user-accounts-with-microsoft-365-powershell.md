...
>[!Note]
>[ユーザー アカウントからライセンスを削除する方法については](../admin/manage/remove-licenses-from-users.md)、Microsoft 365 管理センター。 その他のリソースの一覧については、「ユーザーと [グループの管理」を参照してください](/admin)。
>
