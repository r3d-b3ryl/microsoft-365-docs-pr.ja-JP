...
---
# <a name="policy-recommendations-for-securing-email"></a><span data-ttu-id="6c2f8-103">電子メールをセキュリティで保護するためのポリシーの推奨事項</span><span class="sxs-lookup"><span data-stu-id="6c2f8-103">Policy recommendations for securing email</span></span>
<span data-ttu-id="6c2f8-p101">この資料では、推奨される識別情報および組織の電子メールと最新の認証と条件付きのアクセスをサポートする電子メール クライアントを保護するためにデバイスのアクセス ポリシーを実装する方法について説明します。このガイダンスでは、[共通の id とデバイスのアクセス ポリシー](identity-access-policies.md)の構築しもいくつか追加の推奨事項が含まれています。</span><span class="sxs-lookup"><span data-stu-id="6c2f8-p101">This article describes how to implement the recommended identity and device access policies to protect organizational email and email clients that support Modern Authentication and Conditional Access. This guidance builds on the [Common identity and device access policies](identity-access-policies.md) and also includes a few additional recommendations.</span></span>


<span data-ttu-id="6c2f8-p102">これらの推奨事項は、セキュリティの 3 つの異なる階層に基づいて、お客様のニーズの細分性に基づいて、保護を適用することができます:**ベースライン**、**機密性の高い**、高度や**規制**対象とします。これらのセキュリティ層との[セキュリティ ポリシーおよび構成の概要をお勧め](microsoft-365-policies-configurations.md)するこれらの推奨事項によって参照される、推奨されるクライアントのオペレーティング システムに関する詳細については。</span><span class="sxs-lookup"><span data-stu-id="6c2f8-p102">These recommendations are based on three different tiers of security and protection that can be applied based on the granularity of your needs: **baseline**, **sensitive**, and **highly regulated**. You can learn more about these security tiers, and the recommended client operating systems, referenced by these recommendations in the [recommended security policies and configurations introduction](microsoft-365-policies-configurations.md).</span></span>

<span data-ttu-id="6c2f8-p103">これらの推奨事項では、ユーザーが最新の電子メール クライアント、モバイル デバイスで Outlook の iOS および Android を含むを使用する必要があります。IOS および Android は、outlook では、Office 365 の機能のサポートを提供します。これらモバイルの Outlook アプリケーションは、モバイルをサポートする機能を使用し、他のマイクロソフトのクラウドのセキュリティ機能と機能のセキュリティも設計されています。詳細については、 [iOS および Android のよく寄せられる質問は、Outlook](https://docs.microsoft.com/exchange/clients-and-mobile-in-exchange-online/outlook-for-ios-and-android/outlook-for-ios-and-android-faq)を参照してください。</span><span class="sxs-lookup"><span data-stu-id="6c2f8-p103">These recommendations require your users to use modern email clients, including Outlook for iOS and Android on mobile devices. Outlook for iOS and Android provide support for the best features of Office 365. These mobile Outlook apps are also architected with security capabilities that support mobile use and work together with other Microsoft cloud security capabilities. For more information, see [Outlook for iOS and Android FAQ](https://docs.microsoft.com/exchange/clients-and-mobile-in-exchange-online/outlook-for-ios-and-android/outlook-for-ios-and-android-faq).</span></span>

## <a name="updating-common-policies-to-include-email"></a><span data-ttu-id="6c2f8-112">電子メールを含むように共通のポリシーを更新します。</span><span class="sxs-lookup"><span data-stu-id="6c2f8-112">Updating common policies to include email</span></span>
<span data-ttu-id="6c2f8-p104">次の図は、共通の id を示します、デバイスのアクセス ポリシーとポリシーは電子メールを保護するために更新する必要があることを示します。ActiveSync クライアントをブロックする Exchange Online の新しい規則の追加を確認します。これは、モバイルの Outlook の使用を強制します。</span><span class="sxs-lookup"><span data-stu-id="6c2f8-p104">The following diagram illustrates the common identity and device access policies and indicates which policies need to be updated to protect email. Note the addition of a new rule for Exchange Online to block ActiveSync clients. This forces the use of Outlook mobile.</span></span>

![電子メールを保護するためのポリシーの更新の概要](../images/identity-access-ruleset-mail.png)

<span data-ttu-id="6c2f8-p105">含まれているオンラインの Exchange と Outlook ポリシーのスコープに設定するとき場合、は、ActiveSync クライアントをブロックする新しいポリシーを作成するだけで済みます。次の表に記載されているポリシーを確認し、推奨される追加機能を作成するかまたは、これらは既に含まれていることを確認します。各ルールは、[共通の id とデバイスのアクセス ポリシー](identity-access-policies.md)の資料に関連付けられている構成の手順をページにリンクしています。</span><span class="sxs-lookup"><span data-stu-id="6c2f8-p105">If you included Exchange Online and Outlook in the scope of the policies when you set them up, you only need to create the new policy to block ActiveSync clients. Review the policies listed in the following table and either make the recommended additions, or confirm that these are already included. Each rule links to the associated configuration instructions in the [Common identity and device access policies](identity-access-policies.md) article.</span></span> 

|<span data-ttu-id="6c2f8-120">保護レベル</span><span class="sxs-lookup"><span data-stu-id="6c2f8-120">Protection level</span></span>|<span data-ttu-id="6c2f8-121">[Policies]</span><span class="sxs-lookup"><span data-stu-id="6c2f8-121">Policies</span></span>|<span data-ttu-id="6c2f8-122">詳細情報</span><span class="sxs-lookup"><span data-stu-id="6c2f8-122">More information</span></span>|
|:---------------|:-------|:----------------|
|<span data-ttu-id="6c2f8-123">**基準**</span><span class="sxs-lookup"><span data-stu-id="6c2f8-123">**Baseline**</span></span>|[<span data-ttu-id="6c2f8-124">サインインのリスクが*中*または*高*の場合は、MFA を必要とします。</span><span class="sxs-lookup"><span data-stu-id="6c2f8-124">Require MFA when sign-in risk is *medium* or *high*</span></span>](identity-access-policies.md#require-mfa-based-on-sign-in-risk)|<span data-ttu-id="6c2f8-125">Exchange Online クラウド アプリケーションの割り当てに含まれます。</span><span class="sxs-lookup"><span data-stu-id="6c2f8-125">Include Exchange Online in the assignments of cloud apps.</span></span>|
|        |[<span data-ttu-id="6c2f8-126">現代の認証をサポートしていないクライアントをブロック</span><span class="sxs-lookup"><span data-stu-id="6c2f8-126">Block clients that don't support modern authentication</span></span>](identity-access-policies.md#block-clients-that-dont-support-modern-authentication)|<span data-ttu-id="6c2f8-127">Exchange Online クラウド アプリケーションの割り当てに含まれます。</span><span class="sxs-lookup"><span data-stu-id="6c2f8-127">Include Exchange Online in the assignments of cloud apps.</span></span>|
|        |[<span data-ttu-id="6c2f8-128">アプリケーション保護のポリシーを定義します。</span><span class="sxs-lookup"><span data-stu-id="6c2f8-128">Define app protection policies</span></span>](identity-access-policies.md#high-risk-users-must-change-password)|<span data-ttu-id="6c2f8-p106">アプリケーションの一覧で、Outlook が含まれていることを確認します。各プラットフォーム (iOS、Android、Windows) のポリシーを更新することを確認します。</span><span class="sxs-lookup"><span data-stu-id="6c2f8-p106">Be sure Outlook is included in the list of apps. Be sure to update the policy for each platform (iOS, Android, Windows).</span></span>|
|        |[<span data-ttu-id="6c2f8-131">承認済みのアプリケーションを必要とします。</span><span class="sxs-lookup"><span data-stu-id="6c2f8-131">Require approved apps</span></span>](identity-access-policies.md#require-approved-apps)|<span data-ttu-id="6c2f8-132">クラウド アプリケーションの一覧で、Exchange のオンラインが含まれます。</span><span class="sxs-lookup"><span data-stu-id="6c2f8-132">Include Exchange Online in the list of cloud apps.</span></span>|
|        |[<span data-ttu-id="6c2f8-133">準拠の Pc を必要とします。</span><span class="sxs-lookup"><span data-stu-id="6c2f8-133">Require compliant PCs</span></span>](identity-access-policies.md#require-compliant-pcs-but-not-compliant-phones-and-tablets)|<span data-ttu-id="6c2f8-134">クラウド アプリケーションの一覧で Exchange のオンラインが含まれます。</span><span class="sxs-lookup"><span data-stu-id="6c2f8-134">Include Exchange Online in list of cloud apps.</span></span>|
|        |[<span data-ttu-id="6c2f8-135">ブロック ActiveSync クライアント</span><span class="sxs-lookup"><span data-stu-id="6c2f8-135">Block ActiveSync clients</span></span>](#block-activesync)|<span data-ttu-id="6c2f8-136">この新しいポリシーを追加します。</span><span class="sxs-lookup"><span data-stu-id="6c2f8-136">Add this new policy.</span></span> 
|<span data-ttu-id="6c2f8-137">**機密**</span><span class="sxs-lookup"><span data-stu-id="6c2f8-137">**Sensitive**</span></span>|[<span data-ttu-id="6c2f8-138">サインインのリスクとは、*低*、*中*または*高*の場合は、MFA を必要とします。</span><span class="sxs-lookup"><span data-stu-id="6c2f8-138">Require MFA when sign-in risk is *low*, *medium* or *high*</span></span>](identity-access-policies.md#require-mfa-based-on-sign-in-risk)| <span data-ttu-id="6c2f8-139">Exchange Online クラウド アプリケーションの割り当てに含まれます。</span><span class="sxs-lookup"><span data-stu-id="6c2f8-139">Include Exchange Online in the assignments of cloud apps.</span></span>|
|         |[<span data-ttu-id="6c2f8-140">準拠の Pc*と*モバイル デバイスを必要とします。</span><span class="sxs-lookup"><span data-stu-id="6c2f8-140">Require compliant PCs *and* mobile devices</span></span>](identity-access-policies.md#require-compliant-pcs-and-mobile-devices)|<span data-ttu-id="6c2f8-141">クラウド アプリケーションの一覧で、Exchange のオンラインが含まれます。</span><span class="sxs-lookup"><span data-stu-id="6c2f8-141">Include Exchange Online in the list of cloud apps.</span></span>|
|<span data-ttu-id="6c2f8-142">**高度な規制**</span><span class="sxs-lookup"><span data-stu-id="6c2f8-142">**Highly regulated**</span></span>|[<span data-ttu-id="6c2f8-143">*常に*MFA を必要とします。</span><span class="sxs-lookup"><span data-stu-id="6c2f8-143">*Always* require MFA</span></span>](identity-access-policies.md#require-mfa-based-on-sign-in-risk)|<span data-ttu-id="6c2f8-144">クラウド アプリケーションの割り当てに含める Exchange オンライン</span><span class="sxs-lookup"><span data-stu-id="6c2f8-144">Include Exchange Online in the assignments of cloud apps</span></span> |

## <a name="block-activesync-clients"></a><span data-ttu-id="6c2f8-145">ブロック ActiveSync クライアント</span><span class="sxs-lookup"><span data-stu-id="6c2f8-145">Block ActiveSync clients</span></span>
<span data-ttu-id="6c2f8-p107">このポリシーでは、ActiveSync クライアントが他の条件付きのアクセス ルールをバイパスできなくなります。ルールの構成は、ActiveSync クライアントにのみ適用されます。このポリシーは、**クライアント アプリケーションの承認を必要とする**ことを選択すると、ActiveSync クライアントをブロックします。このポリシーを構成するには。</span><span class="sxs-lookup"><span data-stu-id="6c2f8-p107">This policy prevents ActiveSync clients from bypassing other conditional access rules. The rule configuration applies only to ActiveSync clients. By selecting **Require approved client app**, this policy blocks ActiveSync clients. To configure this policy:</span></span>

1. <span data-ttu-id="6c2f8-p108">[Azure Portal](https://portal.azure.com) に移動し、資格情報でサインインします。 正常にサインインすると、Azure ダッシュボードが開きます。</span><span class="sxs-lookup"><span data-stu-id="6c2f8-p108">Go to the [Azure portal](https://portal.azure.com), and sign in with your credentials. After you've successfully signed in, you see the Azure Dashboard.</span></span>

2. <span data-ttu-id="6c2f8-152">左側のメニューから **[Azure Active Directory]** を選びます。</span><span class="sxs-lookup"><span data-stu-id="6c2f8-152">Choose **Azure Active Directory** from the left menu.</span></span>

3. <span data-ttu-id="6c2f8-153">**[セキュリティ]** セクションで、**[条件付きアクセス]** を選びます。</span><span class="sxs-lookup"><span data-stu-id="6c2f8-153">Under the **Security** section, choose **Conditional access**.</span></span>

4. <span data-ttu-id="6c2f8-154">**[新しいポリシー]** を選びます。</span><span class="sxs-lookup"><span data-stu-id="6c2f8-154">Choose **New policy**.</span></span>

5. <span data-ttu-id="6c2f8-155">ポリシー名を入力し、ポリシーを適用する **[ユーザーとグループ]** を選びます。</span><span class="sxs-lookup"><span data-stu-id="6c2f8-155">Enter a policy name, then choose the **Users and groups** you want to apply the policy for.</span></span>

6. <span data-ttu-id="6c2f8-156">**[クラウド アプリ]** を選びます。</span><span class="sxs-lookup"><span data-stu-id="6c2f8-156">Choose **Cloud apps**.</span></span>

7. <span data-ttu-id="6c2f8-p109">**アプリケーションの選択**を選択して、Office 365 Exchange Online を選択します。**選択**し、[**完了**] をクリックします。</span><span class="sxs-lookup"><span data-stu-id="6c2f8-p109">Choose **Select apps**, select Office 365 Exchange Online. Click **Select** and **Done**.</span></span>
8. <span data-ttu-id="6c2f8-159">**条件**を選択し、**クライアント アプリケーション**を選択します。</span><span class="sxs-lookup"><span data-stu-id="6c2f8-159">Choose **Conditions**, and then choose **Client apps**.</span></span>
9. <span data-ttu-id="6c2f8-p110">**構成**] の [**はい**] をクリックします。次の項目だけをチェックする:**モバイル アプリケーションとデスクトップのクライアント**と**Exchange ActiveSync クライアント**です。**完了**] をクリックします。</span><span class="sxs-lookup"><span data-stu-id="6c2f8-p110">For **Configure**, select **Yes**. Check only the following: **Mobile apps and desktop clients** and **Exchange ActiveSync clients**. Click **Done**.</span></span>

10. <span data-ttu-id="6c2f8-163">**[アクセス制御]** セクションから **[許可]** を選びます。</span><span class="sxs-lookup"><span data-stu-id="6c2f8-163">Choose **Grant** from the **Access controls** section.</span></span>

11. <span data-ttu-id="6c2f8-p111">**クライアント アプリケーションの承認を必要とする**を選択して、**アクセスを許可する**を選択します。 複数のコントロールでは、**選択したコントロールを必要と**するを選択し、**選択**を選択します。</span><span class="sxs-lookup"><span data-stu-id="6c2f8-p111">Choose **Grant access**, select **Require approved client app**.  For multiple controls, select **Require the selected controls**, then choose **Select**.</span></span> 

12. <span data-ttu-id="6c2f8-166">[ **作成**] をクリックします。</span><span class="sxs-lookup"><span data-stu-id="6c2f8-166">Click **Create**.</span></span>

## <a name="setup-office-365-message-encryption"></a><span data-ttu-id="6c2f8-167">Office 365 のメッセージの暗号化を設定します。</span><span class="sxs-lookup"><span data-stu-id="6c2f8-167">Setup Office 365 message encryption</span></span>
<span data-ttu-id="6c2f8-p112">Azure の情報保護の保護機能を活用するには、新しい Office 365 メッセージの暗号化 (ホーム) 機能を備えた組織は、任意のデバイス上の他のユーザーと保護された電子メールを簡単に共有できます。ユーザーは、他の Office 365 の組織と同様に Outlook.com、Gmail、その他の電子メール サービスを使用して Office 365 以外のお客様で保護されたメッセージを送受信することができます。</span><span class="sxs-lookup"><span data-stu-id="6c2f8-p112">With the new Office 365 Message Encryption (OME) capabilities, which leverage the protection features in Azure Information Protection, your organization can easily share protected email with anyone on any device. Users can send and receive protected messages with other Office 365 organizations as well as non-Office 365 customers using Outlook.com, Gmail, and other email services.</span></span>

<span data-ttu-id="6c2f8-170">詳細については、[新しい Office 365 のメッセージの暗号化機能の設定](https://support.office.com/article/set-up-new-office-365-message-encryption-capabilities-7ff0c040-b25c-4378-9904-b1b50210d00e)を参照してください。</span><span class="sxs-lookup"><span data-stu-id="6c2f8-170">For more information, see [Set up new Office 365 Message Encryption capabilities](https://support.office.com/article/set-up-new-office-365-message-encryption-capabilities-7ff0c040-b25c-4378-9904-b1b50210d00e).</span></span> 
...
## <a name="next-steps"></a><span data-ttu-id="6c2f8-171">次の手順</span><span class="sxs-lookup"><span data-stu-id="6c2f8-171">Next steps</span></span>

[<span data-ttu-id="6c2f8-172">SharePoint サイトおよびファイルをセキュリティで保護するためのポリシーの推奨事項の詳細</span><span class="sxs-lookup"><span data-stu-id="6c2f8-172">Learn about policy recommendations for securing SharePoint Sites and files</span></span>](sharepoint-file-access-policies.md)
