...
**[データ損失防止](https://docs.microsoft.com/office365/securitycompliance/data-loss-prevention-policies)** は、Office 365 ProPlus に組み込まれています。これは、クレジット カードや個人識別番号のようなリスクの高いコンテンツが検出されたときにセキュリティ ポリシーをユーザーに通知する場合に役立ちます。ポリシーによって、ユーザーに通知することも、通知後に送信や共有をブロックすることもできます。
