...
次に、SharePoint Online サイトの構成を示します。
...
### <a name="step-2-configure-the-site-for-an-office-365-retention-label"></a>手順 2: Office 365 保持ラベル向けにサイトを構成する
...
架空の企業、Contoso Corporation は、フランスのパリに本社を置く、代表的な世界規模の製造業の複合企業です。 Contoso 社が、パリ、モスクワ、ニューヨーク、北京、およびバンガロールの研究チーム向けに[セキュアな SharePoint Online](contoso-sharepoint-online-site-for-highly-confidential-assets.md)の設計、構成、および導入の推進を行った方法をご覧ください。 
