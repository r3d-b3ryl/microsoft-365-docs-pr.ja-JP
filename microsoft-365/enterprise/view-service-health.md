...
管理センターにサインインできない場合は、[ [サービスの状態] ページ](https://status.office365.com) を使用して既知の問題があるかどうかを確認し、テナントへのログインを妨げることができます。  また、Twitter の [@MSFT365status](https://twitter.com/MSFT365Status) をフォローして、特定のイベントに関する情報を確認するようにサインアップすることもできます。
