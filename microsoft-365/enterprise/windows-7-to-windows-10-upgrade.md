...
> Windows 10 Enterprise 32 ビット版の ISO から展開されたファイル
...
> Windows 10 Enterprise 32 ビット版の画像の選択画面
...
*更新プログラムをダウンロード中の Windows 10 セットアップ*
...
*Windows 10 セットアップの既定のアップグレード オプション*
...
*Windows 10 セットアップのインストール オプション*
...
*Windows 7 に戻す理由を質問する Windows 10 の画面*
...
*以前のインストールのログオン資格情報があることを確かめる Windows 10 回復機能の画面*
...
*Windows 7 に戻る前の Windows 10 回復機能の最後の画面*
