...
また、Yammer が現場担当者に対してどのように機能するかについては、以下のリソースを参照してください: [Yammer Ten コミュニティ](https://aka.ms/Yam10Communities) と [Yammer Lookbook](https://aka.ms/Yammer/Lookbook)
...
| シナリオ | 説明 | サービス | Teams アプリ |
| --- | --- | --- |--- |
| [従業員を関与させ、ウェルビーイングに集中する](flw-wellbeing-engagement.md) | 組織全体のより深いつながりを構築し、包括的な職場を作成します。 | Microsoft Teams <br>SharePoint <br> Microsoft Stream <br>Viva コネクション <br> Yammer| 称賛 |

カバー: [インライン翻訳](/microsoftteams/inline-message-translation-teams)、賛美、対象となるコミュニケーション (Viva コネクション)、Stream または Teams を使用したビデオブロードキャスト。
...
| シナリオ | 説明 | サービス | Teams アプリ |
| --- | --- | --- |--- |
| [Shifts を使用してチームをスケジュールする](shifts-for-teams-landing-page.md) | Shifts と Shifts コネクタを使用して、チームをスケジュールし、従業員管理ツールに接続します。 | Microsoft Teams | Shifts |
...
<!--| サイト、ストア、プロジェクトを管理する | タスクとプロジェクトを常に把握します。 タスク、リスト、承認、および更新を使用して、従業員にチェックインし、スムーズに作業を続けます。 | | |-->
