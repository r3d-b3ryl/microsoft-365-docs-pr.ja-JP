...
---
# <a name="configure-sharepoint-as-a-learning-content-source-for-microsoft-viva-learning-preview"></a><span data-ttu-id="c7698-103">Microsoft Viva SharePointのラーニング コンテンツ ソースとしてラーニング構成する (プレビュー)</span><span class="sxs-lookup"><span data-stu-id="c7698-103">Configure SharePoint as a learning content source for Microsoft Viva Learning (Preview)</span></span>

> [!NOTE]
> <span data-ttu-id="c7698-104">この機能は、製品プレビューではまだ使用できません。</span><span class="sxs-lookup"><span data-stu-id="c7698-104">This feature is not yet available in product preview.</span></span>
