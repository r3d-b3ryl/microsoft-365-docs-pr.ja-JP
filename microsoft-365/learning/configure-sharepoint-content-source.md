---
title: Microsoft Viva learning SharePointコンテンツ ソースとしてコンテンツ を構成する (プレビュー)
ms.author: chucked
...
ms.locfileid: "52782779"
---
# <a name="configure-sharepoint-as-a-learning-content-source-for-microsoft-viva-learning-preview"></a><span data-ttu-id="102b0-103">Microsoft Viva learning SharePointコンテンツ ソースとしてコンテンツ を構成する (プレビュー)</span><span class="sxs-lookup"><span data-stu-id="102b0-103">Configure SharePoint as a learning content source for Microsoft Viva Learning (Preview)</span></span>

> [!NOTE]
> <span data-ttu-id="102b0-104">この機能は、製品プレビューではまだ使用できません。</span><span class="sxs-lookup"><span data-stu-id="102b0-104">This feature is not yet available in product preview.</span></span> 
