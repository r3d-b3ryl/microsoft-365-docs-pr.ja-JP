...
description: Moodle LMS プラグインを設定して構成することで、Moodle とMicrosoft Teamsを統合する準備を整えます。
ms.openlocfilehash: 5c986022923fe2322ad0e24f2e455d6fc502154e
ms.sourcegitcommit: 2f6a7410e9919f753a759c1ada441141e18f06fd
ms.translationtype: MT
ms.contentlocale: ja-JP
ms.lasthandoff: 07/30/2022
ms.locfileid: "67084787"
---
# <a name="set-up-the-moodle-lms-plugins"></a>Moodle LMS プラグインを設定する

この記事では、Moodle LMS プラグインをインストールして構成し、Moodle エクスペリエンスにMicrosoft Teamsを組み込む方法について説明します。

## <a name="prerequisites"></a>前提条件

インストール済みの Moodle をセットアップしてMicrosoft Teamsを操作するための前提条件を次に示します。
...
Moodle と Microsoft Teams の統合は、[Microsoft 365 Moodle プラグインセット](https://moodle.org/plugins/browse.php?list=set&id=72)オープンソースによって強化されます。
...
### <a name="create-azure-app"></a>Azure アプリを作成する
...
### <a name="set-azure-app-details-in-moodle"></a>Moodle で Azure アプリの詳細を設定する

1. OpenID Connect 認証プラグインの構成ページに戻ります。
1. `AppID`[**アプリケーション ID**] ボックス`Key`に値を貼り付け、[**キー**] ボックスに値を貼り付けて、[**変更の保存]** を選択します。

### <a name="configure-connection-between-microsoft-plugins-and-microsoft-services"></a>Microsoft プラグインと Microsoft サービス間の接続を構成する
...
### <a name="configure-user-and-course-synchronization"></a>ユーザーとコースの同期を構成する
...
> - **Microsoft Teams タスクへの Moodle コースの同期** の既定のスケジュールは、Moodle サーバーの既定のタイム ゾーンで毎日午前 1 時です。
