...
description: この記事では、新しい記事と更新された記事をMicrosoft Managed Desktop。
keywords: 変更履歴
ms.service: m365-md
ms.sitesec: library
author: tiaraquan
...
ms.locfileid: "64634319"
---
# <a name="change-history-for-microsoft-managed-desktop-documentation"></a>Microsoft マネージド デスクトップのドキュメントの変更履歴

この記事では、ドキュメントの新しい記事と更新された[記事Microsoft Managed Desktopします](index.yml)。 「更新された」記事には、重要な追加や修正が含め、誤字、スタイル、書式設定の問題の修正などのマイナーな修正は一覧に表示されません。 特定のコミットの履歴 (変更の詳細を含む) を表示するには、常に、GitHub の[リポジトリにアクセスします](https://github.com/MicrosoftDocs/microsoft-365-docs/tree/public/microsoft-365/managed-desktop)。
...
新しい記事または変更された記事 | 説明
--- | ---
| [デバイスの画像](service-description/device-images.md) | [Windows 10 Pro] セクションを追加しました |
| [管理者サポート](working-with-managed-desktop/admin-support.md) | [ケースの詳細の編集] セクションに重大度に関するメモを追加しました |
| [構成可能な設定のリファレンス](working-with-managed-desktop/config-setting-ref.md) | 追加のプロキシ要件 |
...
[Microsoft Managed Desktopライフサイクル](service-description/device-lifecycle.md) | 更新された記事
...
[Microsoft Managed Desktop操作と監視](service-description/operations-and-monitoring.md) | 更新された記事
...
[Microsoft マネージド デスクトップのデバイスをセットアップする](get-started/prepare-devices.md) | 更新された記事
[Microsoft Managed Desktopライフサイクル](service-description/device-lifecycle.md) | 更新された記事
[Microsoft Managed Desktopデバイス](service-description/device-list.md) |更新された記事
...
[Microsoft Managed Desktopサポートされている地域](service-description/regions-languages.md) | 更新された記事
...
[更新プログラムの処理方法は、Microsoft Managed Desktop](service-description/updates.md) | 更新された記事
[管理ポータルへのアクセス](get-started/access-admin-portal.md) | 更新された記事
...
[新しいデバイスをユーザー自身が登録する](get-started/manual-registration.md) | 更新された記事
[既存のデバイスを自分で登録する](get-started/manual-registration-existing-devices .md) |更新された記事 [「Microsoft Managed Desktop|](get-ready/prerequisites.md)更新された記事 [セキュリティ操作 (Microsoft Managed Desktop|](service-description/security-operations.md)新しい記事 [管理ポータル にアクセス|](get-started/access-admin-portal.md)更新された記事[Microsoft 365 Apps for enterprise](get-started/m365-apps.md)|新しい記事 [プライバシーと個人データの](service-description/privacy-personal-data.md)|新しい記事

## <a name="july-2020"></a>2020 年7 月

新しい記事または変更された記事 | 説明
--- | ---
[Microsoft Managed Desktopの要件](service-description/mmd-app-requirements.md) | 更新された記事
[コンプライアンス](intro/compliance.md) | 更新された記事
...
[デバイスにMicrosoft Projectまたは Microsoft VisioをMicrosoft Managed Desktopする](get-started/project-visio.md) | 更新された記事
...
[Microsoft Managed Desktopサポートされている地域と言語](service-description/regions-languages.md) | 更新された記事
...
新しい記事または変更された記事 | 説明
--- | ---
[セキュリティのMicrosoft Managed Desktop](service-description/security.md)| 更新された記事
分析情報を操作する | 更新された記事
Windows セキュリティ更新プログラムの分析情報| 新しい記事
[更新プログラムの処理方法は、Microsoft Managed Desktop](service-description/updates.md) | 更新された記事
[Microsoft Managed Desktopデバイス サービス](service-description/device-services.md) | 更新された記事
...
[Microsoft マネージド デスクトップの管理者サポート](working-with-managed-desktop/admin-support.md) | 更新された記事
[Microsoft Managed Desktopデバイス](service-description/device-list.md) | 更新された記事
[Microsoft Managed Desktop済みデバイス](service-description/archived-device-list.md) | 更新された記事
...
信頼性の分析情報 | 新しい記事
[Microsoft Managed Desktopデバイス](service-description/device-list.md) | 更新された記事
[Microsoft Managed Desktopメイン ページ](./index.yml) | 更新された記事
[Microsoft マネージド デスクトップとは](./intro/index.md) | 更新された記事
[ユーザーがデバイスを使えるようにする](get-started/get-started-devices.md) | 更新された記事
...
[Microsoft マネージド デスクトップの役割と責任](intro/roles-and-responsibilities.md) | 更新された記事
[Microsoft Managed Desktopライフサイクル](service-description/device-lifecycle.md) | 新しい記事
...
[Microsoft Managed Desktopサポートされている地域と言語](service-description/regions-languages.md) | 更新された記事
[Microsoft Managed Desktopデバイス](service-description/device-list.md) | 更新された記事
[Microsoft Managed Desktop済みデバイス](service-description/archived-device-list.md) | 新しい記事
...
[デバイスMicrosoft Managed Desktop注文する](get-started/devices.md) | 更新された記事
...
新しい記事または変更された記事 | 説明
--- | ---
[デバイスIntune ポータル サイトインストールMicrosoft Managed Desktopする](get-started/company-portal.md) | 新しい記事
[デバイスにMicrosoft Projectと Microsoft VisioをMicrosoft Managed Desktopする](get-started/project-visio.md) | 新しい記事
[Microsoft マネージド デスクトップ用にオンプレミス リソース アクセスを準備する](get-ready/authentication.md) | 新しい記事
[デバイスをデバイスに登録Microsoft Managed Desktop](get-started/manual-registration.md) | 新しい記事
[パートナー向けMicrosoft Managed Desktopデバイスを登録する](get-started/partner-registration.md) | 新しい記事
[アプリをデバイスにMicrosoft Managed Desktopする](get-started/deploy-apps.md) | 更新された記事
...
[概要デバイスを使用する](get-started/get-started-devices.md) | 新しい記事

## <a name="january-2019"></a>2019 年 1 月

新しい記事または変更された記事 | 説明
--- | ---
[デバイスのアプリをMicrosoft Managed Desktopする](get-started/deploy-apps.md) | 新しい記事。
[アプリを管理Microsoft Managed Desktop](working-with-managed-desktop/manage-apps.md) | 以前のバージョンの業務用アプリを更新またはロールバックする方法に関する情報が更新されました。

## <a name="december-2018"></a>2018 年 12 月

新しい記事または変更された記事 | 説明
--- | ---
[ユーザーの操作とMicrosoft Managed Desktop](service-description/operations-and-monitoring.md) | 責任テーブルの残高を追加し、他のテーブルを更新しました。
...
新しい記事または変更された記事 | 説明
--- | ---
[ユーザーのサポートMicrosoft Managed Desktop](service-description/support.md)<br />および[ユーザー サポートのMicrosoft Managed Desktop](working-with-managed-desktop/end-user-support.md) | オーストラリアを含む更新。

## <a name="october-30-2018"></a>2018 年 10 月 30 日

コンテンツの再編成: サービスの説明にMicrosoft Managed Desktop[セクションを追加しました](service-description/index.md)。
