...
1. [Microsoft エンドポイントマネージャー管理センター](https://go.microsoft.com/fwlink/?linkid=2109431)にサインインします。
2. **テナント管理**  >  **コネクタを選択し、**  >  **ビジネス用に Microsoft Store に** トークンを使用します。
3. Microsoft Store から Intune に購入したアプリを取得するには、[ **同期** ] を選択します。
