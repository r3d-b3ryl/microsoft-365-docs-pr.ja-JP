...
別のデバイス名テンプレートを要求する場合があります。 ただし、展開モード、Join to Azure AD As、プライバシー設定、またはユーザー アカウントの種類を変更することはできません。
...
- "user" コンテキストを必要とするアプリケーション (Teams など) は、ESP のパブリック プレビューに含めません。