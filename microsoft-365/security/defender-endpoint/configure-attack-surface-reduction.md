...
記事 | 説明
-|-
[Microsoft Edge のハードウェア ベースの分離を有効にする](/windows/security/threat-protection/microsoft-defender-application-guard/install-md-app-guard) | ハードウェア要件とソフトウェア要件を含む Application Guard の準備とインストール方法
...
[フォルダー アクセスの制御](./enable-controlled-folders.md)|悪意のあるアプリから貴重なデータを保護する方法
[攻撃面の縮小](./enable-attack-surface-reduction.md)|悪用を求めるマルウェアによって通常使用されるアクションとアプリを防止する方法
