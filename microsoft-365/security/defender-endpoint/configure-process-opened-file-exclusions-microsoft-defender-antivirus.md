...
プロセス除外リストにプロセスを追加すると、ファイルの場所に関係なく、そのプロセスによって開かれたファイルはスキャンされません。 ただし、プロセス自体は、 [ファイル除外リスト](configure-extension-file-exclusions-microsoft-defender-antivirus.md)にも追加されていない限り、スキャンされます。
