...
|**展開リング**|**説明**|
|:-----|:-----|
Evaluate | リング 1: パイロット テスト用の 50 のシステムを特定する 
パイロット | リング 2: 実稼働環境の次の 50 ~ 100 エンドポイントを特定する <br>  
完全展開 | リング 3: より大きな増分でサービスを残りの環境にロールアウトする
