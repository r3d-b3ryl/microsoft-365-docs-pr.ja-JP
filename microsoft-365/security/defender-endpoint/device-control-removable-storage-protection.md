...
**Microsoft Defender for Endpoint リムーバブル Storage保護**
...
|BitLocker    |     BitLocker 保護されていないリムーバブル ドライブに書き込まれるデータをブロックする: 組織が所有するコンピューターで暗号化されていない限り、リムーバブル ドライブへのアクセスをブロックします。    |   詳細については、「BitLocker – リムーバブル ドライブ[」を参照設定。](/mem/intune/protect/endpoint-security-disk-encryption-profile-settings#bitlocker---removable-drive-settings.md)      |
