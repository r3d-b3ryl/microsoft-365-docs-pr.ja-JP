...
<td><span data-ttu-id="f9b9b-152">Microsoft Defender for Endpoint Service はオンボードされていないので、オンボーディング パラメーターが見つかりませんでした。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-152">Microsoft Defender for Endpoint service is not onboarded and no onboarding parameters were found.</span></span></td>
...
<td><span data-ttu-id="f9b9b-198">Microsoft Defender for Endpoint では、既定の構成の適用に失敗しました。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-198">Microsoft Defender for Endpoint failed to apply the default configuration.</span></span></td>
...
<td><span data-ttu-id="f9b9b-281">Microsoft Defender for Endpoint Connected User Experiences and Telemetry service unregistration failed.</span><span class="sxs-lookup"><span data-stu-id="f9b9b-281">Microsoft Defender for Endpoint Connected User Experiences and Telemetry service unregistration failed.</span></span> <span data-ttu-id="f9b9b-282">エラー コード: <code>variable</code> .</span><span class="sxs-lookup"><span data-stu-id="f9b9b-282">Failure code: <code>variable</code>.</span></span></td>
...
<tr>
<td><span data-ttu-id="f9b9b-346">42</span><span class="sxs-lookup"><span data-stu-id="f9b9b-346">42</span></span></td>
...
<tr>
   ...
   <td><span data-ttu-id="f9b9b-397">クラウド サービスから新しい構成を正常に適用しました。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-397">Successfully applied a new configuration from the cloud service.</span></span></td>
...
<tr>
   ...
   <td><span data-ttu-id="f9b9b-421">デバイスを再起動します。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-421">Reboot the device.</span></span> <span data-ttu-id="f9b9b-422">このエラーが解決しない場合は、サポートにお問い合わせください。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-422">If this error persists, contact Support.</span></span></td>
</tr>
<tr>
...
<tr>
   <td><span data-ttu-id="f9b9b-444">62</span><span class="sxs-lookup"><span data-stu-id="f9b9b-444">62</span></span></td>
...
<tr>
   ...
   <td><span data-ttu-id="f9b9b-459">通常の動作通知。アクションは必要ありません。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-459">Normal operating notification; no action required.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="f9b9b-460">65</span><span class="sxs-lookup"><span data-stu-id="f9b9b-460">65</span></span></td>
   <td><span data-ttu-id="f9b9b-461">Microsoft セキュリティ イベント コンポーネント ミニフィルター ドライバーの読み込みに失敗しました。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-461">Failed to load Microsoft Security Events Component Minifilter driver.</span></span> <span data-ttu-id="f9b9b-462">エラー コード: %1</span><span class="sxs-lookup"><span data-stu-id="f9b9b-462">Failure code: %1</span></span></td>
   <td><span data-ttu-id="f9b9b-463">ファイルシステムのミニフィルターMsSecFlt.sys読み込めない。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-463">Failed to load MsSecFlt.sys filesystem minifilter.</span></span></td>
   <td><span data-ttu-id="f9b9b-464">デバイスを再起動します。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-464">Reboot the device.</span></span> <span data-ttu-id="f9b9b-465">このエラーが解決しない場合は、サポートにお問い合わせください。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-465">If this error persists, contact Support.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="f9b9b-466">66</span><span class="sxs-lookup"><span data-stu-id="f9b9b-466">66</span></span></td>
   <td><span data-ttu-id="f9b9b-467">ポリシー更新プログラム: 待機時間モード - %1</span><span class="sxs-lookup"><span data-stu-id="f9b9b-467">Policy update: Latency mode - %1</span></span></td>
   <td><span data-ttu-id="f9b9b-468">C&C 接続頻度ポリシーが更新されました。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-468">The C&C connection frequency policy was updated.</span></span></td>
   <td><span data-ttu-id="f9b9b-469">通常の動作通知。アクションは必要ありません。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-469">Normal operating notification; no action required.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="f9b9b-470">68</span><span class="sxs-lookup"><span data-stu-id="f9b9b-470">68</span></span></td>
   <td><span data-ttu-id="f9b9b-471">サービスの開始の種類が予期しない。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-471">The start type of the service is unexpected.</span></span> <span data-ttu-id="f9b9b-472">サービス名: %1、実際の開始の種類: %2、予期される開始の種類: %3</span><span class="sxs-lookup"><span data-stu-id="f9b9b-472">Service name: %1, actual start type: %2, expected start type: %3</span></span></td>
   <td><span data-ttu-id="f9b9b-473">予期しない外部サービスの開始の種類。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-473">Unexpected external service start type.</span></span></td>
   <td><span data-ttu-id="f9b9b-474">外部サービスの開始の種類を修正します。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-474">Fix the external service start type.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="f9b9b-475">69</span><span class="sxs-lookup"><span data-stu-id="f9b9b-475">69</span></span></td>
   <td><span data-ttu-id="f9b9b-476">サービスが停止します。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-476">The service is stopped.</span></span> <span data-ttu-id="f9b9b-477">サービス名: %1</span><span class="sxs-lookup"><span data-stu-id="f9b9b-477">Service name: %1</span></span></td>
   <td><span data-ttu-id="f9b9b-478">外部サービスが停止します。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-478">The external service is stopped.</span></span></td>
   <td><span data-ttu-id="f9b9b-479">外部サービスを開始します。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-479">Start the external service.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="f9b9b-480">70</span><span class="sxs-lookup"><span data-stu-id="f9b9b-480">70</span></span></td>
   <td><span data-ttu-id="f9b9b-481">ポリシー更新: サンプル コレクションを許可する - %1</span><span class="sxs-lookup"><span data-stu-id="f9b9b-481">Policy update: Allow sample collection - %1</span></span></td>
   <td><span data-ttu-id="f9b9b-482">サンプル コレクション ポリシーが更新されました。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-482">The sample collection policy was updated.</span></span></td>
   <td><span data-ttu-id="f9b9b-483">通常の動作通知。アクションは必要ありません。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-483">Normal operating notification; no action required.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="f9b9b-484">71</span><span class="sxs-lookup"><span data-stu-id="f9b9b-484">71</span></span></td>
   <td><span data-ttu-id="f9b9b-485">コマンドの実行に成功しました: %1</span><span class="sxs-lookup"><span data-stu-id="f9b9b-485">Succeeded to run command: %1</span></span></td>
   <td><span data-ttu-id="f9b9b-486">コマンドが正常に実行されました。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-486">The command was executed successfully.</span></span></td>
   <td><span data-ttu-id="f9b9b-487">通常の動作通知。アクションは必要ありません。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-487">Normal operating notification; no action required.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="f9b9b-488">72</span><span class="sxs-lookup"><span data-stu-id="f9b9b-488">72</span></span></td>
   <td><span data-ttu-id="f9b9b-489">最初の完全なコンピューター プロファイル レポートの送信を試みました。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-489">Tried to send first full machine profile report.</span></span> <span data-ttu-id="f9b9b-490">結果コード: %1</span><span class="sxs-lookup"><span data-stu-id="f9b9b-490">Result code: %1</span></span></td>
   <td><span data-ttu-id="f9b9b-491">情報提供のみ。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-491">Informational only.</span></span></td>
   <td><span data-ttu-id="f9b9b-492">通常の動作通知。アクションは必要ありません。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-492">Normal operating notification; no action required.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="f9b9b-493">73</span><span class="sxs-lookup"><span data-stu-id="f9b9b-493">73</span></span></td>
   <td><span data-ttu-id="f9b9b-494">プラットフォームの開始センス: %1</span><span class="sxs-lookup"><span data-stu-id="f9b9b-494">Sense starting for platform: %1</span></span></td>
   <td><span data-ttu-id="f9b9b-495">情報提供のみ。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-495">Informational only.</span></span></td>
   <td><span data-ttu-id="f9b9b-496">通常の動作通知。アクションは必要ありません。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-496">Normal operating notification; no action required.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="f9b9b-497">74</span><span class="sxs-lookup"><span data-stu-id="f9b9b-497">74</span></span></td>
   <td><span data-ttu-id="f9b9b-498">レジストリ内のデバイス タグが長さの制限を超えています。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-498">Device tag in registry exceeds length limit.</span></span> <span data-ttu-id="f9b9b-499">タグ名: %2。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-499">Tag name: %2.</span></span> <span data-ttu-id="f9b9b-500">長さの制限: %1。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-500">Length limit: %1.</span></span></td>
   <td><span data-ttu-id="f9b9b-501">デバイス タグが長さの制限を超えています。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-501">The device tag exceeds the length limit.</span></span></td>
   <td><span data-ttu-id="f9b9b-502">短いデバイス タグを使用します。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-502">Use a shorter device tag.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="f9b9b-503">81</span><span class="sxs-lookup"><span data-stu-id="f9b9b-503">81</span></span></td>
   <td><span data-ttu-id="f9b9b-504">エンドポイント ETW 自動ロガー用 Microsoft Defender の作成に失敗しました。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-504">Failed to create Microsoft Defender for Endpoint ETW autologger.</span></span> <span data-ttu-id="f9b9b-505">エラー コード: %1</span><span class="sxs-lookup"><span data-stu-id="f9b9b-505">Failure code: %1</span></span></td>
   <td><span data-ttu-id="f9b9b-506">ETW セッションの作成に失敗しました。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-506">Failed to create the ETW session.</span></span></td>
   <td><span data-ttu-id="f9b9b-507">デバイスを再起動します。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-507">Reboot the device.</span></span> <span data-ttu-id="f9b9b-508">このエラーが解決しない場合は、サポートにお問い合わせください。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-508">If this error persists, contact Support.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="f9b9b-509">82</span><span class="sxs-lookup"><span data-stu-id="f9b9b-509">82</span></span></td>
   <td><span data-ttu-id="f9b9b-510">エンドポイント ETW 自動ロガー用 Microsoft Defender の削除に失敗しました。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-510">Failed to remove Microsoft Defender for Endpoint ETW autologger.</span></span> <span data-ttu-id="f9b9b-511">エラー コード: %1</span><span class="sxs-lookup"><span data-stu-id="f9b9b-511">Failure code: %1</span></span></td>
   <td><span data-ttu-id="f9b9b-512">ETW セッションの削除に失敗しました。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-512">Failed to delete the ETW session.</span></span></td>
   <td><span data-ttu-id="f9b9b-513">サポートにお問い合わせください。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-513">Contact Support.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="f9b9b-514">84</span><span class="sxs-lookup"><span data-stu-id="f9b9b-514">84</span></span></td>
   <td><span data-ttu-id="f9b9b-515">実行中Windows Defender ウイルス対策を設定します。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-515">Set Windows Defender Antivirus running mode.</span></span> <span data-ttu-id="f9b9b-516">強制パッシブ モード: %1、結果コード: %2。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-516">Force passive mode: %1, result code: %2.</span></span></td>
   <td><span data-ttu-id="f9b9b-517">Defender の実行モード (アクティブまたはパッシブ) を設定します。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-517">Set defender running mode (active or passive).</span></span></td>
   <td><span data-ttu-id="f9b9b-518">通常の動作通知。アクションは必要ありません。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-518">Normal operating notification; no action required.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="f9b9b-519">85</span><span class="sxs-lookup"><span data-stu-id="f9b9b-519">85</span></span></td>
   <td><span data-ttu-id="f9b9b-520">Microsoft Defender for Endpoint 実行可能ファイルのトリガーに失敗しました。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-520">Failed to trigger Microsoft Defender for Endpoint executable.</span></span> <span data-ttu-id="f9b9b-521">エラー コード: %1</span><span class="sxs-lookup"><span data-stu-id="f9b9b-521">Failure code: %1</span></span></td>
   <td><span data-ttu-id="f9b9b-522">SenseIR 実行可能ファイルの主演に失敗しました。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-522">Starring SenseIR executable failed.</span></span></td>
   <td><span data-ttu-id="f9b9b-523">デバイスを再起動します。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-523">Reboot the device.</span></span> <span data-ttu-id="f9b9b-524">このエラーが解決しない場合は、サポートにお問い合わせください。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-524">If this error persists, contact Support.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="f9b9b-525">86</span><span class="sxs-lookup"><span data-stu-id="f9b9b-525">86</span></span></td>
   <td><span data-ttu-id="f9b9b-526">もう一度開始すると、起動する必要がある外部サービスが停止しました。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-526">Starting again stopped external service that should be up.</span></span> <span data-ttu-id="f9b9b-527">名前: %1、終了コード: %2</span><span class="sxs-lookup"><span data-stu-id="f9b9b-527">Name: %1, exit code: %2</span></span></td>
   <td><span data-ttu-id="f9b9b-528">外部サービスを再度開始します。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-528">Starting the external service again.</span></span></td>
   <td><span data-ttu-id="f9b9b-529">通常の動作通知。アクションは必要ありません。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-529">Normal operating notification; no action required.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="f9b9b-530">87</span><span class="sxs-lookup"><span data-stu-id="f9b9b-530">87</span></span></td>
   <td><span data-ttu-id="f9b9b-531">外部サービスを開始できません。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-531">Cannot start the external service.</span></span> <span data-ttu-id="f9b9b-532">名前: %1</span><span class="sxs-lookup"><span data-stu-id="f9b9b-532">Name: %1</span></span></td>
   <td><span data-ttu-id="f9b9b-533">外部サービスの開始に失敗しました。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-533">Failed to start the external service.</span></span></td>
   <td><span data-ttu-id="f9b9b-534">サポートにお問い合わせください。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-534">Contact Support.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="f9b9b-535">88</span><span class="sxs-lookup"><span data-stu-id="f9b9b-535">88</span></span></td>
   <td><span data-ttu-id="f9b9b-536">外部サービスの開始の種類を再度更新します。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-536">Updating the start type of external service again.</span></span> <span data-ttu-id="f9b9b-537">名前: %1、実際の開始の種類: %2、予期される開始の種類: %3、終了コード: %4</span><span class="sxs-lookup"><span data-stu-id="f9b9b-537">Name: %1, actual start type: %2, expected start type: %3, exit code: %4</span></span></td>
   <td><span data-ttu-id="f9b9b-538">外部サービスの開始の種類を更新しました。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-538">Updated the start type of the external service.</span></span></td>
   <td><span data-ttu-id="f9b9b-539">通常の動作通知。アクションは必要ありません。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-539">Normal operating notification; no action required.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="f9b9b-540">89</span><span class="sxs-lookup"><span data-stu-id="f9b9b-540">89</span></span></td>
   <td><span data-ttu-id="f9b9b-541">外部サービスの開始の種類を更新できません。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-541">Cannot update the start type of external service.</span></span> <span data-ttu-id="f9b9b-542">名前: %1、実際の開始の種類: %2、予期される開始の種類: %3</span><span class="sxs-lookup"><span data-stu-id="f9b9b-542">Name: %1, actual start type: %2, expected start type: %3</span></span></td>
   <td><span data-ttu-id="f9b9b-543">外部サービスの開始の種類を更新できない。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-543">Can't update the start type of the external service.</span></span></td>
   <td><span data-ttu-id="f9b9b-544">サポートにお問い合わせください。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-544">Contact Support.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="f9b9b-545">90</span><span class="sxs-lookup"><span data-stu-id="f9b9b-545">90</span></span></td>
   <td><span data-ttu-id="f9b9b-546">地域 %1 のクラウド サービスに接続するための System Guard ランタイム モニターの構成に失敗しました。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-546">Failed to configure System Guard Runtime Monitor to connect to cloud service in geo-region %1.</span></span> <span data-ttu-id="f9b9b-547">エラー コード: %2</span><span class="sxs-lookup"><span data-stu-id="f9b9b-547">Failure code: %2</span></span></td>
   <td><span data-ttu-id="f9b9b-548">System Guard ランタイム モニターは、構成証明データをクラウド サービスに送信しない。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-548">System Guard Runtime Monitor won't send attestation data to the cloud service.</span></span></td>
   <td><span data-ttu-id="f9b9b-549">登録パスのアクセス許可を確認します。"HKLM\Software\Microsoft\Windows\CurrentVersion\Sgrm"。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-549">Check the permissions on register path: "HKLM\Software\Microsoft\Windows\CurrentVersion\Sgrm".</span></span> <span data-ttu-id="f9b9b-550">問題が見つからない場合は、サポートにお問い合わせください。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-550">If no issues spotted, contact Support.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="f9b9b-551">91</span><span class="sxs-lookup"><span data-stu-id="f9b9b-551">91</span></span></td>
   <td><span data-ttu-id="f9b9b-552">System Guard ランタイム モニター地域情報の削除に失敗しました。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-552">Failed to remove System Guard Runtime Monitor geo-region information.</span></span> <span data-ttu-id="f9b9b-553">エラー コード: %1</span><span class="sxs-lookup"><span data-stu-id="f9b9b-553">Failure code: %1</span></span></td>
   <td><span data-ttu-id="f9b9b-554">System Guard ランタイム モニターは、構成証明データをクラウド サービスに送信しない。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-554">System Guard Runtime Monitor won't send attestation data to the cloud service.</span></span></td>
   <td><span data-ttu-id="f9b9b-555">登録パスのアクセス許可を確認します。"HKLM\Software\Microsoft\Windows\CurrentVersion\Sgrm"。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-555">Check the permissions on register path: "HKLM\Software\Microsoft\Windows\CurrentVersion\Sgrm".</span></span> <span data-ttu-id="f9b9b-556">問題が見つからない場合は、サポートにお問い合わせください。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-556">If no issues spotted, contact Support.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="f9b9b-557">92</span><span class="sxs-lookup"><span data-stu-id="f9b9b-557">92</span></span></td>
   <td><span data-ttu-id="f9b9b-558">データ クォータを超えたため、センサーのサイバー データ クォータの送信を停止します。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-558">Stopping sending sensor cyber data quota because data quota is exceeded.</span></span> <span data-ttu-id="f9b9b-559">クォータ期間が過ぎると、送信が再開されます。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-559">Will resume sending once quota period passes.</span></span> <span data-ttu-id="f9b9b-560">状態マスク: %1</span><span class="sxs-lookup"><span data-stu-id="f9b9b-560">State Mask: %1</span></span></td>
   <td><span data-ttu-id="f9b9b-561">調整の制限を超える。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-561">Exceed throttling limit.</span></span></td>
   <td><span data-ttu-id="f9b9b-562">通常の動作通知。アクションは必要ありません。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-562">Normal operating notification; no action required.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="f9b9b-563">93</span><span class="sxs-lookup"><span data-stu-id="f9b9b-563">93</span></span></td>
   <td><span data-ttu-id="f9b9b-564">センサーのサイバー データの送信を再送信する。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-564">Resuming sending sensor cyber data.</span></span> <span data-ttu-id="f9b9b-565">状態マスク: %1</span><span class="sxs-lookup"><span data-stu-id="f9b9b-565">State Mask: %1</span></span></td>
   <td><span data-ttu-id="f9b9b-566">サイバー データの送信を再開します。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-566">Resume cyber data submission.</span></span></td>
   <td><span data-ttu-id="f9b9b-567">通常の動作通知。アクションは必要ありません。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-567">Normal operating notification; no action required.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="f9b9b-568">94</span><span class="sxs-lookup"><span data-stu-id="f9b9b-568">94</span></span></td>
   <td><span data-ttu-id="f9b9b-569">Microsoft Defender for Endpoint 実行可能ファイルが開始されました</span><span class="sxs-lookup"><span data-stu-id="f9b9b-569">Microsoft Defender for Endpoint executable has started</span></span></td>
   <td><span data-ttu-id="f9b9b-570">SenseCE 実行可能ファイルが開始されました。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-570">The SenseCE executable has started.</span></span></td>
   <td><span data-ttu-id="f9b9b-571">通常の動作通知。アクションは必要ありません。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-571">Normal operating notification; no action required.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="f9b9b-572">95</span><span class="sxs-lookup"><span data-stu-id="f9b9b-572">95</span></span></td>
   <td><span data-ttu-id="f9b9b-573">Microsoft Defender for Endpoint 実行可能ファイルが終了しました</span><span class="sxs-lookup"><span data-stu-id="f9b9b-573">Microsoft Defender for Endpoint executable has ended</span></span></td>
   <td><span data-ttu-id="f9b9b-574">SenseCE 実行可能ファイルが終了しました。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-574">The SenseCE executable has ended.</span></span></td>
   <td><span data-ttu-id="f9b9b-575">通常の動作通知。アクションは必要ありません。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-575">Normal operating notification; no action required.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="f9b9b-576">96</span><span class="sxs-lookup"><span data-stu-id="f9b9b-576">96</span></span></td>
   <td><span data-ttu-id="f9b9b-577">Microsoft Defender for Endpoint Init が呼び出しました。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-577">Microsoft Defender for Endpoint Init has called.</span></span> <span data-ttu-id="f9b9b-578">結果コード: %2</span><span class="sxs-lookup"><span data-stu-id="f9b9b-578">Result code: %2</span></span></td>
   <td><span data-ttu-id="f9b9b-579">SenseCE 実行可能ファイルは MCE 初期化と呼ばされています。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-579">The SenseCE executable has called MCE initialization.</span></span></td>
   <td><span data-ttu-id="f9b9b-580">通常の動作通知。アクションは必要ありません。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-580">Normal operating notification; no action required.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="f9b9b-581">97</span><span class="sxs-lookup"><span data-stu-id="f9b9b-581">97</span></span></td>
   <td><span data-ttu-id="f9b9b-582">DLP シナリオのクラウドへの接続に関する問題がある</span><span class="sxs-lookup"><span data-stu-id="f9b9b-582">There are connectivity issues to the Cloud for the DLP scenario</span></span></td>
   <td><span data-ttu-id="f9b9b-583">DLP 分類フローに影響するネットワーク接続の問題があります。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-583">There are network connectivity issues that affect the DLP classification flow.</span></span></td>
   <td><span data-ttu-id="f9b9b-584">ネットワーク接続を確認します。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-584">Check the network connectivity.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="f9b9b-585">98</span><span class="sxs-lookup"><span data-stu-id="f9b9b-585">98</span></span></td>
   <td><span data-ttu-id="f9b9b-586">DLP シナリオのクラウドへの接続が復元されました</span><span class="sxs-lookup"><span data-stu-id="f9b9b-586">The connectivity to the Cloud for the DLP scenario has been restored</span></span></td>
   <td><span data-ttu-id="f9b9b-587">ネットワークへの接続が復元され、DLP 分類フローを続行できます。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-587">The connectivity to the network was restored and the DLP classification flow can continue.</span></span></td>
   <td><span data-ttu-id="f9b9b-588">通常の動作通知。アクションは必要ありません。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-588">Normal operating notification; no action required.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="f9b9b-589">99</span><span class="sxs-lookup"><span data-stu-id="f9b9b-589">99</span></span></td>
   <td><span data-ttu-id="f9b9b-590">サーバーとの通信中に、センスで次のエラーが発生しました。(%1)。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-590">Sense has encountered the following error while communicating with server: (%1).</span></span> <span data-ttu-id="f9b9b-591">結果: (%2)</span><span class="sxs-lookup"><span data-stu-id="f9b9b-591">Result: (%2)</span></span></td>
   <td><span data-ttu-id="f9b9b-592">通信エラーが発生しました。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-592">A communication error occurred.</span></span></td>
   <td><span data-ttu-id="f9b9b-593">詳細については、イベント ログで次のイベントを確認してください。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-593">Check the following events in the event log for further details.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="f9b9b-594">100</span><span class="sxs-lookup"><span data-stu-id="f9b9b-594">100</span></span></td>
   <td><span data-ttu-id="f9b9b-595">Microsoft Defender for Endpoint 実行可能ファイルの起動に失敗しました。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-595">Microsoft Defender for Endpoint executable failed to start.</span></span> <span data-ttu-id="f9b9b-596">エラー コード: %1</span><span class="sxs-lookup"><span data-stu-id="f9b9b-596">Failure code: %1</span></span></td>
   <td><span data-ttu-id="f9b9b-597">SenseCE 実行可能ファイルの起動に失敗しました。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-597">The SenseCE executable has failed to start.</span></span></td>
   <td><span data-ttu-id="f9b9b-598">デバイスを再起動します。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-598">Reboot the device.</span></span> <span data-ttu-id="f9b9b-599">このエラーが解決しない場合は、サポートにお問い合わせください。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-599">If this error persists, contact Support.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="f9b9b-600">102</span><span class="sxs-lookup"><span data-stu-id="f9b9b-600">102</span></span></td>
   <td><span data-ttu-id="f9b9b-601">Microsoft Defender for Endpoint Network Detection and Response 実行可能ファイルが開始されました</span><span class="sxs-lookup"><span data-stu-id="f9b9b-601">Microsoft Defender for Endpoint Network Detection and Response executable has started</span></span></td>
   <td><span data-ttu-id="f9b9b-602">SenseNdr 実行可能ファイルが開始されました。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-602">The SenseNdr executable has started.</span></span></td>
   <td><span data-ttu-id="f9b9b-603">通常の動作通知。アクションは必要ありません。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-603">Normal operating notification; no action required.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="f9b9b-604">103</span><span class="sxs-lookup"><span data-stu-id="f9b9b-604">103</span></span></td>
   <td><span data-ttu-id="f9b9b-605">Microsoft Defender for Endpoint Network Detection and Response 実行可能ファイルが終了しました</span><span class="sxs-lookup"><span data-stu-id="f9b9b-605">Microsoft Defender for Endpoint Network Detection and Response executable has ended</span></span></td>
   <td><span data-ttu-id="f9b9b-606">SenseNdr 実行可能ファイルが終了しました。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-606">The SenseNdr executable has ended.</span></span></td>
   <td><span data-ttu-id="f9b9b-607">通常の動作通知。アクションは必要ありません。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-607">Normal operating notification; no action required.</span></span></td>
</tr>
</tbody>
</table>

><span data-ttu-id="f9b9b-608">Microsoft Defender ATP を試してみたいですか?</span><span class="sxs-lookup"><span data-stu-id="f9b9b-608">Want to experience Microsoft Defender for Endpoint?</span></span> [<span data-ttu-id="f9b9b-609">無料試用版にサインアップしてください。</span><span class="sxs-lookup"><span data-stu-id="f9b9b-609">Sign up for a free trial.</span></span>](https://www.microsoft.com/microsoft-365/windows/microsoft-defender-atp?ocid=docs-wdatp-eventerrorcodes-belowfoldlink)

## <a name="related-topics"></a><span data-ttu-id="f9b9b-610">関連項目</span><span class="sxs-lookup"><span data-stu-id="f9b9b-610">Related topics</span></span>
- [<span data-ttu-id="f9b9b-611">Windows 10 デバイスのオンボード</span><span class="sxs-lookup"><span data-stu-id="f9b9b-611">Onboard Windows 10 devices</span></span>](configure-endpoints.md)
- [<span data-ttu-id="f9b9b-612">デバイス プロキシとインターネット接続の設定を構成する</span><span class="sxs-lookup"><span data-stu-id="f9b9b-612">Configure device proxy and Internet connectivity settings</span></span>](configure-proxy-internet.md)
- [<span data-ttu-id="f9b9b-613">Microsoft Defender for Endpoint のトラブルシューティング</span><span class="sxs-lookup"><span data-stu-id="f9b9b-613">Troubleshoot Microsoft Defender for Endpoint</span></span>](troubleshoot-onboarding.md)
