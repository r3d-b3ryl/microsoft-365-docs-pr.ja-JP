---
title: Linux でのユーザー設定Microsoft Defender for Endpoint設定する
ms.reviewer: ''
description: エンタープライズの Linux 上でMicrosoft Defender for Endpointを構成する方法について説明します。
...
ms.locfileid: "64634187"
---
# <a name="set-preferences-for-microsoft-defender-for-endpoint-on-linux"></a>Linux でのユーザー設定Microsoft Defender for Endpoint設定する
...
|**データ型**|Boolean|
|**指定可能な値**|true (既定) <p> false|
|**コメント**|バージョン 101.45.00 以上Microsoft Defender for Endpointバージョンで使用できます。|
|||
