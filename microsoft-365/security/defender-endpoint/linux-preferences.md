---
title: Linux でMicrosoft Defender for Endpointの基本設定を設定する
ms.reviewer: ''
...
---
# <a name="set-preferences-for-microsoft-defender-for-endpoint-on-linux"></a>Linux でMicrosoft Defender for Endpointの基本設定を設定する
