...
| **メソッド**          | **戻り値の型**         | **説明**                         |
|---------------------|-------------------------|-----------------------------------------|
| ライブラリ ファイルを一覧表示する  | ライブラリ ファイル コレクション | ライブラリ ファイル エンティティを一覧表示する              |
| ライブラリへのアップロード   | ライブラリ ファイル エンティティ     | ファイルをライブ応答ライブラリにアップロードする |
| ライブラリから削除する | コンテンツはありません              | ライブラリ ファイル エンティティを削除する              |

## <a name="properties"></a>プロパティ

| **プロパティ** | **型**                         | **説明**                                        |
|--------------|----------------------------------|--------------------------------------------------------|
| コマンド     | Live Response コマンド コレクション | Command オブジェクトの配列。 [ライブ応答コマンド](live-response.md#live-response-commands)を参照してください。 |
