...
> [!TIP]
> 最新のエンジン、プラットフォーム、署名の日付を確認するには、セキュリティ インテリジェンスの更新プログラム[(Microsoft Defender ウイルス対策その他の Microsoft](https://www.microsoft.com/wdsi/defenderupdates)マルウェア対策に関するページをご覧ください。
...
&ensp;プラットフォーム のバージョン: **4.18.2105.5**   
&ensp;エンジンのバージョン: **1.1.18300.4**  
&ensp;署名バージョン: **1.343.658.0**    
...
&ensp;パッケージ のバージョン: **1.1.2106.01**    
&ensp;プラットフォーム のバージョン: **4.18.2104.14**   
&ensp;エンジンのバージョン: **1.1.18100.6**  
&ensp;署名バージョン: **1.339.1923.0**    
...
&ensp;パッケージのバージョン: **1.1.2105.01**    
&ensp;プラットフォーム のバージョン: **4.18.2103.7**   
&ensp;エンジンのバージョン: **1.1.18100.6**  
&ensp;署名バージョン: **1.339.42.0**    
