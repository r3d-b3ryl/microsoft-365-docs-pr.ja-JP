...
Defender Streaming API Microsoft 365新しい機能には、デバイス イベントに加えて、電子メールイベントとアラート イベントが含まれています。 詳細については、「Defender[ストリーミング API Microsoft 365を参照してください](../defender/streaming-api.md)。
