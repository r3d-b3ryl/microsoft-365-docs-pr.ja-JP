...
|ウイルス対策 |macOS: <br/>- 10.15 (Catalina)<br/>- 10.14 (Mojave) <br/>- 10.13 (High Sierra) |[macOS のエンドポイント用 Microsoft Defender: ネットワーク接続](microsoft-defender-endpoint-mac.md#network-connections) |
