...
| [スキャン中ファイルと検出情報](review-scan-results-microsoft-defender-antivirus.md) | はい | はい <sup>[[5](#fn5)]</sup> | いいえ | はい | 
...
| [データ損失防止](../../compliance/endpoint-dlp-learn-about.md) | はい | 必要 | 不要 | 不要 |
...
| [デバイス コントロール](device-control-report.md) | はい | 必要 | 不要 | 不要 |
