...
-  [Defender for Cloudの統合EDR ソリューションでエンドポイントを保護する: Microsoft Defender for Endpoint](/azure/defender-for-cloud/integration-defender-for-endpoint)
-  [Azure 以外のマシンをMicrosoft Defender for CloudにConnectする](/azure/defender-for-cloud/quickstart-onboard-machines)
