...
ms.locfileid: "51186607"
---
# <a name="supported-managed-security-service-providers"></a>サポートされているマネージ セキュリティ サービス プロバイダー
...
![Trustwave Threat Detection &のロゴのイメージ](images/trustwave-logo.png)| [Trustwave Threat Detection &応答サービス](https://go.microsoft.com/fwlink/?linkid=2127542) | Sentinel および Defender for Endpoint との統合を活用する Azure の脅威検出および応答サービス
