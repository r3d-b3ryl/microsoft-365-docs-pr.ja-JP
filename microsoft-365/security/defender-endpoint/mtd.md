...
|脅威と脆弱性の管理 (TVM)|オンボードモバイル デバイスの脆弱性評価。 Microsoft Defender for [Endpoint 脅威と脆弱性の管理詳細](next-gen-threat-and-vuln-mgt.md)については、このページをご覧ください。 *iOS でのみ OS の脆弱性が現在サポートされている点に注意してください。*|
...
> [!NOTE]
> Android と iOS のプライバシーコントロールは現在プレビュー中であり、商用リリース前に大幅に変更される可能性があります。
