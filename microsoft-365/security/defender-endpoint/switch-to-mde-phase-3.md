...
|Windows セキュリティアプリ|1. デバイスでWindowsアプリをWindows セキュリティします。<br/><br/>2. [ **ウイルス対策&保護] を選択します**。<br/><br/>3. [ユーザー **Who保護] の下** にある [プロバイダーの **管理] を選択します**。<br/><br/>4. [セキュリティ **プロバイダー] ページの** [ウイルス対策] で、有効になっているMicrosoft Defender ウイルス対策 **を探します**。|
