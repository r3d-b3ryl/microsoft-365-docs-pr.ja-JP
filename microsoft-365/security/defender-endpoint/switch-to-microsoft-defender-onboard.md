...
組織のデバイスを Defender for Endpoint にオンボードし、Microsoft Defender ウイルス対策 がインストールされ有効になっているので、次に、Microsoft 以外のエンドポイント保護ソリューションをアンインストールします。 このタスクのヘルプを表示するには、ソリューション プロバイダーのテクニカル サポート チームに問い合わせください。
