...
![共有クエリのイメージ。](../../media/advanced-hunting-shared-queries.png)
...
3. クエリの名前を入力します。 
   ...
   ![クエリを保存するイメージ。](../../media/advanced-hunting-save-query.png)
...
1. 名前を変更または削除するクエリを右クリックします。
    ...
    ![削除クエリのイメージ。](../../media/advanced_hunting_delete_rename.png)
