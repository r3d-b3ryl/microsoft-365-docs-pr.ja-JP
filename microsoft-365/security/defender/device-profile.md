...
セキュリティ ポータルMicrosoft 365デバイス プロファイル ページを提供し、ネットワーク上のデバイスの正常性と状態をすばやく評価できます。
...
:::image type="content" source="../../media/mtp-device-profile/hybrid-device-overall.png" alt-text="[デバイス プロファイル] ページ (Microsoft 365 Defender ポータル)" lightbox="../../media/mtp-device-profile/hybrid-device-overall.png":::
...
:::image type="content" source="../../media/mtp-device-profile/azure-atp-only-device-sidebar.png" alt-text="デバイス プロファイルの [サイドバー] タブ (Microsoft 365 Defender ポータル)" lightbox="../../media/mtp-device-profile/azure-atp-only-device-sidebar.png":::
...
* **ディレクトリ データ** (*Microsoft Defender for Identity* に登録されているデバイスの場合のみ) - UAC フラグ、[SPN](/windows/security/identity-protection/user-account-control/user-account-control-overview)、およびグループ メンバーシップ。 [](/windows/win32/ad/service-principal-names)

## <a name="response-actions"></a>応答アクション

応答アクションは、脅威に対する防御と分析を迅速に行う方法を提供します。

:::image type="content" source="../../media/mtp-device-profile/hybrid-device-long-action-bar.png" alt-text="デバイス プロファイルのアクション バー (Microsoft 365 Defender ポータル)" lightbox="../../media/mtp-device-profile/hybrid-device-long-action-bar.png":::
...
* **ライブ応答セッションの開始** - デバイス上のリモート シェルを読み込んで、詳細なセキュリティ [調査を行います](/microsoft-365/security/defender-endpoint/live-response)。
* **自動調査を開始する** - 脅威 [を自動的に調査して修復します](../office-365-security/office-365-air.md)。 このページから自動調査を手動で実行することもできますが、特定のアラート [](../../compliance/alert-policies.md#default-alert-policies) ポリシーによって独自に自動調査がトリガーされます。
...
:::image type="content" source="../../media/mtp-device-profile/hybrid-device-tab-overview.png" alt-text="デバイス プロファイルの [概要] タブ (Microsoft 365 Defender ポータル)" lightbox="../../media/mtp-device-profile/hybrid-device-tab-overview.png":::
...
:::image type="content" source="../../media/mtp-device-profile/hybrid-device-tab-alerts.png" alt-text="デバイス プロファイルの [アラート] タブ (Microsoft 365 Defender ポータル)" lightbox="../../media/mtp-device-profile/hybrid-device-tab-alerts.png":::
...
:::image type="content" source="../../media/mtp-device-profile/hybrid-device-tab-timeline.png" alt-text="ポータルのデバイス プロファイルの [タイムライン] タブMicrosoft 365 Defenderします。" lightbox="../../media/mtp-device-profile/hybrid-device-tab-timeline.png":::
...
:::image type="content" source="../../media/mtp-device-profile/hybrid-device-tab-security-recs.png" alt-text="デバイス プロファイルの [セキュリティの推奨事項] タブ (Microsoft 365 Defender ポータル)" lightbox="../../media/mtp-device-profile/hybrid-device-tab-security-recs.png":::
...
:::image type="content" source="../../media/mtp-device-profile/hybrid-device-tab-software-inventory.png" alt-text="ポータルのデバイス プロファイルの [ソフトウェア インベントリ] タブMicrosoft 365 Defenderします。" lightbox="../../media/mtp-device-profile/hybrid-device-tab-software-inventory.png":::
...
:::image type="content" source="../../media/mtp-device-profile/hybrid-device-tab-discovered-vulnerabilities.png" alt-text="デバイス プロファイルの [検出された脆弱性] タブ (Microsoft 365 Defender ポータル)" lightbox="../../media/mtp-device-profile/hybrid-device-tab-discovered-vulnerabilities.png":::
...
[ **不足している KB]** タブには、デバイスにまだ適用されていない Microsoft 更新プログラムが一覧表示されます。 問題の "KB" は、これらの [更新プログラムについて説明](https://support.microsoft.com/help/242450/how-to-query-the-microsoft-knowledge-base-by-using-keywords-and-query) するサポート技術情報の記事です。たとえば、 [KB4551762 など](https://support.microsoft.com/help/4551762/windows-10-update-kb4551762)です。

:::image type="content" source="../../media/mtp-device-profile/hybrid-device-tab-missing-kbs.PNG" alt-text="デバイス プロファイルの [不足している KB] タブ (Microsoft 365 Defender ポータル)" lightbox="../../media/mtp-device-profile/hybrid-device-tab-missing-kbs.PNG":::
