...
Defender for Cloud Apps を使用しない場合、組織で使用されるクラウド アプリは、図に示すように非管理対象であり、保護されていません。
...
#### <a name="integrating-with-azure-ad-with-conditional-access-app-control"></a>条件付きアクセス アプリ制御とAzure ADとの統合
