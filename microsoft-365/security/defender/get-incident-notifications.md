...
Microsoft 365 Defender をセットアップして、新しいインシデントや既存のインシデントの更新に関するメールをスタッフに通知できます。 次に基づいて通知を受け取る方法を選択できます。
...
1. ナビゲーション ウィンドウで **、[Microsoft 365 Defender >インシデントメール通知>設定] を選択します**。
2. [アイテム **の追加] を選択します**。
...
4. [通知の **設定] ページで** 、次の構成を行います。
    ...
    - **[テナント固有のポータル リンクを** 含める] - 特定の Microsoft 365 テナントにアクセスするために、電子メール通知にテナント ID とのリンクを追加する場合に選択します。
...
既存のルールを編集するには、ルールの一覧からルールを選択します。 ルール名を持つウィンドウで、[削除] を **選択します**。
