...
- **[手順 1: Microsoft 365 Defender を有効にする](m365d-enable.md)** <br>
...
- **[手順 2: サポートされているサービスを展開する](deploy-supported-services.md)** <br>
    最初の手順を完了した後、Microsoft 365 Defender に関連するサポートされているサービスを展開する必要があります。 サービスを展開すると、ネットワーク全体の資産からの信号の可視性が効果的に向上します。


## <a name="key-capabilities"></a>主な機能
Microsoft 365 Defender を有効にしてサービスを展開すると、次の主要な機能にアクセスできます。
