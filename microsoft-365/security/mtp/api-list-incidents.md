...
| 送信者                                    | EntityType がユーザーの*User* / *メールボックス*MailMessage の場合に使用でき / *MailMessage*ます。                                                                                                                                                                                                                                                                                                                                  | user.abc@mail.contoso.co.in                                                                                                                                                                 |
...
| registryValueType                         | EntityType が  *レジストリ*の場合に使用できます。                                                                                                                                                                                                                                                                                                                                                    | 文字列                                                                                                                                                                                                                                            |
...
- [インシデントの更新](api-update-incidents.md)
