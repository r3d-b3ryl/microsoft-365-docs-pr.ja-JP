...
8. 残りのオプション **が選択** されている間は、[ユーザーが安全なリンクをクリックしても追跡しない] オプションが選択されていないことを確認します。 詳細については [、「セーフ リンクの設定」](../office-365-security/recommended-settings-for-eop-and-office365-atp.md) を参照してください。 **[保存]** をクリックします。 
...
より包括的なガイダンスについては [、「Turn On Microsoft 365 Defender」を参照してください](mtp-enable.md)。 
