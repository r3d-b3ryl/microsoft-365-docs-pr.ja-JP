...
* **ライブ応答セッションの開始** - デバイスにリモート シェルを読み込んで、詳細なセキュリティ [調査を行います](/windows/security/threat-protection/microsoft-defender-atp/live-response)。
...
* [ライブ応答を使用して、デバイス上のエンティティを調査する](/windows/security/threat-protection/microsoft-defender-atp/live-response)
