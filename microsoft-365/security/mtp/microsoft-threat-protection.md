...
Microsoft 365 E5 または同等のライセンスを持つお客様は、Microsoft の脅威保護を使用できます。 開始するには、 [security.microsoft.com](https://security.microsoft.com)の Microsoft 365 セキュリティセンターでサービスを有効にします。 詳細については、以下を参照してください。
