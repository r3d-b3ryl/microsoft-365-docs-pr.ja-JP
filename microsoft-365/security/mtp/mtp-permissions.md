...
- **グローバル Azure Active Directory (Azure AD) ロール**
- **カスタム ロール アクセス**

次のグローバル **Azure サーバーロールに割りADアカウントは** 、Microsoft 365 Defender の機能とデータにアクセスできます。
- グローバル管理者
- セキュリティ管理者
- セキュリティ オペレーター
- グローバル閲覧者
...
>![メモ]この記事は、グローバル Azure の役割の管理にのみADします。 カスタムの役割ベースのアクセス制御の使用の詳細については、「役割ベースのアクセス制御のカスタム [ロール」を参照してください。](custom-roles.md)
