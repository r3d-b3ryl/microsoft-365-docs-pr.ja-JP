...
1. テナントで [Microsoft 365 Defender が有効になっているか確認します](./mtp-enable.md#starting-the-service)。
...
|![閉じると概要のフェーズ](../../media/mtp/close.png) <br>[閉じると概要のフェーズ](mtp-pilot-close.md)|Microsoft 365 Defender パイロットの結果を分析し、関係者に提示し、次の手順を実行します。
|:-----|:-----|