...
Exchange Online Microsoft 365 メールボックスを持つ組織では、管理者は Microsoft 365 Defender ポータルの Submits ポータルを使用して、電子メール メッセージ、URL、添付ファイルを Microsoft に送信してスキャンできます。
...
- メッセージとファイルを Microsoft に送信するには、次のいずれかの役割グループのメンバーである必要があります。
  - **Defender ポータル** の **組織** の管理 [またはセキュリティ Microsoft 365リーダー](permissions-microsoft-365-security-center.md)です。
...
1. [Defender ポータルMicrosoft 365] で、[メールの送信] **&に** \> **移動します**。
...
レポート メッセージ アドイン、レポート[](enable-the-report-message-add-in.md)フィッシング アドイン、またはユーザー[](enable-the-report-phish-add-in.md)が web 上[の Outlook](report-junk-email-and-phishing-scams-in-outlook-on-the-web-eop.md)で組み込みのレポートを使用している場合は、[ユーザー報告メッセージ] タブでユーザーが報告している情報を確認できます。
