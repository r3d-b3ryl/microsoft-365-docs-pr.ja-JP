...
[Microsoft Defender For Office 365](office-365-atp.md)で[自動調査](office-365-air.md)が行われると、その調査に関する詳細が自動化された調査プロセスの間で利用可能になります。 必要なアクセス許可を持っている場合は、調査の詳細ビューでこれらの詳細を表示できます。 調査の詳細ビューでは最新の状態が表示され、保留中のアクションを承認する機能が提供されます。
...
電子メールの分析手順では、次の3種類の電子メールクラスターを識別できます。類似性クラスター (すべての調査)、インジケータークラスター (すべての調査)、メールボックス/ユーザークラスター。
...
- インジケータークラスターは、元の電子メールから同じインジケーターエンティティ (ファイルハッシュまたは URL) を探すことで識別される電子メールメッセージです。 Ouserriginal ファイルまたは URL エンティティが悪意のあるものとして識別されると、エアはそのエンティティを含む電子メールメッセージのクラスター全体にインジケーター verdict を適用します。 マルウェアとして識別されたファイルは、そのファイルを含む電子メールメッセージのクラスターがマルウェアの電子メールメッセージとして扱われることを意味します。
- メールボックス/ユーザークラスターは、ユーザーが侵害された調査に関与するユーザーに関連する電子メールメッセージです。  なお、これらの電子メールクラスターは、セキュリティ運用チームによる詳細な分析のためのものであり、電子メール修復アクションを生成しません。  侵害されたプレイブックのメールボックス/ユーザークラスターは、分析対象のユーザーによって送信されるメールをレビューして、メールボックスから送信されるメールの潜在的な影響を把握します。
    - メールボックス/ユーザーから送信された悪意のある電子メール。メールボックス/アカウントが侵害される可能性があることを示すもので、侵害の一部として悪意のあるユーザーによって影響を受ける可能性がある他のユーザーやメールボックスが表示されます。
    - メールボックス/ユーザーによって送信される不審なメール。メールボックスから送信されたスパム/バルクメールを表示します。これは、侵害の可能性に関連する可能性があります。また、少なくともメールアカウントからの潜在的な不要なアクティビティを示します。
    - メールボックス/ユーザーによって送信される電子メールを消去します。これにより、電子メールが送信された正当なユーザーの電子メールの表示をセキュリティ運用チームに提供します。
...
|メールクラスターの識別|ヘッダー、本文、コンテンツ、ファイル、および Url に基づく電子メールクラスターの分析|
...
|URL クリックの調査| 組織内の [Office 365 で、Microsoft Defender の [安全なリンク](atp-safe-links.md) で保護されたユーザーからのクリックを調べます。|
...
- [Microsoft 365 Defender での自動化された調査と対応について説明します。](https://docs.microsoft.com/microsoft-365/security/mtp/mtp-autoir)
