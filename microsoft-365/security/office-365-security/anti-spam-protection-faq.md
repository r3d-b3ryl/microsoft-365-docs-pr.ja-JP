...
A. はい。 [[インターネット上のプライバシーを保護する](https://support.microsoft.com/help/4091455)] をお読みください。
...
11. **送信方向の配信状態通知の書式を設定します。**
    ...
    配信状態通知メッセージを生成するとき、送信業者は「[RFC 3464](https://www.ietf.org/rfc/rfc3464.txt)」で指定されるバウンス メールの形式に従う必要があります。
