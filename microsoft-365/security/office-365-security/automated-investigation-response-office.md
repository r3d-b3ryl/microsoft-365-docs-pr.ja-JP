...
- チェックは、Exchange Online Protection[(EOP)](exchange-online-protection-overview.md)と ([microsoft Defender for Office 365](office-365-atp.md)) を通して行われ、ユーザーによって報告された他の類似のメッセージが表示される場合があります。
