...
2. [スパム **対策ポリシー]** ページで、名前をクリックして、リストから[カスタム送信スパム ポリシーの種類] 値を持つポリシーを選択します。 表示されるポリシーの詳細のフライアウトの上部にある [その他のアクション] ![ アイコンをクリックします。](../../media/m365-cc-sc-more-actions-icon.png) **その他のアクション** \>![[ポリシーの削除] アイコン ](../../media/m365-cc-sc-delete-icon.png) **[ポリシーの削除] をクリックします**。
