...
## <a name="use-the-security-center-to-remove-custom-anti-spam-policies"></a>セキュリティ センターを使用して、カスタムのスパム対策ポリシーを削除する

セキュリティ センターを使用してカスタムのスパム対策ポリシーを削除すると、スパム フィルター ルールと、それに対応するスパム フィルター ポリシーが両方とも削除されます。既定のスパム対策ポリシーを削除することはできません。
