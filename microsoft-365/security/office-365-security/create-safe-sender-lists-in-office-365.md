...
> [!IMPORTANT]
>
> - 差出人セーフ リスト *を使用* したスパム フィルター処理の例外を注意深く監視してください。
>
...
多くの場合、 `5321.MailFrom` 住所 `5322.From` は同じです (人と人のコミュニケーション)。 ただし、メールが他のユーザーの代わりに送信される場合、アドレスは異なる場合があります。 これは、バルク メール メッセージの場合に最も多く発生します。
