...
Microsoft 365 の Azure AD グループは、Microsoft 365 グループとは異なります。 Azure AD グループは、その**種類**が [**セキュリティ**] に設定され、電子メールアドレスを持たない Microsoft 365 管理センターに表示されます。 以下で Azure AD グループを管理できます。
