...
*Emailの詳細*: *[分析*] タブで使用できる電子メールの詳細を理解するために必要な詳細。
...
*複合認証*: これは、SPF、DKIM、DMARC などの電子メール認証を組み合わせて、メッセージが本物かどうかを判断するために Microsoft 365 によって使用される値です。 評価の基礎として、メールの *From:* ドメインが使用されます。
