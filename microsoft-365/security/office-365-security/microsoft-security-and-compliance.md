...
[![新しい Microsoft 365 セキュリティセンター](../media/m365-security-center.png)](../mtp/overview-security-center.md)
...
新しい[microsoft 365 コンプライアンスセンター](../../compliance/microsoft-365-compliance-center.md)は、コンプライアンスの全体的な状況を反映した Microsoft コンプライアンスマネージャーの可視性を提供し、複雑なコンプライアンスを満たす設定を構成するために推奨される対策を提供します。義務. 
