...
> [!TIP]
> Microsoft 365 E5 または Microsoft 365 E3 と Id & 脅威保護を組み合わせて使用していますか? [Microsoft の脅威保護で自動調査と応答 (AIR)](../mtp/mtp-autoir.md)を試行することを検討してください。
...
1. に[https://protection.office.com](https://protection.office.com)移動し、サインインします。 
