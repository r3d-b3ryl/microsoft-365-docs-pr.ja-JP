...
組織のセキュリティ チームは、Office 365 セキュリティ/コンプライアンス センターで、各 ATP ツールのポリシーを定義する必要があります。 **[脅威の管理]**  >  **[ポリシー]** に移動して、ポリシー オプションにアクセスします。 詳細については、「[脅威からの保護](protect-against-threats.md)」を参照してください。
