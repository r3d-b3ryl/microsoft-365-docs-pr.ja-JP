...
|**レビュー担当者**|メンバーは、セキュリティ & コンプライアンスセンターの [電子情報開示ケース] ページでのみ、ケースの一覧を表示できます。 電子情報開示ケースを作成したり、開いたり、管理したりすることはできません。 この役割グループの主な目的は、メンバーが Advanced 電子情報開示のケースデータを表示してアクセスできるようにすることです。 <br/><br/> この役割グループが持っている電子情報開示関連のアクセス許可は最も厳しくなっています。|Review|
...
|**データの調査員**|メールボックス、SharePoint Online サイト、および OneDrive for Business の場所に対して検索を実行します。|エクスポート <br/><br/> RMS の暗号化解除 <br/><br/> Custodian <br/><br/> 通信 <br/><br/> Review <br/><br/> プレビュー <br/><br/> コンプライアンス検索 <br/><br/> データ調査の管理|
