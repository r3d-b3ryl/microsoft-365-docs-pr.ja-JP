...
|**Supervisory Review**|メンバーは、組織内で確認する対象となる通信を定義するポリシーを作成および管理できます。 詳細については、「[組織の監督レビューポリシーを構成する](../../compliance/configure-supervision-policies.md)」を参照してください。|監督レビュー管理者|
