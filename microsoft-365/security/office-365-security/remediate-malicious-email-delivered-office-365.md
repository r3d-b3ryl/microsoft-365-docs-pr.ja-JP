...
電子メール アクションはバックエンドで自動調査を作成するため、 *自動調査* を有効にする必要があります。 **[設定** \> **Endpoints** \> **Advanced 機能**] に移動し、[**自動調査]** をオンにします。
...
> [!NOTE]
> 修復が開始されると、アラートと調査が並行して生成されます。 アラートは、"管理者によって送信された管理アクション" という名前のアラート キューに表示され、セキュリティ担当者がエンティティを修復するアクションを実行したことを示します。 アクションを実行したユーザーの名前、調査リンクのサポート、時間などの詳細が表示されます。エンティティに対して修復などの厳しいアクションが実行されるたびに、非常に効果的です。 これらのアクションはすべて、[ **アクション&申請** \> **アクション センター**  -> **履歴] タブ** (パブリック プレビュー) で追跡できます。
...
エクスプローラー、高度な捜索、または自動調査によって作成されたすべての修復 (直接承認) は、アクション センターに表示されます。 左側のナビゲーション パネルの [ **アクション&送信** \> **アクション センター**  -> **の履歴] タブ** からアクセスします。

エクスプローラーまたは高度な捜索または自動調査によって作成されたすべての修復 (直接承認) は、アクション センターに表示されます。 左側のナビゲーション パネルの [ **アクション&送信** \> **アクション センター**  -> **の履歴] タブ** からアクセスします。 
...
:::image type="content" source="../../media/microsoft-365-defender-action-center-history-panel.png" alt-text="[受信トレイに移動] オプションが開いているアクション センター。":::
