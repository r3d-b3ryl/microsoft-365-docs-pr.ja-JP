...
|Chris の組織には、組織内のすべてのユーザーに対して長年にわたる安全な添付ファイル ポリシーがあります。 Chris は添付ファイルを含むメールを受信し、外部の受信者にメッセージを転送します。|Chis は安全な添付ファイルによって保護されています。 <br/><br/> Microsoft 365 組織内の外部受信者の場合、転送されたメッセージも安全な添付ファイルによって保護されます。|
