...
|Lee の組織には、財務セーフにのみ適用される添付ファイルポリシーがあります。 Lee は営業部門のメンバーです。|リーと他の営業部門は、セーフ 添付ファイル ポリシーで定義されていないすべての受信者に適用される組み込みの保護事前設定セキュリティ ポリシーにより、セーフ 添付ファイルによって保護されます。|
...
|Chris の組織には、組織内のすべてのユーザーセーフに関する長年の添付ファイル ポリシーがあります。 Chris は、添付ファイルを含む電子メールを受信し、そのメッセージを外部受信者に転送します。|Chis は添付ファイルによってセーフされます。 <p> 組織の外部受信者が組織Microsoft 365、転送されたメッセージも添付ファイルによってセーフされます。|
|
