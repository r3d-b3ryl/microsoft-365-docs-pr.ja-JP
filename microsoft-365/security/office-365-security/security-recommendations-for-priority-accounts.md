...
|Task|すべてのOffice 365 Enterprise プラン|Microsoft 365 E3|Microsoft 365 E5|
|---|:---:|:---:|:---:|
...
厳密なポリシー設定が既定のポリシー設定と標準ポリシー設定とどのように異なるかについては、「EOP および Microsoft Defender for Office [365](recommended-settings-for-eop-and-office365.md)セキュリティの推奨設定」を参照してください。
