...
|:-----|:-----|
| |結果
|30 日|高速構成:  <br/> •基本的な管理者による保護  <br/> •ログおよび分析  <br/> •基本的な id の保護  <br/> テナントの構成  <br/>  ステークホルダーの準備  <br/> |
...
|ID およびアクセス管理  <br/> | •すべてのユーザーに対して MFA を有効にし、適用します。  <br/>  •[条件付きアクセスと関連ポリシー](https://docs.microsoft.com/microsoft-365/enterprise/microsoft-365-policies-configurations)のセットを実装します。 |
