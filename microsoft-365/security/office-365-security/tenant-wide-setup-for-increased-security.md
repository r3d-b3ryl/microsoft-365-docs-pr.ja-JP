...
- PowerShell を使用する、最新 [の認証を使用しないアプリをブロックするを参照してください](/mem/intune/protect/app-modern-authentication-block)。
