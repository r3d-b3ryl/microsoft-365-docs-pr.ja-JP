...
[ポータル] **Microsoft 365 Defender[** メール]**グループ&に** 移動し、[エクスプローラー] を **選択します**。
...
エクスプローラー ツールを開くには、ポータル **の [メール] Microsoft 365 Defenderに移動**  >  **し&エクスプローラーを開**  >  **きます**。 既定では、[マルウェア] ページに移動しますが、[表示]ドロップダウンを使用してオプションを理解します。 フィッシングを探している場合、または脅威キャンペーンを掘り下ろしている場合は、それらのビューを選択します。
