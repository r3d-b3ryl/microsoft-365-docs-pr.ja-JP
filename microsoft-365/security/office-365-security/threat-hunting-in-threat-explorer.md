...
[Defender ポータル **Microsoft 365] で**、[メール の編集] &**に移動** し、[エクスプローラー] を **選択します**。
...
エクスプローラー ツールを開く場合は、[Defender portal **Email Microsoft 365] に移動し**、&  >  **エクスプローラーに**  >  **移動します**。 既定では、[マルウェア] ページに移動しますが、[表示]ドロップダウンを使用してオプションを理解します。 フィッシングを探している場合、または脅威キャンペーンを掘り下ろしている場合は、それらのビューを選択します。
...
> [!div class="mx-imgBorder"]
> ![列で使用可能なオプション](../../media/column-options.png)
...
> [!div class="mx-imgBorder"]
> ![メールの配信元マップ](../../media/threat-explorer-email-origin-map.png)
...
エクスプローラーまたはリアルタイムの検出を表示および使用するには、次の情報が必要です。

- Defender ポータルMicrosoft 365の場合:
...
- [Microsoft 365 Defender ポータルのアクセス許可](permissions-in-the-security-and-compliance-center.md)
