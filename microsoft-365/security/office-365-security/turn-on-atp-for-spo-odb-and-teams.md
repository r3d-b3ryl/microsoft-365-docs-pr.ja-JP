...
2. Office 365 セキュリティ & コンプライアンスセンターの左側のナビゲーションウィンドウで、[脅威の**管理**] の下の [**ポリシー** \>の**安全な添付ファイル**] を選択します。
...
1. [Office 365 セキュリティ & コンプライアンスセンター](https://protection.office.com)で、 **[通知の** \> **管理**] を選択します。
