...
- **合計メール数**
- **エッジの許可、エッジのフィルター処理**
- **マルウェア、安全な添付ファイルの検出 (Defender for Office 365)、マルウェア対策エンジンの検出、ルールブロック**
- **Not フィッシング、DMARC failure、impersonation detection、スプーフィング検出、フィッシング検出**
- **URL 分析、URL 分析検出 (Defender for Office 365) を使用した検出なし**
- **スパムではない、スパム**
- **非悪意のある電子メール、安全なリンクの検出 (Defender for Office 365)、ZAP**
