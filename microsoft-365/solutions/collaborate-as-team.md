...
この記事では、ゲストと共同作業するためのチームをセットアップするために必要な Microsoft 365 の構成手順について説明します。
...
Teams には、ゲスト アクセス用のマスター オン/オフ スイッチと、ゲストがチームで実行できる操作を制御できるさまざまな設定があります。 ゲスト アクセスが Teams **で機能するには、マスター** スイッチ (Teams でのゲスト アクセスを **許可** する) がオンである必要があります。
...
2. SharePoint 管理センターの左側のナビゲーション ウィンドウで、[ポリシー  ] を展開し、[共有] をクリック **します**。
