...
1. Microsoft 365 管理センターにログイン[https://admin.microsoft.com](https://admin.microsoft.com)します。
2. 左側のナビゲーションで、[**すべて表示**] をクリックします。
3. [**管理センター**] で [ **Teams**] をクリックします。
4. Teams 管理センターの左側のナビゲーションで、[**組織全体の設定**] を展開し、[**ゲストアクセス**] をクリックします。
5. [ **Teams でのゲストアクセスを許可**する] が **[オン**] に設定されていることを確認します。
6. 追加のゲスト設定に必要な変更を加え、[**保存**] をクリックします。
...
内部ユーザーをチームに招待するには
1. チームで、[**その他**のオプション**\*\***] () をクリックし、[**メンバーの追加**] をクリックします。
2. 招待するユーザーの名前を入力します。
