...
### <a name="microsoft-defender-for-endpoint-deployment-strategy"></a>エンドポイント展開戦略のための Microsoft Defender
...
Microsoft 365 およびその他の Microsoft クラウドテクノロジを使用すると、組織のオンプレミスの情報、クラウドベースの情報、ツール、およびリソースへの安全なアクセスをユーザーに提供できます。 
...
詳細については、「 [Microsoft 365 を使用してリモートワーカーを支援](empower-people-to-work-remotely.md)する」の記事を参照してください。

### <a name="microsoft-teams-with-security-isolation"></a>セキュリティを分離した Microsoft Teams
