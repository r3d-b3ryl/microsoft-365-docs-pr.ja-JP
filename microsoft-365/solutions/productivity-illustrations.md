...
## <a name="microsoft-defender-for-endpoint-deployment-strategy"></a>Microsoft Defender for Endpoint展開戦略
...
詳細については、このポスターの記事「 [セキュリティ分離を使用してチームを構成する」を](secure-teams-security-isolation.md)参照してください。
