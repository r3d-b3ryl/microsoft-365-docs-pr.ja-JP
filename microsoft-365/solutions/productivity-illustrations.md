...
| アイテム | 説明 |
|:-----|:-----|
|[![グループ インフォグラフィックのサムネイル](../downloads/msft-m365-groups-architecture-thumb.png)](https://github.com/MicrosoftDocs/microsoft-365-docs/raw/public/microsoft-365/downloads/msft-m365-groups.pdf) <br/> 
...
Microsoft 365 には、広範な情報保護とコンプライアンスの機能が含まれています。Microsoft の生産性を向上させるツールも使用しながら、これらの機能によって組織は厳格な法的コンプライアンスのフレームワークに準拠しながら、リアルタイムで共同作業を行うことが容易になります。 

これらのイラストは、最も規制の厳しい産業の 1 つである金融サービスを取り上げて、これらの機能が一般的な規制要件に対応するために、いかなる方法で適用できるかを示します。これらのイラストをご自由にお役立てください。 
