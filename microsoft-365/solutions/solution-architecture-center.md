...
- [Microsoft 365 を使用してリモートワーカーを支援する](empower-people-to-work-remotely.md)
...
![オブジェクト](https://docs.microsoft.com/office/media/icons/objects-blue.png)の**[ワークロードのソリューションとシナリオのガイダンス](workload-solutions-scenarios-overview.md)** これらのシナリオとソリューションは、特定のビジネス目標を達成するのに役立ちます。 これらを基本ソリューションに追加して、環境に機能を追加することができます。
